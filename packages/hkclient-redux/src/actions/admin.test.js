...
import * as Actions from 'hkclient-redux/actions/admin';
...
describe('hkclient-redux/actions.Admin', () => {
    let store;
    beforeAll(() => {
    ...
    it('uploadBrandImage', async () => {
        const testImageData = fs.createReadStream('packages/hkclient-redux/src/test/assets/images/test.png');
    ...
    it('uploadPublicSamlCertificate', async () => {
        const testFileData = fs.createReadStream('packages/hkclient-redux/src/test/assets/images/test.png');
