...
describe('hkclient-redux/actions.Files', () => {
    ...
    it('uploadFile', async () => {
        ...
        const testImageData = fs.createReadStream(`packages/hkclient-redux/test/assets/images/${testFileName}`);
        ...
        imageFormData.append('hkclient-redux/client_ids', clientId);
