 ...
 * @param {object} roles same structure as returned by hkclient-redux `getRoles`.
 * @return {object} the updated roles (only) in the same structure as returned by hkclient-redux `getRoles`.
 */
