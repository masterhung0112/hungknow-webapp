...
import {Preferences as PreferencesRedux, General} from 'hkclient-redux/constants';
import {
    getChannel,
    getCurrentChannelId,
    getMyChannels,
...
import {getBool, isCollapsedThreadsEnabled} from 'hkclient-redux/selectors/entities/preferences';
import {getCurrentTeamId, getTeamMember} from 'hkclient-redux/selectors/entities/teams';
