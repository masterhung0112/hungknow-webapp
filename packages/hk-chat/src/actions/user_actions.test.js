...
jest.mock('hkclient-redux/actions/users', () => {
    const original = jest.requireActual('hkclient-redux/actions/users');
    return {
        ...original,
...
jest.mock('hkclient-redux/selectors/entities/channels', () => {
    const GeneralTypes = jest.requireActual('hkclient-redux/constants').General;
    const original = jest.requireActual('hkclient-redux/selectors/entities/channels');
...
jest.mock('hkclient-redux/actions/teams', () => {
    const original = jest.requireActual('hkclient-redux/actions/teams');
    return {
        ...original,
...
jest.mock('hkclient-redux/actions/channels', () => {
    const original = jest.requireActual('hkclient-redux/actions/channels');
    return {
        ...original,
...
jest.mock('hkclient-redux/actions/preferences', () => {
    const original = jest.requireActual('hkclient-redux/actions/preferences');
    return {
        ...original,
