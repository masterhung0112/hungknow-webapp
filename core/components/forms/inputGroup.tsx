...
export default class InputGroup extends AbstractPureComponent<
...
> {
  ...
  public componentDidUpdate(prevProps: IInputGroupProps & HTMLInputProps) {
    ...
    if (
      prevProps.leftElement !== leftElement ||
      prevProps.rightElement !== rightElement
    ) {
      this.updateInputWidth();
    }
  }
  ...
  private updateInputWidth() {
    ...
    if (this.leftElement != null) {
      ...
      if (
        ...
        Math.abs(clientWidth - leftElementWidth) > 2
      ) {
    ...
    if (this.rightElement != null) {
      ...
      if (
        ...
        Math.abs(clientWidth - rightElementWidth) > 2
      ) {
