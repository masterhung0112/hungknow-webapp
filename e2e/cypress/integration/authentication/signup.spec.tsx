...
describe('Signup Email page', () => {
  ...
  it('should match elements, body', () => {
    ...
    cy.get('#signup_agreement').should(
      'contain',
      `By proceeding to create your account and use ${config.TeamSettings.SiteName}, you agree to our Terms of Service and Privacy Policy. If you do not agree, you cannot use ${config.TeamSettings.SiteName}.`
    )
