  ...
  render() {
    ...
    return (
      <RootCloseWrapper disabled={!open} onRootClose={this.handleRootClose} event={rootCloseEvent}>
        <ul role="menu" className="dropdown-menu channel-header_plugin-dropdown">
          {children}
        </ul>
      </RootCloseWrapper>
    )
  ...
  createDropdown = (plugs: PluginComponent[]) => {
      ...
      .map((plug) => {
        return (
          <li key={'channelHeaderPlug' + plug.id}>
            <a href="#" className="d-flex align-items-center" onClick={() => this.fireActionAndClose(plug.action!)}>
    ...
    return (
      <div className="flex-child">
        <Dropdown id="channelHeaderPlugDropdown" onToggle={this.toggleDropdown} open={this.state.dropdownOpen}>
          <CustomToggle dropdownOpen={this.state.dropdownOpen} bsRole="toggle">
            <OverlayTrigger
                ...
                this.state.dropdownOpen ? (
                  ...
                  <Tooltip id="removeIcon">
                    <div aria-hidden={true}>
                      <FormattedMessage id="generic_icons.plugins" defaultMessage="Plugins" />
                    </div>
                  </Tooltip>
                )
              }
          ...
          <CustomMenu bsRole="menu" open={this.state.dropdownOpen} onClose={this.onClose}>
            {items}
          </CustomMenu>
        </Dropdown>
      </div>
