...
describe('plugins/MobileChannelHeaderPlug', () => {
  ...
  test('should match snapshot with no extended component', () => {
    const wrapper = mount(
      <MobileChannelHeaderPlug components={[]} channel={{}} channelMember={{}} theme={{}} isDropdown={false} />
    )
  ...
  test('should match snapshot with one extended component', () => {
    const wrapper = mount(
      <MobileChannelHeaderPlug components={[testPlug]} channel={{}} channelMember={{}} theme={{}} isDropdown={false} />
    )
    expect(wrapper).toMatchSnapshot()
  ...
  test('should match snapshot with no extended component, in dropdown', () => {
    const wrapper = mount(
      <MobileChannelHeaderPlug components={[]} channel={{}} channelMember={{}} theme={{}} isDropdown={true} />
    )
    expect(wrapper).toMatchSnapshot()
  ...
  test('should match snapshot with one extended component, in dropdown', () => {
    const wrapper = mount(
      <MobileChannelHeaderPlug components={[testPlug]} channel={{}} channelMember={{}} theme={{}} isDropdown={true} />
    )
    expect(wrapper).toMatchSnapshot()
