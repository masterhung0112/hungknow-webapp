...
export default class MobileChannelHeaderPlug extends React.PureComponent {
  ...
  createButton = (plug) => {
    ...
    if (this.props.isDropdown) {
      return (
        <li key={'mobileChannelHeaderItem' + plug.id} role="presentation" className="MenuItem">
    ...
    return (
      <li className="flex-parent--center">
        <button className="navbar-toggle navbar-right__icon" onClick={onClick}>
          <span className="icon navbar-plugin-button">{plug.icon}</span>
        </button>
      </li>
    )
  }
