...
import React, { ExoticComponent, ForwardRefExoticComponent, ReactElement } from 'react'
import { createIntl, injectIntl, IntlShape, IntlProvider } from 'react-intl'
import { shallow, mount, ShallowRendererProps, MountRendererProps } from 'enzyme'
...
function unwrapForwardRef<WrappedComponentElement extends ReactElement>(
  element: ReactElement
): WrappedComponentElement {
  ...
  if (type.$$typeof && type.$$typeof === Symbol.for('react.forward_ref')) {
    ...
    return React.cloneElement((type as ForwardRefComponent).render(), props) as WrappedComponentElement
  }
...
export function mountWithIntl<T extends ReactElement | IntlInjectedElement>(
  element: T,
  options?: MountWithIntlOptions
) {
