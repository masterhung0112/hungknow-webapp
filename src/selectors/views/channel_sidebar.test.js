      ...
      entities: {
        ...
        channels: {
          ...
          channelsInTeam: {
            ...
            team1: [...baseState.entities.channels.channelsInTeam.team1, 'archivedChannel'],
          },
          myMembers: {
            ...baseState.entities.channels.myMembers,
...
describe('getDisplayedChannels', () => {
  ...
  test('should return channels in the order that they appear in each category', () => {
    ...
    expect(Selectors.getDisplayedChannels(state)).toEqual([currentChannel, unreadChannel1, readChannel, unreadChannel2])
  })
  ...
  test('with unread filter enabled, should not return read channels', () => {
    ...
    expect(Selectors.getDisplayedChannels(state)).toEqual([unreadChannel2, unreadChannel1, currentChannel])
  })
  ...
  test('with unreads section enabled, should have unread channels first', () => {
    ...
    expect(Selectors.getDisplayedChannels(state)).toEqual([unreadChannel2, unreadChannel1, currentChannel, readChannel])
  })
...
describe('makeGetFilteredChannelsForCategory', () => {
  ...
  test('with the unreads category enabled, should not include unread channels', () => {
    const category1 = {
      id: 'category1',
      team_id: 'team1',
      channel_ids: [currentChannel.id, readChannel.id, unreadChannel1.id, unreadChannel2.id],
    }
