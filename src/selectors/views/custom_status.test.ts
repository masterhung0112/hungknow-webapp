...
import * as GeneralSelectors from 'hkclient-ts/lib/selectors/entities/general'
...
jest.mock('hkclient-ts/lib/selectors/entities/users')
jest.mock('hkclient-ts/lib/selectors/entities/general')
jest.mock('hkclient-ts/lib/selectors/entities/preferences')
