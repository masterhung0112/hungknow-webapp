...
export const getInstalledPlugins = (state) => Object.values(getPlugins(state)).filter((p) => p.installed_version !== '')

export const getPlugin = (state, id) => getPlugins(state).find((p) => p.manifest && p.manifest.id === id)
