...
} from 'hkclient-ts/lib/selectors/entities/channel_categories'
...
import { CategorySorting, ChannelCategory } from 'hkclient-ts/lib/types/channel_categories'
...
import { createIdsSelector, memoizeResult } from 'hkclient-ts/lib/utils/helpers'
...
export const getAutoSortedCategoryIds: (state: GlobalState) => Set<string> = (() =>
  createSelector(
...
export const getChannelsByCategoryForCurrentTeam: (
  state: GlobalState
) => RelationOneToOne<ChannelCategory, Channel[]> = (() => {
