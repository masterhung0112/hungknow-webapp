...
import * as AdminActions from 'hkclient-ts/lib/actions/admin'
...
import { bindClientFunc } from 'hkclient-ts/lib/actions/helpers'
  ...
  return async () => {
    try {
      ...
      const response = await Client4.doFetch(`${Client4.getBaseRoute()}/trial-license`, {
        method: 'POST',
        body: JSON.stringify({ users, terms_accepted: termsAccepted, receive_emails_accepted: receiveEmailsAccepted }),
      })
