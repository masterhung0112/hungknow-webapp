...
import { getMyChannelMember } from 'hkclient-ts/lib/actions/channels'
import {
  getChannel,
...
import { canEditPost, comparePosts } from 'hkclient-ts/lib/utils/post_utils'
...
export function handleNewPost(post, msg) {
  return async (dispatch, getState) => {
    ...
    const myChannelMemberDoesntExist =
      !myChannelMember || (Object.keys(myChannelMember).length === 0 && myChannelMember.constructor === 'Object')
