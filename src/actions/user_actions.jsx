...
import { getChannelAndMyMember, getChannelMembersByIds } from 'hkclient-ts/lib/actions/channels'
import { savePreferences } from 'hkclient-ts/lib/actions/preferences'
import { getTeamMembersByIds } from 'hkclient-ts/lib/actions/teams'
import * as UserActions from 'hkclient-ts/lib/actions/users'
import { Preferences as PreferencesRedux, General } from 'hkclient-ts/lib/constants'
import {
  getChannel,
  getCurrentChannelId,
  getMyChannels,
...
import { getCurrentTeamId, getTeamMember } from 'hkclient-ts/lib/selectors/entities/teams'
import * as Selectors from 'hkclient-ts/lib/selectors/entities/users'
import {
