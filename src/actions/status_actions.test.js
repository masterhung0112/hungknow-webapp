...
import { getStatusesByIds } from 'hkclient-ts/lib/actions/users'
  ...
  const initialState = {
    ...
    entities: {
      channels: {
        ...
        channels: {
          channel_id1: { id: 'channel_id1', name: 'channel1', team_id: 'team_id1' },
          channel_id2: { id: 'channel_id2', name: 'channel2', team_id: 'team_id1' },
        },
      ...
      posts: {
        ...
        postsInChannel: {
          channel_id1: [{ order: ['post_id1', 'post_id2'], recent: true }],
          channel_id2: [],
        },
      },
      preferences: {
  ...
  describe('loadStatusesForChannelAndSidebar', () => {
    test('load statuses with posts in channel and user in sidebar', () => {
      ...
      expect(getStatusesByIds).toHaveBeenCalledWith(
        expect.arrayContainingExactly(['current_user_id', 'user_id2', 'user_id3'])
      )
    })
