...
import { getCurrentChannel, getMyChannelMember, makeGetChannel } from 'hkclient-ts/lib/selectors/entities/channels'
import { getConfig } from 'hkclient-ts/lib/selectors/entities/general'
import { getTeammateNameDisplaySetting } from 'hkclient-ts/lib/selectors/entities/preferences'
import { getCurrentUserId, getCurrentUser, getStatusForUserId, getUser } from 'hkclient-ts/lib/selectors/entities/users'
...
export function sendDesktopNotification(post, msgProps) {
  return async (dispatch, getState) => {
    ...
    const soundName =
      user.notify_props !== undefined && user.notify_props.desktop_notification_sound !== undefined
