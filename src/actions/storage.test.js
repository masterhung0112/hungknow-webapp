...
describe('Actions.Storage', () => {
  ...
  it('actionOnGlobalItemsWithPrefix', async () => {
    ...
    store.dispatch(Actions.actionOnGlobalItemsWithPrefix('prefix', (key, value) => touchedPairs.push([key, value])))
  ...
  it('actionOnItemsWithPrefix', async () => {
    ...
    const touchedPairs = []
    store.dispatch(Actions.actionOnItemsWithPrefix('prefix', (key, value) => touchedPairs.push([key, value])))
