...
const UserSelectors = require('hkclient-ts/lib/selectors/entities/users')
...
jest.mock('hkclient-ts/lib/actions/search', () => ({
  ...
  describe('openAtPrevious', () => {
    ...
    it('opens selected post card', async () => {
      ...
      await store.dispatch(
        openAtPrevious({ selectedPostCardId: previousSelectedPost.id, previousRhsState: previousState })
      )
