...
\`\`\``)
  ...
  test('<a> should contain target=_blank for external links', () => {
    ...
    expect(output).toContain(
      '<a class="theme markdown__link" href="http://example.com" rel="noreferrer" target="_blank">external_link</a>'
    )
  })
  ...
  test('<a> should not contain target=_blank for internal links', () => {
    ...
    expect(output).toContain(
      '<a class="theme markdown__link" href="http://localhost/example" rel="noreferrer" data-link="/example">internal_link</a>'
    )
  })
  ...
  test('<a> should contain target=_blank for internal links that live under /plugins', () => {
    ...
    expect(output).toContain(
      '<a class="theme markdown__link" href="http://localhost/plugins/example" rel="noreferrer" target="_blank">internal_link</a>'
    )
  })

  test('<a> should contain target=_blank for internal links that are files', () => {
    const output = format(
      'http://localhost/files/o6eujqkmjfd138ykpzmsmc131y/public?h=j5nPX8JlgUeNVMOB3dLXwyG_jlxlSw4nSgZmegXfpHw',
      { siteURL: 'http://localhost' }
    )

    expect(output).toContain(
      '<a class="theme markdown__link" href="http://localhost/files/o6eujqkmjfd138ykpzmsmc131y/public?h=j5nPX8JlgUeNVMOB3dLXwyG_jlxlSw4nSgZmegXfpHw" rel="noreferrer" target="_blank">http://localhost/files/o6eujqkmjfd138ykpzmsmc131y/public?h=j5nPX8JlgUeNVMOB3dLXwyG_jlxlSw4nSgZmegXfpHw</a>'
    )
  })
  ...
  test('<a> should not contain target=_blank for pl|channels|messages links', () => {
    ...
    expect(pl).toContain(
      '<a class="theme markdown__link" href="/reiciendis-0/pl/b3hrs3brjjn7fk4kge3xmeuffc" rel="noreferrer" data-link="/reiciendis-0/pl/b3hrs3brjjn7fk4kge3xmeuffc">thread</a>'
    )

    const channels = format('[thread](/reiciendis-0/channels/b3hrs3brjjn7fk4kge3xmeuffc))', {
      siteURL: 'http://localhost',
    })
    expect(channels).toContain(
      '<a class="theme markdown__link" href="/reiciendis-0/channels/b3hrs3brjjn7fk4kge3xmeuffc" rel="noreferrer" data-link="/reiciendis-0/channels/b3hrs3brjjn7fk4kge3xmeuffc">thread</a>'
    )

    const messages = format('[thread](/reiciendis-0/messages/b3hrs3brjjn7fk4kge3xmeuffc))', {
      siteURL: 'http://localhost',
    })
    expect(messages).toContain(
      '<a class="theme markdown__link" href="/reiciendis-0/messages/b3hrs3brjjn7fk4kge3xmeuffc" rel="noreferrer" data-link="/reiciendis-0/messages/b3hrs3brjjn7fk4kge3xmeuffc">thread</a>'
    )

    const plugin = format('[plugin](/reiciendis-0/plugins/example))', { siteURL: 'http://localhost' })
    expect(plugin).toContain(
      '<a class="theme markdown__link" href="/reiciendis-0/plugins/example" rel="noreferrer" data-link="/reiciendis-0/plugins/example">plugin</a>'
    )
  })
  ...
  describe('should correctly open links in the current tab based on whether they are handled by the web app', () => {
    for (const testCase of [
      ...
      {
        name: 'link to a specific system console page',
        link: 'http://localhost/admin_console/plugins/plugin_com.github.matterpoll.matterpoll',
        handled: true,
      },
      ...
      {
        name: 'relative link to a specific system console page',
        link: '/admin_console/plugins/plugin_com.github.matterpoll.matterpoll',
        handled: true,
      },

      { name: 'link to a plugin-handled path', link: 'http://localhost/plugins/example', handled: false },
      {
        name: 'link to a file attachment public link',
        link: 'http://localhost/files/o6eujqkmjfd138ykpzmsmc131y/public?h=j5nPX8JlgUeNVMOB3dLXwyG_jlxlSw4nSgZmegXfpHw',
        handled: false,
      },

      { name: 'relative link to a plugin-handled path', link: '/plugins/example', handled: false },
      {
        name: 'relative link to a file attachment public link',
        link: '/files/o6eujqkmjfd138ykpzmsmc131y/public?h=j5nPX8JlgUeNVMOB3dLXwyG_jlxlSw4nSgZmegXfpHw',
        handled: false,
      },

      {
        name: 'link to a managed resource',
        link: 'http://localhost/trusted/jitsi',
        options: { managedResourcePaths: ['trusted'] },
        handled: false,
      },
      {
        name: 'relative link to a managed resource',
        link: '/trusted/jitsi',
        options: { managedResourcePaths: ['trusted'] },
        handled: false,
      },
      {
        name: 'link that is not to a managed resource',
        link: 'http://localhost/trusted/jitsi',
        options: { managedResourcePaths: ['jitsi'] },
        handled: true,
      },
    ]) {
      test(testCase.name, () => {
