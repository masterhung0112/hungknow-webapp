...
import { Permissions } from 'hkclient-ts/lib/constants/index'
...
describe('PolicyRolesAdapter', () => {
  ...
  beforeEach(() => {
    roles = {
      channel_user: {
        name: 'channel_user',
        permissions: [Permissions.EDIT_POST, Permissions.DELETE_POST, Permissions.MANAGE_PRIVATE_CHANNEL_MEMBERS],
      },
      team_user: {
        name: 'team_user',
        permissions: [
