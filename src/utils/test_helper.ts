...
import {Channel, ChannelMembership, ChannelNotifyProps, ChannelWithTeamData} from 'hkclient-redux/types/channels';
...
import {CategorySorting, ChannelCategory} from 'hkclient-redux/types/channel_categories';
