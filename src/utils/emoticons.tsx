...
export function handleEmoticons(text: string, tokens: Map<string, { value: string; originalText: string }>): string {
  let output = text

  function replaceEmoticonWithToken(fullMatch: string, prefix: string, matchText: string, name: string): string {
  ...
  output = output.replace(EMOJI_PATTERN, (fullMatch: string, matchText: string, name: string): string =>
