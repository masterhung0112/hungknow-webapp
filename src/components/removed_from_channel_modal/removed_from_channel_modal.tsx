...
export default class RemovedFromChannelModal extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    channelName = <FormattedMessage id="removed_channel.channelName" defaultMessage="the channel" />
    if (this.props.channelName) {
      channelName = this.props.channelName
    }

    remover = <FormattedMessage id="removed_channel.someone" defaultMessage="Someone" />
    ...
    return (
      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="removeFromChannelModalLabel">
        ...
        <Modal.Footer>
          <button type="button" className="btn btn-primary" onClick={this.onHide} id="removedChannelBtn">
