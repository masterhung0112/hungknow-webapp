...
export default class PasswordResetSendLink extends React.PureComponent<Props, State> {
  ...
  handleSendLink = async (e: React.FormEvent) => {
    ...
    if (!email || !isEmail(email)) {
      this.setState({
        error: <FormattedMessage id="password_send.error" defaultMessage="Please enter a valid email address." />,
      })
      return
    }
    ...
    if (data) {
      this.setState({
        error: null,
        updateText: (
          <div id="passwordResetEmailSent" className="reset-form alert alert-success">
            <FormattedMessage
      ...
      <div>
        ...
        <div className="col-sm-12">
          <div className="signup-team__container">
            ...
            <form onSubmit={this.handleSendLink} ref={this.resetForm}>
              <p>
                <FormattedMessage
              ...
              {error}
              <button id="passwordResetButton" type="submit" className="btn btn-primary">
