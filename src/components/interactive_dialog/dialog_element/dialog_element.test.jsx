...
describe('components/interactive_dialog/DialogElement', () => {
  ...
  it('subtype blank', () => {
    const wrapper = shallow(<DialogElement {...baseDialogProps} subtype="" />)
    expect(wrapper.matchesElement(<TextSetting {...baseTextSettingProps} type="input" />)).toEqual(true)
  })

  it('subtype email', () => {
    const wrapper = shallow(<DialogElement {...baseDialogProps} subtype="email" />)
    expect(wrapper.matchesElement(<TextSetting {...baseTextSettingProps} type="email" />)).toEqual(true)
  })

  it('subtype invalid', () => {
    const wrapper = shallow(<DialogElement {...baseDialogProps} subtype="invalid" />)
    expect(wrapper.matchesElement(<TextSetting {...baseTextSettingProps} type="input" />)).toEqual(true)
  })

  it('subtype password', () => {
    const wrapper = shallow(<DialogElement {...baseDialogProps} subtype="password" />)
    expect(wrapper.matchesElement(<TextSetting {...baseTextSettingProps} type="password" />)).toEqual(true)
  })
  ...
  describe('radioSetting', () => {
    ...
    test('RadioSetting is rendered when type is radio', () => {
      const wrapper = shallow(
        <DialogElement {...baseDialogProps} type="radio" options={radioOptions} onChange={jest.fn()} />
      )
    ...
    test('RadioSetting is rendered when options are null', () => {
      const wrapper = shallow(<DialogElement {...baseDialogProps} type="radio" options={null} onChange={jest.fn()} />)
    ...
    test('RadioSetting is rendered when options are null and value is null', () => {
      const wrapper = shallow(
        <DialogElement {...baseDialogProps} type="radio" options={null} value={null} onChange={jest.fn()} />
      )
    ...
    test('RadioSetting is rendered when options are null and value is not null', () => {
      const wrapper = shallow(
        <DialogElement {...baseDialogProps} type="radio" options={null} value={'a'} onChange={jest.fn()} />
      )
    ...
    test('RadioSetting is rendered when value is not one of the options', () => {
      const wrapper = shallow(
        <DialogElement {...baseDialogProps} type="radio" options={radioOptions} value={'a'} onChange={jest.fn()} />
      )
