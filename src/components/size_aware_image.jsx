...
export default class SizeAwareImage extends React.PureComponent {
    ...
    const image = (
      <img
        ...
        className={
          ...
          (this.props.handleSmallImageContainer && this.state.isSmallImage ? ' small-image--inside-container' : '')
        }
        src={src}
  ...
  renderImageOrPlaceholder = () => {
    ...
    if (this.dimensionsAvailable(dimensions) && !this.state.loaded) {
      placeHolder = (
        <div className={`image-loading__container ${this.props.className}`} style={{ maxWidth: dimensions.width }}>
    ...
    return (
      <React.Fragment>
        {placeHolder}
        <div className="file-preview__button" style={{ display: shouldShowImg ? 'initial' : 'none' }}>
