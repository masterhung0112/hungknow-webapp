...
export default class UsersEmailsInput extends React.PureComponent {
  ...
  loadingMessage = () => {
    const text = <FormattedMessage id={this.props.loadingMessageId} defaultMessage={this.props.loadingMessageDefault} />
  ...
  formatOptionLabel = (user, options) => {
    ...
    if (options.context === 'menu') {
      ...
      return (
        <React.Fragment>
          <Avatar size="lg" username={user.username} url={profileImg} />
    ...
    return (
      <div className="users-emails-input__option users-emails-input__option--no-matches">
        <FormattedMarkdownMessage
          ...
          disableLinks={true}
        >
          {(message) => <components.NoOptionsMessage {...props}>{message}</components.NoOptionsMessage>}
        </FormattedMarkdownMessage>
      </div>
    )
  }

  MultiValueRemove = ({ children, innerProps }) => <div {...innerProps}>{children || <CloseCircleSolidIcon />}</div>
    ...
    return (
      <>
        <AsyncSelect
          ...
          isMulti={true}
          isClearable={false}
          className={classNames('UsersEmailsInput', this.props.showError ? 'error' : '', {
        ...
        {this.props.showError && (
          <div className="InputErrorBox">
            <FormattedMarkdownMessage
              ...
              disableLinks={true}
            >
              {(message) => <components.NoOptionsMessage>{message}</components.NoOptionsMessage>}
            </FormattedMarkdownMessage>
