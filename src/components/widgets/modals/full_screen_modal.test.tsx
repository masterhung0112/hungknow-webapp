...
describe('components/widgets/modals/FullScreenModal', () => {
  test('showing content', () => {
    const wrapper = shallowWithIntl(
      <FullScreenModal show={true} onClose={jest.fn()} ariaLabel="test">
        {'test'}
      </FullScreenModal>
    )
...
`)
  ...
  test('not showing content', () => {
    const wrapper = shallowWithIntl(
      <FullScreenModal show={false} onClose={jest.fn()} ariaLabel="test">
        {'test'}
      </FullScreenModal>
    )
    expect(wrapper).toMatchInlineSnapshot(`
...
`)
  ...
  test('with back icon', () => {
    const wrapper = shallowWithIntl(
      <FullScreenModal show={true} onClose={jest.fn()} onGoBack={jest.fn()} ariaLabel="test">
        {'test'}
      </FullScreenModal>
    )
    expect(wrapper).toMatchInlineSnapshot(`
...
`)
  ...
  test('close on close icon click', () => {
    const close = jest.fn()
    const wrapper = shallowWithIntl(
      <FullScreenModal show={true} onClose={close} ariaLabel="test">
        {'test'}
      </FullScreenModal>
    )
  ...
  test('go back on back icon click', () => {
    const back = jest.fn()
    const wrapper = shallowWithIntl(
      <FullScreenModal show={true} onClose={jest.fn()} onGoBack={back} ariaLabel="test">
        {'test'}
      </FullScreenModal>
    )
