...
storiesOf('Widgets/Separator', module)
  ...
  .add('basic separator without text', () => {
    return <BasicSeparator />
  })
  .add('basic separator with text', () => {
    return <BasicSeparator>{text('Text', 'Some text')}</BasicSeparator>
  })
  .add('notification separator with text', () => {
    return <NotificationSeparator>{text('Text', 'Some text')}</NotificationSeparator>
  })
