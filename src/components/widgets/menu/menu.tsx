...
export default class Menu extends React.PureComponent<Props> {
  ...
  public render() {
    ...
    return (
      <div aria-label={ariaLabel} className="a11y__popup Menu" id={id} role="menu">
        <ul ref={this.node} style={styles} className="Menu__content dropdown-menu" onClick={this.handleMenuClick}>
          {children}
        </ul>
      </div>
    )
