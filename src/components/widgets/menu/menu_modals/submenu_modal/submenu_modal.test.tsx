...
describe('components/submenu_modal', () => {
  ...
  test('should match snapshot', () => {
    const wrapper = shallow(<SubMenuModal {...baseProps} />)
    expect(wrapper).toMatchSnapshot()
  })

  test('should match state when onHide is called', () => {
    const wrapper = shallow<SubMenuModal>(<SubMenuModal {...baseProps} />)
  ...
  test('should have called click function when button is clicked', async () => {
    ...
    const wrapper = mount(<SubMenuModal {...props} />)
  ...
  test('should have called props.onHide when Modal.onExited is called', () => {
    ...
    const wrapper = shallow(<SubMenuModal {...props} />)
