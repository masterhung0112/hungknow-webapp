...
export default class GifReactionsIcon extends React.PureComponent {
  render() {
    return (
      <span {...this.props}>
        <svg className="ic-svg ic-reactions-svg" width="14px" height="14px" viewBox="0 0 14 14" version="1.1">
          <g id="Finalized-Design" stroke="none" fill="inherit">
            <g id="GfyCat---Gycat-Tab" transform="translate(-1348.000000, -620.000000)" fill="inherit">
              <g id="modal---emojis" transform="translate(1147.000000, 542.000000)">
                <g id="tabs---gfycat" transform="translate(1.000000, 68.000000)">
                  <g id="tab---category---deselected" transform="translate(138.000000, 0.000000)">
                    <path
