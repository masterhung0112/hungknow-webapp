    ...
    return (
      <span {...this.props}>
        <svg width="30px" height="30px" viewBox="0 0 30 30">
          <g id="Developer-Export" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(-995.000000, -1372.000000)" id="All-Team-Members">
              <g transform="translate(245.000000, 698.000000)">
                <g id="Team-Administrators" transform="translate(0.000000, 651.000000)">
                  <g id="accordion-header">
                    <g id="accordion---expanded" transform="translate(750.000000, 23.000000)">
                      <path
                        ...
                        fill="#979797"
                      />
                      <circle id="Oval-2" stroke="#989898" strokeWidth="2" cx="15" cy="15" r="14" />
                    </g>
                  </g>
                </g>
              </g>
