    ...
    return (
      <div className="color-input input-group">
        ...
        {!this.props.isDisabled && (
          <span id={`${id}-squareColorIcon`} className="input-group-addon color-pad" onClick={this.togglePicker}>
            <i
        ...
        {isOpened && (
          <div ref={this.colorPicker} className="color-popover" id={`${id}-ChromePickerModal`}>
            <ChromePicker color={value} onChange={this.handleColorChange} disableAlpha={true} />
          </div>
        )}
      </div>
    )
