...
describe('components/AccessHistoryModal', () => {
  ...
  test('should have called actions.getUserAudits when onShow is called', () => {
    ...
    const wrapper: ShallowWrapper<any, any, AccessHistoryModal> = shallow(<AccessHistoryModal {...props} />)
  ...
  test('should match state when onHide is called', () => {
    const wrapper: ShallowWrapper<any, any, AccessHistoryModal> = shallow(<AccessHistoryModal {...baseProps} />)
