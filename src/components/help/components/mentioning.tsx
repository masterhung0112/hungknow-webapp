  ...
  return (
    <div>
      <h1 className="markdown__heading">
        <FormattedMessage id="help.mentioning.title" defaultMessage="Mentioning Teammates" />
      </h1>
      <hr />
      <h2 className="markdown__heading">
        <FormattedMessage id="help.mentioning.mentions.title" defaultMessage="@Mentions" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.mentioning.username.title" defaultMessage="@Username" />
      </h4>
      <p>
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.mentioning.channel.title" defaultMessage="@Channel" />
      </h4>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.mentioning.triggers.title" defaultMessage="Words That Trigger Mentions" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.mentioning.recent.title" defaultMessage="Recent Mentions" />
      </h2>
      <p>
        <FormattedMarkdownMessage
