  ...
  const renderRawExampleWithResult = (example: string | React.ReactNode): JSX.Element => {
    return (
      <div>
        ...
        <p>
          <FormattedMessage id="help.formatting.renders" defaultMessage="Renders as:" />
        </p>{' '}
  ...
  return (
    <div>
      <h1 className="markdown__heading">
        <FormattedMessage id="help.formatting.title" defaultMessage="Formatting Text" />
      </h1>
      <hr />
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.style.title" defaultMessage="Text Style" />
      </h2>
      <p>
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.code.title" defaultMessage="Code Block" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <p>
        <FormattedMessage id="help.formatting.example" defaultMessage="Example:" />
      </p>
      <FormattedMessage id="help.formatting.codeBlock" defaultMessage="Code block">
        {(example) => renderRawExampleWithResult('```\n' + example + '\n```')}
      </FormattedMessage>
      <h3 className="markdown__heading">
        <FormattedMessage id="help.formatting.syntax.title" defaultMessage="Syntax Highlighting" />
      </h3>
      <p>
        <FormattedMarkdownMessage
      ...
      <p>
        <FormattedMarkdownMessage id="help.formatting.githubTheme" defaultMessage="**GitHub Theme**" />
      </p>
      <p>
        <img
      ...
      <p>
        <FormattedMarkdownMessage id="help.formatting.solirizedDarkTheme" defaultMessage="**Solarized Dark Theme**" />
      </p>
      <p>
        <img
      ...
      <p>
        <FormattedMarkdownMessage id="help.formatting.solirizedLightTheme" defaultMessage="**Solarized Light Theme**" />
      </p>
      <p>
        <img
      ...
      <p>
        <FormattedMarkdownMessage id="help.formatting.monokaiTheme" defaultMessage="**Monokai Theme**" />
      </p>
      <p>
        <img
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.inline.title" defaultMessage="In-line Code" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.links.title" defaultMessage="Links" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.images.title" defaultMessage="In-line Images" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.emojis.title" defaultMessage="Emojis" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.lines.title" defaultMessage="Lines" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <Markdown message="***" />
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.quotes.title" defaultMessage="Block quotes" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <p>
        <FormattedMarkdownMessage id="help.formatting.quotesExample" defaultMessage="`> block quotes` renders as:" />
      </p>
      <p>
        <FormattedMarkdownMessage id="help.formatting.quotesRender" defaultMessage="> block quotes" />
      </p>
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.lists.title" defaultMessage="Lists" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <FormattedMessage id="help.formatting.orderedExample" defaultMessage={'1. Item one\n2. Item two'}>
        {(example) => renderRawExampleWithResult(example)}
      </FormattedMessage>
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.tables.title" defaultMessage="Tables" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.formatting.headings.title" defaultMessage="Headings" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <FormattedMessage id="help.formatting.headings2Example" defaultMessage={'Large Heading\n-------------'}>
        {(example) => renderRawExampleWithResult(example)}
      </FormattedMessage>
      <p className="links">
        <FormattedMessage id="help.learnMore" defaultMessage="Learn more about:" />
      </p>
      <ul>
        <li>
          <Link to="/help/messaging">
            <FormattedMessage id="help.link.messaging" defaultMessage="Basic Messaging" />
          </Link>
        </li>
        <li>
          <Link to="/help/composing">
            <FormattedMessage id="help.link.composing" defaultMessage="Composing Messages and Replies" />
          </Link>
        </li>
        <li>
          <Link to="/help/mentioning">
            <FormattedMessage id="help.link.mentioning" defaultMessage="Mentioning Teammates" />
          </Link>
        </li>
        <li>
          <Link to="/help/attaching">
            <FormattedMessage id="help.link.attaching" defaultMessage="Attaching Files" />
          </Link>
        </li>
        <li>
          <Link to="/help/commands">
            <FormattedMessage id="help.link.commands" defaultMessage="Executing Commands" />
          </Link>
        </li>
      </ul>
    </div>
