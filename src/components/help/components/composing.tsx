  ...
  return (
    <div>
      <h1 className="markdown__heading">
        <FormattedMessage id="help.composing.title" defaultMessage="Sending Messages" />
      </h1>
      <hr />
      <h2 className="markdown__heading">
        <FormattedMessage id="help.composing.types.title" defaultMessage="Message Types" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.composing.posts.title" defaultMessage="Posts" />
      </h4>
      <p>
        <FormattedMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.composing.replies.title" defaultMessage="Replies" />
      </h4>
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.composing.posting.title" defaultMessage="Posting a Message" />
      </h2>
      <p>
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.composing.editing.title" defaultMessage="Editing a Message" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.composing.deleting.title" defaultMessage="Deleting a message" />
      </h2>
      <p>
        <FormattedMarkdownMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.composing.linking.title" defaultMessage="Linking to a message" />
      </h2>
      <p>
        <FormattedMarkdownMessage
