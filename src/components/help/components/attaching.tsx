  ...
  return (
    <div>
      <h1 className="markdown__heading">
        <FormattedMessage id="help.attaching.title" defaultMessage="Attaching Files" />
      </h1>
      <hr />
      <h2 className="markdown__heading">
        <FormattedMessage id="help.attaching.methods.title" defaultMessage="Attachment Methods" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.attaching.dragdrop.title" defaultMessage="Drag and Drop" />
      </h4>
      <p>
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.attaching.icon.title" defaultMessage="Attachment Icon" />
      </h4>
      <p>
        <FormattedMarkdownMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.attaching.pasting.title" defaultMessage="Pasting Images" />
      </h4>
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.attaching.previewer.title" defaultMessage="File Previewer" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.attaching.publicLinks.title" defaultMessage="Sharing Public Links" />
      </h4>
      <p>
        <FormattedMarkdownMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.attaching.downloading.title" defaultMessage="Downloading Files" />
      </h4>
      <p>
        <FormattedMarkdownMessage
      ...
      <h4 className="markdown__heading">
        <FormattedMessage id="help.attaching.supported.title" defaultMessage="Supported Media Types" />
      </h4>
      <p>
        <FormattedMessage
      ...
      <ul>
        <li>
          <FormattedMessage id="help.attaching.supportedListItem1" defaultMessage="Images: BMP, GIF, JPG, JPEG, PNG" />
        </li>
        <li>
          <FormattedMessage id="help.attaching.supportedListItem2" defaultMessage="Video: MP4" />
        </li>
        <li>
          <FormattedMessage id="help.attaching.supportedListItem3" defaultMessage="Audio: MP3, M4A" />
        </li>
        <li>
          <FormattedMessage id="help.attaching.supportedListItem4" defaultMessage="Documents: PDF" />
        </li>
      </ul>
      <p>
        <FormattedMessage
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.attaching.limitations.title" defaultMessage="File Size Limitations" />
      </h2>
      <p>
        <FormattedMessage
      ...
      <ul>
        ...
        <li>
          <Link to="/help/formatting">
            <FormattedMessage id="help.link.formatting" defaultMessage="Formatting Messages Using Markdown" />
          </Link>
        </li>
        <li>
