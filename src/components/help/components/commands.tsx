  ...
  return (
    <div>
      <h1 className="markdown__heading">
        <FormattedMessage id="help.commands.title" defaultMessage="Executing Commands" />
      </h1>
      ...
      <h2 className="markdown__heading">
        <FormattedMessage id="help.commands.builtin.title" defaultMessage="Built-in Commands" />
      </h2>
      ...
      <h2 className="markdown__heading">
        <FormattedMarkdownMessage id="help.commands.custom.title" defaultMessage="Custom Commands" />
      </h2>
