...
export default class SelectTeamItem extends React.PureComponent<Props> {
  ...
  renderDescriptionTooltip = (): ReactNode => {
    ...
    const descriptionTooltip = <Tooltip id="team-description__tooltip">{team.description}</Tooltip>

    return (
      <OverlayTrigger delayShow={1000} placement="top" overlay={descriptionTooltip} rootClose={true} container={this}>
