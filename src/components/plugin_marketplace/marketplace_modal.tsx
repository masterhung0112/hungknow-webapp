...
import { MarketplacePlugin, PluginStatusRedux } from 'hkclient-ts/lib/types/plugins'
  ...
  if (installedPlugins.length === 0) {
    return (
      <div className="no_plugins_div">
        ...
        >
          <FormattedMessage id="marketplace_modal.install_plugins" defaultMessage="Install Plugins" />
        </button>
      </div>
    )
  }
...
export class MarketplaceModal extends React.PureComponent<MarketplaceModalProps, MarketplaceModalState> {
  ...
  render(): JSX.Element {
    ...
    if (this.state.serverError) {
      errorBanner = (
        <div className="error-bar" id="error_bar">
    ...
    return (
      <RootPortal>
        ...
        >
          {errorBanner}
          <div className="modal-marketplace" id="modal_marketplace">
            <h1>
              <strong>
                <FormattedMessage id="marketplace_modal.title" defaultMessage="Plugin Marketplace" />
              </strong>
            </h1>
            {input}
            <Tabs
            ...
            >
              ...
              <Tab
                ...
                title={
                  localizeMessage('marketplace_modal.tabs.installed_plugins', 'Installed') +
                  ` (${this.props.installedPlugins.length})`
                }
              >
                <InstalledPlugins installedPlugins={this.props.installedPlugins} changeTab={this.changeTab} />
              </Tab>
            </Tabs>
          </div>
        </FullScreenModal>
