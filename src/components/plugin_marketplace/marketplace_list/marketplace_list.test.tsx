...
import { AuthorType, MarketplacePlugin, ReleaseStage } from 'hkclient-ts/lib/types/plugins'
...
describe('components/marketplace/marketplace_list', () => {
  ...
  it('should set page to 0 when list of plugins changed', () => {
    const wrapper = shallow<MarketplaceList>(<MarketplaceList plugins={[samplePlugin, samplePlugin]} />)
