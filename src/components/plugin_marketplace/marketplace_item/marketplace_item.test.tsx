...
describe('components/MarketplaceItem', () => {
  describe('UpdateDetails', () => {
    ...
    it('should render with release notes url', () => {
      const wrapper = mount(<UpdateDetails {...baseProps} />)
  ...
  describe('MarketplaceItem', () => {
    ...
    test('should render', () => {
      const wrapper = shallow<MarketplaceItem>(<MarketplaceItem {...baseProps} />)
    ...
    test('should render with no plugin description', () => {
      ...
      const wrapper = shallow(<MarketplaceItem {...props} />)
    ...
    test('should render with no plugin icon', () => {
      ...
      const wrapper = shallow<MarketplaceItem>(<MarketplaceItem {...props} />)
