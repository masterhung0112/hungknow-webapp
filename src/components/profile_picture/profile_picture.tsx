...
export default class ProfilePicture extends React.PureComponent<Props> {
  ...
  public render() {
    ...
    const profileSrc =
      typeof this.props.profileSrc === 'string' && this.props.profileSrc !== '' ? this.props.profileSrc : this.props.src
        ...
        >
          <button className={`status-wrapper style--none ${this.props.wrapperClass}`} tabIndex={-1}>
            <span className={profileIconClass}>
              <Avatar username={this.props.username} size={this.props.size} url={this.props.src} />
            </span>
    ...
    return (
      <span className={`status-wrapper style--none ${this.props.wrapperClass}`}>
        <span className={profileIconClass}>
          <Avatar size={this.props.size} url={this.props.src} />
        </span>
        {this.props.newStatusIcon ? (
          <StatusIconNew className={this.props.statusClass} status={this.props.status} />
        ) : (
          <StatusIcon status={this.props.status} />
        )}
      </span>
