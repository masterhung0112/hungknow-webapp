...
export default class RhsCard extends React.Component {
  ...
  render() {
    ...
    let user = <UserProfile userId={selected.user_id} hideStatus={true} disablePopover={true} />
    ...
    const avatar = <PostProfilePicture compactDisplay={false} post={selected} userId={selected.user_id} />
          ...
          <div className="post-right__scroll">
            ...
            <div className="d-flex post-card--info">
              ...
              <div className="post-card--view-post">
                <Link to={`${teamUrl}/pl/${selected.id}`} className="post__permalink" onClick={this.handleClick}>
                  <FormattedMessage id="rhs_card.jump" defaultMessage="Jump" />
                </Link>
              </div>
            </div>
          </div>
