...
import { getPostThread } from 'hkclient-ts/lib/actions/posts'
...
describe('components/PermalinkView', () => {
  ...
  test('should match snapshot', () => {
    const wrapper = shallow(<PermalinkView {...baseProps} />)
  ...
  test('should match snapshot with archived channel', () => {
    ...
    const wrapper = shallow(<PermalinkView {...props} />)
        ...
        expect(testStore.getActions()).toEqual([
          {
            ...
            data: {
              posts: { dmpostid1: { id: 'dmpostid1', message: 'some message', channel_id: 'dmchannelid' } },
              order: ['dmpostid1'],
            },
          },
        ])
        ...
        expect(testStore.getActions()).toEqual([
          {
            type: 'MOCK_GET_POST_THREAD',
            data: {
              posts: { gmpostid1: { id: 'gmpostid1', message: 'some message', channel_id: 'gmchannelid' } },
              order: ['gmpostid1'],
            },
          },
        ])
        ...
        expect(testStore.getActions()).toEqual([
          {
            type: 'MOCK_GET_POST_THREAD',
            data: {
              posts: { postid1: { id: 'postid1', message: 'some message', channel_id: 'channelid1' } },
              order: ['postid1'],
            },
          },
