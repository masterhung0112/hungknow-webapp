...
describe('components/SizeAwareImage', () => {
  ...
  test('should surround the image with container div if the image is small', () => {
    ...
    expect(wrapper.find('div.small-image__container').prop('className')).toEqual(
  ...
  test('should properly set container div width', () => {
    ...
    expect(wrapper.find('div.small-image__container').prop('style')).toHaveProperty('width', 222)
    ...
    expect(wrapper.find('div.small-image__container').hasClass('small-image__container--min-width')).toEqual(true)
  })
