...
import { getFullName } from 'hkclient-ts/lib/utils/user_utils'
  ...
  render() {
    ...
    if (!this.state.saving) {
      if (this.state.submitError) {
        errorMsg = (
          <label id="add-user-to-channel-modal__invite-error" className="modal__error has-error control-label">
            {this.state.submitError}
          </label>
        )
      } else if (targetUserIsMemberOfSelectedChannel) {
        errorMsg = (
          <label id="add-user-to-channel-modal__user-is-member" className="modal__error has-error control-label">
            <FormattedMessage
        ...
        <form role="form" onSubmit={this.handleSubmit}>
          ...
          <Modal.Footer>
            <button type="button" className="btn btn-link" onClick={this.onHide}>
              <FormattedMessage id="add_user_to_channel_modal.cancel" defaultMessage="Cancel" />
            </button>
            <button
              type="button"
            ...
            >
              <FormattedMessage id="add_user_to_channel_modal.add" defaultMessage="Add" />
            </button>
          </Modal.Footer>
        </form>
      </Modal>
