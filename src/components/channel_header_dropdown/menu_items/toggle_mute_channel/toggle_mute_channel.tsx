...
import { Channel, ChannelNotifyProps } from 'hkclient-ts/lib/types/channels'
...
export default class MenuItemToggleMuteChannel extends React.PureComponent<Props> {
  ...
  render() {
    ...
    return <Menu.ItemAction id={id} onClick={this.handleClick} text={text} />
  }
}
