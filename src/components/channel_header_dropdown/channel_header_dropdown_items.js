    ...
    return (
      <React.Fragment>
        <Menu.Group divider={divider}>
          ...
          />
          <MenuItemViewPinnedPosts id="channelViewPinnedPosts" show={isMobile} channel={channel} />
          <Menu.ItemToggleModalRedux
        ...
        <Menu.Group divider={divider}>
          <Menu.ItemToggleModalRedux
            ...
            show={
              (channel.type === Constants.DM_CHANNEL || channel.type === Constants.GM_CHANNEL) &&
              !isArchived &&
              !isReadonly
            }
        ...
        <Menu.Group divider={divider}>
          {isMobile && <MobileChannelHeaderPlug channel={channel} isDropdown={true} />}
          ...
          />
          <MenuItemCloseMessage id="channelCloseMessage" channel={channel} currentUser={user} />
          <MenuItemCloseChannel id="channelCloseChannel" isArchived={isArchived} />
        </Menu.Group>
