...
export default class SettingPicture extends Component {
  ...
  renderImg = () => {
      ...
      return (
        <div className={`${imageContext}-img-preview`}>
          <div className="img-preview__image">
            <div alt={`${imageContext} image preview`} style={imageStyles} className={`${imageContext}-img-preview`} />
          </div>
        </div>
      )
    }
    ...
    if (this.state.setDefaultSrc) {
      return <img className={`${imageContext}-img`} alt={`${imageContext} image`} src={this.props.defaultImageSrc} />
    }

    if (this.props.src && !this.state.removeSrc) {
      const imageElement = <img className={`${imageContext}-img`} alt={`${imageContext} image`} src={this.props.src} />
      ...
      if (this.props.onRemove) {
        title = <FormattedMessage id="setting_picture.remove" defaultMessage="Remove This Icon" />
        handler = this.handleRemoveSrc
      } else if (this.props.onSetDefault) {
        title = <FormattedMessage id="setting_picture.remove_profile_picture" defaultMessage="Remove Profile Picture" />
      ...
      return (
        <div className={`${imageContext}-img__container`}>
          ...
          >
            <button data-testid="removeSettingPicture" className={`${imageContext}-img__remove`} onClick={handler}>
