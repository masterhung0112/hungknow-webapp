...
export default class BleveSettings extends AdminSettings {
  ...
  renderTitle() {
    return <FormattedMessage id="admin.bleve.title" defaultMessage="Bleve" />
  }
  ...
  renderSettings = () => {
    return (
      <SettingsGroup>
        <BooleanSetting
          id="enableIndexing"
          label={<FormattedMessage id="admin.bleve.enableIndexingTitle" defaultMessage="Enable Bleve Indexing:" />}
          helpText={
            <FormattedMessage
        ...
        <TextSetting
          id="indexDir"
          label={<FormattedMessage id="admin.bleve.indexDirTitle" defaultMessage="Index Directory:" />}
          helpText={
            <FormattedMessage
        ...
        <div className="form-group">
          <label className="control-label col-sm-4">
            <FormattedMessage id="admin.bleve.bulkIndexingTitle" defaultMessage="Bulk Indexing:" />
          </label>
          <div className="col-sm-8">
            <div className="job-table-setting">
              <JobsTable
                ...
                createJobButtonText={<FormattedMessage id="admin.bleve.createJob.title" defaultMessage="Index Now" />}
                createJobHelpText={
                  <FormattedMessage
        ...
        <RequestButton
          ...
          buttonText={<FormattedMessage id="admin.bleve.purgeIndexesButton" defaultMessage="Purge Index" />}
          successMessage={{
          ...
          disabled={!this.state.canPurgeAndIndex || this.props.isDisabled}
          label={<FormattedMessage id="admin.bleve.purgeIndexesButton.label" defaultMessage="Purge Indexes:" />}
        />
        <BooleanSetting
          id="enableSearching"
          label={
            <FormattedMessage id="admin.bleve.enableSearchingTitle" defaultMessage="Enable Bleve for search queries:" />
          }
          helpText={
            <FormattedMessage
