      ...
      <SettingsGroup>
        <div>
          <TextSetting
            ...
            label={<FormattedMessage id="admin.password.minimumLength" defaultMessage="Minimum Password Length:" />}
          ...
          />
          <Setting label={<FormattedMessage id="passwordRequirements" defaultMessage="Password Requirements:" />}>
            <div>
              <label className="checkbox-inline">
                ...
                />
                <FormattedMessage id="admin.password.lowercase" defaultMessage="At least one lowercase letter" />
              </label>
            </div>
            <div>
              <label className="checkbox-inline">
                ...
                />
                <FormattedMessage id="admin.password.uppercase" defaultMessage="At least one uppercase letter" />
              </label>
            </div>
            <div>
              <label className="checkbox-inline">
        ...
        <TextSetting
          ...
          label={<FormattedMessage id="admin.service.attemptTitle" defaultMessage="Maximum Login Attempts:" />}
