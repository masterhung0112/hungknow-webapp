...
const noBillingHistory = (
  <div className="BillingSummary__noBillingHistory">
    <img className="BillingSummary__noBillingHistory-graphic" src={noBillingHistoryGraphic} />
    ...
    case 'paid':
      return (
        <div className="BillingSummary__lastInvoice-headerStatus paid">
          <FormattedMessage id="admin.billing.subscriptions.billing_summary.lastInvoice.paid" defaultMessage="Paid" />
  ...
  if (subscription && subscription.last_invoice) {
    ...
    body = (
      <div className="BillingSummary__lastInvoice">
        ...
        <div className="BillingSummary__lastInvoice-productName">{product?.name}</div>
        <hr />
        {fullCharges.map((charge) => (
          <div key={charge.price_id} className="BillingSummary__lastInvoice-charge">
