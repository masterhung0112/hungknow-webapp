...
const addInfoButton = (
  <div className="PaymentInfoDisplay__addInfo">
    ...
    >
      ...
      <FormattedMessage id="admin.billing.payment_info.add" defaultMessage="Add a Credit Card" />
    </BlockableLink>
  </div>
)
...
const noPaymentInfoSection = (
  <div className="PaymentInfoDisplay__noPaymentInfo">
    <img className="ComapnyInfoDisplay__noPaymentInfo-graphic" src={noPaymentInfoGraphic} />
      ...
      <div className="PaymentInfoDisplay__paymentInfo">
        <div className="PaymentInfoDisplay__paymentInfo-text">
          ...
          <div className="PaymentInfoDisplay__paymentInfo-addressTitle">
            <FormattedMessage id="admin.billing.payment_info.billingAddress" defaultMessage="Billing Address" />
          </div>
