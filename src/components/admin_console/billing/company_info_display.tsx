...
const addInfoButton = (
  <div className="CompanyInfoDisplay__addInfo">
    ...
    >
      ...
      <FormattedMessage id="admin.billing.company_info.add" defaultMessage="Add Company Information" />
    </BlockableLink>
  </div>
)
...
const noCompanyInfoSection = (
  <div className="CompanyInfoDisplay__noCompanyInfo">
    <img className="ComapnyInfoDisplay__noCompanyInfo-graphic" src={noCompanyInfoGraphic} />
    ...
    body = (
      <div className="CompanyInfoDisplay__companyInfo">
        <div className="CompanyInfoDisplay__companyInfo-text">
          <div className="CompanyInfoDisplay__companyInfo-name">{companyInfo?.name}</div>
          ...
          <div className="CompanyInfoDisplay__companyInfo-addressTitle">
            <FormattedMessage id="admin.billing.company_info.companyAddress" defaultMessage="Company Address" />
          </div>
      ...
      <div className="CompanyInfoDisplay__header">
        <div className="CompanyInfoDisplay__headerText">
          <div className="CompanyInfoDisplay__headerText-top">
            <FormattedMessage id="admin.billing.company_info_display.companyDetails" defaultMessage="Company Details" />
          </div>
