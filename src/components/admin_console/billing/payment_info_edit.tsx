...
import { getCloudCustomer } from 'hkclient-ts/lib/actions/cloud'
  ...
  return (
    <div className="wrapper--fixed PaymentInfoEdit">
      <div className="admin-console__header with-back">
        <div>
          <BlockableLink to="/admin_console/billing/payment_info" className="fa fa-angle-left back" />
          <FormattedMessage id="admin.billing.payment_info_edit.title" defaultMessage="Edit Payment Information" />
        </div>
      </div>
            ...
            <AlertBanner
              ...
              message={
                <>
                  ...
                  />
                  <a target="_new" rel="noopener noreferrer" href={CloudLinks.BILLING_DOCS}>
                    <FormattedMessage
      ...
      <div className="admin-console-save">
        <SaveButton
          ...
          defaultMessage={
            <FormattedMessage id="admin.billing.payment_info_edit.save" defaultMessage="Save credit card" />
          }
        />
        <BlockableLink className="cancel-button" to="/admin_console/billing/payment_info">
          <FormattedMessage id="admin.billing.payment_info_edit.cancel" defaultMessage="Cancel" />
        </BlockableLink>
        {isValid === false && (
