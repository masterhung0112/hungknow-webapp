...
import { getCloudCustomer, updateCloudCustomer, updateCloudCustomerAddress } from 'hkclient-ts/lib/actions/cloud'
...
const CompanyInfoEdit: React.FC<Props> = () => {
  ...
  const [sameAsBillingAddress, setSameAsBillingAddress] = useState(
    Boolean(!companyInfo?.company_address?.line1 && companyInfo?.billing_address?.line1)
  )
  ...
  const billingAddressDisplay = (
    <>
      <div className="CompanyInfoEdit__companyInfo-addressTitle">
        <FormattedMessage id="admin.billing.company_info.billingAddress" defaultMessage="Billing Address" />
      </div>
    ...
    <>
      ...
      <div className="form-row">
        <div className="form-row-third-1 selector">
          <StateSelector country={country!} state={state!} onChange={(stateValue) => setState(stateValue)} />
        </div>
  ...
  return (
    <div className="wrapper--fixed CompanyInfoEdit">
      <div className="admin-console__header with-back">
        <div>
          <BlockableLink to="/admin_console/billing/company_info" className="fa fa-angle-left back" />
          <FormattedMessage id="admin.billing.company_info_edit.title" defaultMessage="Edit Company Information" />
        </div>
      </div>
        ...
        <div className="admin-console__content">
          <div className="CompanyInfoEdit__card">
            <div className="CompanyInfoEdit__form">
              ...
              {sameAsBillingAddress && companyInfo?.billing_address?.line1
      ...
      <div className="admin-console-save">
        <SaveButton
          ...
          defaultMessage={<FormattedMessage id="admin.billing.company_info_edit.save" defaultMessage="Save info" />}
        />
        <BlockableLink className="cancel-button" to="/admin_console/billing/company_info">
          <FormattedMessage id="admin.billing.company_info_edit.cancel" defaultMessage="Cancel" />
        </BlockableLink>
      </div>
    </div>
  )
