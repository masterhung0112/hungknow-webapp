...
export default class DatabaseSettings extends AdminSettings {
  ...
  renderTitle() {
    return <FormattedMessage id="admin.database.title" defaultMessage="Database Settings" />
  }
    ...
    if (this.props.license.IsLicensed === 'true') {
      recycleDbButton = (
        <RequestButton
          ...
          buttonText={<FormattedMessage id="admin.recycle.button" defaultMessage="Recycle Database Connections" />}
    ...
    return (
      <SettingsGroup>
        ...
        <div className="form-group">
          <label className="control-label col-sm-4" htmlFor="DriverName">
            <FormattedMessage id="admin.sql.driverName" defaultMessage="Driver Name:" />
          </label>
          <div className="col-sm-8">
            <input type="text" className="form-control" value={this.state.driverName} disabled={true} />
        ...
        <div className="form-group">
          <label className="control-label col-sm-4" htmlFor="DataSource">
            <FormattedMessage id="admin.sql.dataSource" defaultMessage="Data Source:" />
          </label>
          <div className="col-sm-8">
            <input type="text" className="form-control" value={dataSource} disabled={true} />
            <div className="help-text">
              <FormattedMessage
        ...
        <TextSetting
          id="maxIdleConns"
          label={<FormattedMessage id="admin.sql.maxConnectionsTitle" defaultMessage="Maximum Idle Connections:" />}
        ...
        <TextSetting
          id="maxOpenConns"
          label={<FormattedMessage id="admin.sql.maxOpenTitle" defaultMessage="Maximum Open Connections:" />}
        ...
        <TextSetting
          id="queryTimeout"
          label={<FormattedMessage id="admin.sql.queryTimeoutTitle" defaultMessage="Query Timeout:" />}
        ...
        <TextSetting
          ...
          label={<FormattedMessage id="admin.sql.connMaxLifetimeTitle" defaultMessage="Maximum Connection Lifetime:" />}
        ...
        <TextSetting
          ...
          label={
            <FormattedMessage id="admin.sql.connMaxIdleTimeTitle" defaultMessage="Maximum Connection Idle Time:" />
          }
        ...
        <TextSetting
          ...
          label={
            <FormattedMessage id="admin.service.minimumHashtagLengthTitle" defaultMessage="Minimum Hashtag Length:" />
          }
        ...
        <BooleanSetting
          id="trace"
          label={<FormattedMessage id="admin.sql.traceTitle" defaultMessage="SQL Statement Logging: " />}
          helpText={
            <FormattedMessage
        ...
        <BooleanSetting
          ...
          label={
            <FormattedMessage id="admin.sql.disableDatabaseSearchTitle" defaultMessage="Disable database search: " />
          }
          helpText={
            <FormattedMarkdownMessage
