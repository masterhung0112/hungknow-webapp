...
import { AdminConfig, EnvironmentConfig } from 'hkclient-ts/lib/types/config'
...
export default abstract class AdminSettings<Props extends BaseProps, State extends BaseState> extends React.Component<
  Props,
  State
> {
