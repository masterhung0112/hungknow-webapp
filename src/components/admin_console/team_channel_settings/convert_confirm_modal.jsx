...
export default class ConvertConfirmModal extends React.PureComponent {
  ...
  render() {
    ...
    const titleId = toPublic
      ? t('admin.team_channel_settings.convertConfirmModal.toPublicTitle')
    ...
    const confirmMsgId = toPublic
      ? t('admin.team_channel_settings.convertConfirmModal.toPublicConfirm')
    ...
    const confirmButton = (
      <FormattedMessage id={confirmMsgId} defaultMessage={toPublic ? toPublicConfirmMsg : toPrivateConfirmMsg} />
    )

    const cancelButton = (
      <FormattedMessage id="admin.team_channel_settings.convertConfirmModal.cancel" defaultMessage="No, cancel" />
    )
