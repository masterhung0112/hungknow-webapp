...
const AllowAllToggle: React.SFC<Props> = (props: Props): JSX.Element | null => {
  ...
  return (
    <LineSwitch
      ...
      onText={<FormattedMessage id="channel_toggle_button.public" defaultMessage="Public" />}
      offText={<FormattedMessage id="channel_toggle_button.private" defaultMessage="Private" />}
    />
  )
}
