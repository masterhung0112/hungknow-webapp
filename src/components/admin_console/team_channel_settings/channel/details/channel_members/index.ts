...
import {ActionResult, ActionFunc, GenericAction} from 'hkclient-redux/types/actions';
import {ChannelStats} from 'hkclient-redux/types/channels';

import {getChannelStats} from 'hkclient-redux/actions/channels';
import {getFilteredUsersStats} from 'hkclient-redux/actions/users';
