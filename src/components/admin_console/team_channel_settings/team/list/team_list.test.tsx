...
describe('admin_console/team_channel_settings/team/TeamList', () => {
  test('should match snapshot', () => {
    ...
    const wrapper = shallow(<TeamList data={testTeams} total={testTeams.length} actions={actions} />)
  ...
  test('should match snapshot with paging', () => {
    ...
    const wrapper = shallow(<TeamList data={testTeams} total={30} actions={actions} />)
    wrapper.setState({ loading: false })
    expect(wrapper).toMatchSnapshot()
  })
})
