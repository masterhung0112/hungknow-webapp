  ...
  handleSubmit = async () => {
    ...
    if (allowedDomainsChecked && allowedDomains.trim().length === 0) {
      ...
      const patchTeamSyncable = groups
        ...
        .map((g) =>
          actions.patchGroupSyncable(g.id, teamID, Groups.SYNCABLE_TYPE_TEAM, { scheme_admin: g.scheme_admin })
        )
      ...
      const link = groups
        ...
        .map((g) =>
          actions.linkGroupSyncable(g.id, teamID, Groups.SYNCABLE_TYPE_TEAM, {
            auto_add: true,
    ...
    return (
      <div className="wrapper--fixed">
        <div className="admin-console__header with-back">
          <div>
            <BlockableLink to="/admin_console/user_management/teams" className="fa fa-angle-left back" />
            <FormattedMessage
