...
export default class UsersToBeRemovedModal extends React.PureComponent {
  ...
  render() {
    ...
    const button = (
      <FormattedMessage id="admin.team_channel_settings.usersToBeRemovedModal.close" defaultMessage="Close" />
    )
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <GroupsUsers members={users} total={total} scope={scope} scopeId={scopeId} />
        </Modal.Body>
        <Modal.Footer>
          <button
            type="button"
