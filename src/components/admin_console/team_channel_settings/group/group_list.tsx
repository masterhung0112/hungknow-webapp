  ...
  return (
    <div className="groups-list--header">
      <div className="group-name group-name-adjusted">
        <FormattedMessage id="admin.team_channel_settings.group_list.nameHeader" defaultMessage="Group Name" />
      </div>
      <div className="group-content">
        <div className="group-description group-description-adjusted">
          <FormattedMessage id="admin.team_channel_settings.group_list.membersHeader" defaultMessage="Member Count" />
        </div>
        <div className="group-description group-description-adjusted">
          <FormattedMessage id="admin.team_channel_settings.group_list.rolesHeader" defaultMessage="Roles" />
        </div>
...
export default class GroupList extends React.PureComponent<Props> {
  ...
  render(): JSX.Element {
    return <AbstractList header={<Header />} renderRow={this.renderRow} {...this.props} />
  }
}
