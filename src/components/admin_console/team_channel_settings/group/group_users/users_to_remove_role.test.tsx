...
describe('components/admin_console/team_channel_settings/group/UsersToRemoveRole', () => {
  ...
  test('should match snapshot scope team and regular membership', () => {
    const wrapper = mountWithIntl(
      <IntlProvider locale="en" messages={{}}>
        <UsersToRemoveRole user={userWithGroups} scope={scopeTeam} membership={teamMembership} />
      </IntlProvider>
    ).childAt(0)
  ...
  test('should match snapshot scope team and admin membership', () => {
    const wrapper = mountWithIntl(
      <IntlProvider locale="en" messages={{}}>
        <UsersToRemoveRole user={userWithGroups} scope={scopeTeam} membership={adminTeamMembership} />
      </IntlProvider>
    ).childAt(0)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  test('should match snapshot scope channel and regular membership', () => {
    const wrapper = mountWithIntl(
      <IntlProvider locale="en" messages={{}}>
        <UsersToRemoveRole user={userWithGroups} scope={scopeChannel} membership={channelMembership} />
      </IntlProvider>
    ).childAt(0)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  test('should match snapshot scope channel and admin membership', () => {
    const wrapper = mountWithIntl(
      <IntlProvider locale="en" messages={{}}>
        <UsersToRemoveRole user={userWithGroups} scope={scopeChannel} membership={adminChannelMembership} />
      </IntlProvider>
    ).childAt(0)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  test('should match snapshot scope channel and admin membership but user is sys admin', () => {
    const wrapper = mountWithIntl(
      <IntlProvider locale="en" messages={{}}>
        <UsersToRemoveRole user={adminUserWithGroups} scope={scopeChannel} membership={adminChannelMembership} />
      </IntlProvider>
    ).childAt(0)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  test('should match snapshot guest', () => {
    const wrapper = mountWithIntl(
      <IntlProvider locale="en" messages={{}}>
        <UsersToRemoveRole user={guestUserWithGroups} scope={scopeTeam} membership={guestMembership} />
      </IntlProvider>
    ).childAt(0)
    expect(wrapper).toMatchSnapshot()
  })
