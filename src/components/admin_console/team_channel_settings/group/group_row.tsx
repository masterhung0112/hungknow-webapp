...
export default class GroupRow extends React.PureComponent<GroupRowProps> {
  ...
  displayCurrentRole = () => {
    ...
    const channelAdmin = (
      <FormattedMessage id="admin.team_channel_settings.group_row.channelAdmin" defaultMessage="Channel Admin" />
    )
    const teamAdmin = (
      <FormattedMessage id="admin.team_channel_settings.group_row.teamAdmin" defaultMessage="Team Admin" />
    )
    const member = <FormattedMessage id="admin.team_channel_settings.group_row.member" defaultMessage="Member" />
        ...
        <div id="group-row" className="group-row">
          ...
          <div className="group-description row-content roles">
            <MenuWrapper isDisabled={this.props.isDisabled}>
              ...
              >
                <Menu.ItemAction id="role-to-be" onClick={this.setNewGroupRole} text={this.displayRoleToBe()} />
              </Menu>
            </MenuWrapper>
          </div>
          <span id="group-actions" className="group-actions">
            <a href="#" onClick={this.removeGroup} className={this.props.isDisabled ? 'disabled' : ''}>
              <FormattedMessage id="admin.team_channel_settings.group_row.remove" defaultMessage="Remove" />
            </a>
          </span>
        </div>
      </div>
