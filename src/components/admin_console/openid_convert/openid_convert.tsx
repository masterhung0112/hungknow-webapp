    ...
    return (
      <div className="OpenIdConvert">
        <div className="OpenIdConvert_imageWrapper">
          <img className="OpenIdConvert_image" src={imagePath} alt="OpenId Convert Image" />
        </div>
        ...
        <div className="OpenIdConvert_copyWrapper">
          ...
          <div className="OpenIdConvert_actionWrapper">
            ...
            >
              <FormattedMessage id="admin.openIdConvert.text" defaultMessage="Convert to OpenID Connect" />
            </button>
            <a
            ...
            >
              <FormattedMessage id="admin.openIdConvert.help" defaultMessage="Learn more" />
            </a>
