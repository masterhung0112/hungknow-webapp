  ...
  <div>
    <table className="table table-bordered" cellPadding="5">
      <tbody>
        <tr>
          <td>
            <FormattedMessage id="admin.webserverModeGzip" defaultMessage="gzip" />
          </td>
          <td>
            <FormattedMessage
        ...
        <tr>
          <td>
            <FormattedMessage id="admin.webserverModeUncompressed" defaultMessage="Uncompressed" />
          </td>
          <td>
            <FormattedMessage
        ...
        <tr>
          <td>
            <FormattedMessage id="admin.webserverModeDisabled" defaultMessage="Disabled" />
          </td>
          <td>
            <FormattedMessage
