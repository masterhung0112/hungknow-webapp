...
export default class SystemUsersDropdown extends React.PureComponent<Props, State> {
  ...
  renderPromoteToUserModal = () => {
    ...
    const promoteUserButton = <FormattedMessage id="promote_to_user_modal.promote" defaultMessage="Promote" />
  ...
  renderDemoteToGuestModal = () => {
    ...
    const demoteGuestButton = <FormattedMessage id="demote_to_user_modal.demote" defaultMessage="Demote" />
  ...
  renderRevokeSessionsModal = () => {
    ...
    const revokeUserButtonButton = <FormattedMessage id="revoke_user_sessions_modal.revoke" defaultMessage="Revoke" />
  ...
  render() {
    ...
    if (isGuest) {
      currentRoles = <FormattedMessage id="team_members_dropdown.guest" defaultMessage="Guest" />
    }
