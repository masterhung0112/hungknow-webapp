...
export default class MessageExportSettings extends AdminSettings {
  ...
  renderTitle() {
    return <FormattedMessage id="admin.complianceExport.title" defaultMessage="Compliance Export (Beta)" />
  }
    ...
    const exportFormatOptions = [
      {
        ...
        text: Utils.localizeMessage('admin.complianceExport.exportFormat.actiance', 'Actiance XML'),
      },
      {
        value: exportFormats.EXPORT_FORMAT_CSV,
        text: Utils.localizeMessage('admin.complianceExport.exportFormat.csv', 'CSV'),
      },
      {
        value: exportFormats.EXPORT_FORMAT_GLOBALRELAY,
        text: Utils.localizeMessage('admin.complianceExport.exportFormat.globalrelay', 'GlobalRelay EML'),
      },
    ]
      ...
      const globalRelayCustomerType = (
        <RadioSetting
          ...
          values={[
            {
              value: 'A9',
              text: Utils.localizeMessage('admin.complianceExport.globalRelayCustomerType.a9.description', 'A9/Type 9'),
            },
            {
              value: 'A10',
    ...
    return (
      <SettingsGroup>
        <BooleanSetting
          ...
          label={
            <FormattedMessage id="admin.service.complianceExportTitle" defaultMessage="Enable Compliance Export:" />
          }
          helpText={
            <FormattedMarkdownMessage
        ...
        <DropdownSetting
          ...
          label={<FormattedMessage id="admin.complianceExport.exportFormat.title" defaultMessage="Export Format:" />}
