...
export const it = {
  not: (func) => (config, state, license, enterpriseReady, consoleAccess, cloud, isSystemAdmin) => {
    return typeof func === 'function'
      ? !func(config, state, license, enterpriseReady, consoleAccess, cloud, isSystemAdmin)
      : !func
  },
...
const usesLegacyOauth = (config, state, license, enterpriseReady, consoleAccess, cloud) => {
  return it.any(
    it.all(
      ...
      it.any(it.configIsTrue('GitLabSettings', 'Id'), it.configIsTrue('GitLabSettings', 'Secret'))
    ),
    it.all(
      it.not(it.configContains('GoogleSettings', 'Scope', 'openid')),
      it.any(it.configIsTrue('GoogleSettings', 'Id'), it.configIsTrue('GoogleSettings', 'Secret'))
    ),
    it.all(
      it.not(it.configContains('Office365Settings', 'Scope', 'openid')),
      it.any(it.configIsTrue('Office365Settings', 'Id'), it.configIsTrue('Office365Settings', 'Secret'))
    )
...
const AdminDefinition = {
  ...
  billing: {
    ...
    subscription: {
      ...
      searchableStrings: ['admin.billing.subscription.title'],
      schema: {
  ...
  reporting: {
    ...
    server_logs: {
      ...
      isHidden: it.any(it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin')),
  ...
  user_management: {
    ...
    permissions: {
      ...
      isHidden: it.any(it.not(it.licensed), it.not(it.userHasReadPermissionOnResource('user_management.permissions'))),
      isDisabled: it.not(it.userHasWritePermissionOnResource('user_management.permissions')),
      schema: {
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              'A comma-separated list of paths on the Mattermost server that are managed by another service. See [here](!https://docs.mattermost.com/install/desktop-managed-resources.html) for more information.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('environment')),
          },
          {
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_markdown: true,
            help_text_default:
              '(Optional) Only required if you do not want to authenticate to S3 using an [IAM role](!https://about.mattermost.com/default-iam-role). Enter the Access Key ID provided by your Amazon EC2 administrator.',
          ...
          },
          {
            ...
            help_text_markdown: true,
            help_text_default:
              'When true, encrypt files in Amazon S3 using server-side encryption with Amazon S3-managed keys. See [documentation](!https://about.mattermost.com/default-server-side-encryption) to learn more.',
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_values: {
              boldedLogLevel: (
                <strong>
                  <FormattedMessage id="admin.log.logLevel" defaultMessage="Log Level" />
                </strong>
              ),
            },
            isDisabled: it.not(it.userHasWritePermissionOnResource('environment')),
          },
          {
            ...
            help_text_default:
              'Enable this feature to improve the quality and performance of Mattermost by sending error reporting and diagnostic information to Mattermost, Inc. Read our [privacy policy](!https://about.mattermost.com/default-privacy-policy/) to learn more.',
            help_text_markdown: true,
        ...
        settings: [
          {
            ...
            help_text_default:
              'When true, Mattermost will enable performance monitoring collection and profiling. Please see [documentation](!http://docs.mattermost.com/deployment/metrics.html) to learn more about configuring performance monitoring for Mattermost.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('environment')),
          },
          {
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              'The URL for the Help link on the Mattermost login page, sign-up pages, and Main Menu. If this field is empty, the Help link is hidden from users.',
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
          },
          {
            type: Constants.SettingsTypes.TYPE_TEXT,
          ...
          },
          {
            ...
            help_text_default:
              'Add a link to a download page for the Mattermost apps. When a link is present, an option to "Download Mattermost Apps" will be added in the Main Menu so users can find the download page. Leave this field blank to hide the option from the Main Menu.',
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
            isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
          },
          {
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              "When true, disables users' ability to change settings under Main Menu > Account Settings > Display > Teammate Name Display.",
          ...
          },
          {
            ...
            help_text_default:
              "When **true**, both Team Admins and System Admins can edit other users' posts.  When **false**, only System Admins can edit other users' posts. However, Team Admins and System Admins can always delete other users' posts.",
            help_text_markdown: true,
            permissions_mapping_name: 'editOthersPosts',
            isHidden: it.any(it.licensed, it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin')),
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
          },
          {
            type: Constants.SettingsTypes.TYPE_BOOL,
            ...
            help_text_default:
              '(Beta) When true, allows users to view, share and search for content of channels that have been archived. Users can only view the content in channels of which they were a member before the channel was archived.',
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
          },
          {
            type: Constants.SettingsTypes.TYPE_BOOL,
        ...
        settings: [
          {
            ...
            help_text_default:
              'When true, users will be prompted to confirm when posting @channel, @all and group mentions in channels with over five members. When false, no confirmation is required.',
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
          },
          {
            type: Constants.SettingsTypes.TYPE_BOOL,
          ...
          },
          {
            ...
            help_text_default:
              '**Send full message contents** - Sender name and channel are included in email notifications. Typically used for compliance reasons if Mattermost contains confidential information and policy dictates it cannot be stored in email.\n  **Send generic description with only sender name** - Only the name of the person who sent the message, with no information about channel name or message contents are included in email notifications. Typically used for compliance reasons if Mattermost contains confidential information and policy dictates it cannot be stored in email.',
            help_text_markdown: true,
            options: [
              {
                value: 'full',
        ...
        settings: [
          {
            ...
            help_text_default:
              'When enabled, System Admins will receive notices about available server upgrades and relevant system administration features. [Learn more about notices](!https://about.mattermost.com/default-notices) in our documentation.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
          },
          {
            ...
            help_text_default:
              'When enabled, all users will receive notices about available client upgrades and relevant end user features to improve user experience. [Learn more about notices](!https://about.mattermost.com/default-notices) in our documentation.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('site')),
          },
        ],
  ...
  authentication: {
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              'New user accounts are restricted to the above specified email domain (e.g. "mattermost.org") or list of comma-separated domains (e.g. "corp.mattermost.com, mattermost.org"). New teams can only be created by users from the above domain(s). This setting only affects email login for users.',
        ...
        settings: [
          {
            ...
            label_default:
              '[Multi-factor authentication](!https://docs.mattermost.com/deployment/auth.html) is available for accounts with AD/LDAP or email login. If other login methods are used, MFA should be configured with the authentication provider.',
            label_markdown: true,
            banner_type: 'info',
          },
          {
          ...
          },
          {
            ...
            help_text_markdown: true,
            help_text_default:
              'When true, [multi-factor authentication](!https://docs.mattermost.com/deployment/auth.html) is required for login. New users will be required to configure MFA on signup. Logged in users without MFA configured are redirected to the MFA setup page until configuration is complete.\n \nIf your system has users with login methods other than AD/LDAP and email, MFA must be enforced with the authentication provider outside of Mattermost.',
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            isDisabled: it.any(
              it.not(it.userHasWritePermissionOnResource('authentication')),
              it.all(it.stateIsFalse('LdapSettings.Enable'), it.stateIsFalse('LdapSettings.EnableSync'))
            ),
          },
          {
            type: Constants.SettingsTypes.TYPE_NUMBER,
          ...
          },
          {
            ...
            isDisabled: it.all(it.stateIsFalse('LdapSettings.Enable'), it.stateIsFalse('LdapSettings.EnableSync')),
            fileType: '.key',
          ...
          },
          {
            ...
            help_text_default:
              'The username used to perform the AD/LDAP search. This should typically be an account created specifically for use with Mattermost. It should have access limited to read the portion of the AD/LDAP tree specified in the BaseDN field.',
            isDisabled: it.any(
              it.not(it.userHasWritePermissionOnResource('authentication')),
              it.all(it.stateIsFalse('LdapSettings.Enable'), it.stateIsFalse('LdapSettings.EnableSync'))
            ),
          ...
          },
          {
            ...
            isDisabled: it.any(
              it.not(it.userHasWritePermissionOnResource('authentication')),
              it.all(it.stateEquals('LdapSettings.Enable', false), it.stateEquals('LdapSettings.EnableSync', false))
            ),
          },
          {
            type: Constants.SettingsTypes.TYPE_TEXT,
          ...
          },
          {
            ...
            help_text_markdown: true,
            help_text_default:
              'Tests if the Mattermost server can connect to the AD/LDAP server specified. Please review "System Console > Logs" and [documentation](!https://mattermost.com/default-ldap-docs) to troubleshoot errors.',
          ...
          },
          {
            ...
            help_text_markdown: true,
            help_text_default:
              'Initiates an AD/LDAP synchronization immediately. See the table below for status of each synchronization. Please review "System Console > Logs" and [documentation](!https://mattermost.com/default-ldap-docs) to troubleshoot errors.',
            isDisabled: it.any(
              it.not(it.userHasWritePermissionOnResource('authentication')),
              it.stateIsFalse('LdapSettings.EnableSync')
            ),
    ...
    ldap_feature_discovery: {
      ...
      title: t('admin.sidebar.ldap'),
      title_default: 'AD/LDAP',
      isHidden: it.any(it.licensedForFeature('LDAP'), it.not(it.enterpriseReady)),
      schema: {
        id: 'LdapSettings',
        name: t('admin.authentication.ldap'),
        name_default: 'AD/LDAP',
        ...
        settings: [
          {
            ...
            help_text_default:
              'When true, Mattermost allows login using SAML 2.0. Please see [documentation](!http://docs.mattermost.com/deployment/sso-saml.html) to learn more about configuring SAML for Mattermost.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('authentication')),
          },
          {
            ...
            help_text_default:
              'When true, Mattermost periodically synchronizes SAML user attributes, including user deactivation and removal, from AD/LDAP. Enable and configure synchronization settings at **Authentication > AD/LDAP**. When false, user attributes are updated from SAML during user login. See [documentation](!https://about.mattermost.com/default-saml-ldap-sync) to learn more.',
            help_text_markdown: true,
            isDisabled: it.any(
              it.not(it.userHasWritePermissionOnResource('authentication')),
          ...
          },
          {
            ...
            isDisabled: it.any(it.not(it.isSystemAdmin), it.stateIsFalse('SamlSettings.Enable')),
          },
          {
            type: Constants.SettingsTypes.TYPE_TEXT,
    ...
    saml_feature_discovery: {
      ...
      title: t('admin.sidebar.saml'),
      title_default: 'SAML 2.0',
      isHidden: it.any(it.licensedForFeature('SAML'), it.not(it.enterpriseReady)),
      schema: {
        id: 'SamlSettings',
        name: t('admin.authentication.saml'),
        name_default: 'SAML 2.0',
    ...
    oauth: {
      ...
      tag: {
        value: <FormattedMessage id="admin.sidebar.oauth.tag" defaultMessage="deprecated" />,
        shouldDisplay: (license) => license.IsLicensed && license.OpenId === 'true',
      },
      isHidden: it.any(it.not(it.licensed), it.all(it.licensedForFeature('OpenId'), it.not(usesLegacyOauth))),
      schema: {
        id: 'OAuthSettings',
        ...
        settings: [
          {
            ...
            key: 'OpenIdConvert',
            isHidden: it.any(it.not(it.licensedForFeature('OpenId')), it.not(usesLegacyOauth)),
            isDisabled: it.not(it.userHasWritePermissionOnResource('authentication')),
          },
          {
            type: Constants.SettingsTypes.TYPE_DROPDOWN,
          ...
          },
          {
            ...
            dynamic_value: (value, config, state) => {
              if (state['Office365Settings.DirectoryId']) {
                return (
                  'https://login.microsoftonline.com/' + state['Office365Settings.DirectoryId'] + '/oauth2/v2.0/token'
                )
              }
      ...
      schema: {
        ...
        onConfigLoad: (config) => {
          ...
          if (config.GitLabSettings.UserApiEndpoint) {
            ...
            newState['GitLabSettings.Url'] = config.GitLabSettings.DiscoveryEndpoint.replace(
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              'When true, [multi-factor authentication](!https://docs.mattermost.com/deployment/auth.html) for guests is required for login. New guest users will be required to configure MFA on signup. Logged in guest users without MFA configured are redirected to the MFA setup page until configuration is complete.\n \nIf your system has guest users with login methods other than AD/LDAP and email, MFA must be enforced with the authentication provider outside of Mattermost.',
            help_text_markdown: true,
            isHidden: it.any(
              it.configIsFalse('ServiceSettings', 'EnableMultifactorAuthentication'),
        ...
        settings: [
          {
            ...
            help_text_default:
              'When true, incoming webhooks will be allowed. To help combat phishing attacks, all posts from webhooks will be labelled by a BOT tag. See [documentation](!http://docs.mattermost.com/developer/webhooks-incoming.html) to learn more.',
            help_text_markdown: true,
          ...
          },
          {
            ...
            help_text_default:
              'When true, outgoing webhooks will be allowed. See [documentation](!http://docs.mattermost.com/developer/webhooks-outgoing.html) to learn more.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('integrations')),
          },
          {
            ...
            help_text_default:
              'When true, custom slash commands will be allowed. See [documentation](!http://docs.mattermost.com/developer/slash-commands.html) to learn more.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('integrations')),
          },
          {
            ...
            help_text_default:
              'When true, Mattermost can act as an OAuth 2.0 service provider allowing Mattermost to authorize API requests from external applications. See [documentation](!https://docs.mattermost.com/developer/oauth-2-0-applications.html) to learn more.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('integrations')),
          },
          {
          ...
          },
          {
            ...
            help_text_default:
              'When true, users can create [user access tokens](!https://about.mattermost.com/default-user-access-tokens) for integrations in **Account Settings > Security**. They can be used to authenticate against the API and give full access to the account.\n\n To manage who can create personal access tokens or to search users by token ID, go to the **User Management > Users** page.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('integrations')),
          },
        ],
        ...
        settings: [
          {
            ...
            help_text_default:
              'When true, System Admins can create bot accounts for integrations in [Integrations > Bot Accounts]({siteURL}/_redirect/integrations/bots). Bot accounts are similar to user accounts except they cannot be used to log in. See [documentation](https://mattermost.com/pl/default-bot-accounts) to learn more.',
            help_text_markdown: true,
            help_text_values: { siteURL: getSiteURL() },
            isDisabled: it.not(it.userHasWritePermissionOnResource('integrations')),
          },
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              'When true, Mattermost allows compliance reporting from the **Compliance and Auditing** tab. See [documentation](!https://docs.mattermost.com/administration/compliance.html) to learn more.',
            help_text_markdown: true,
            isHidden: it.not(it.licensedForFeature('Compliance')),
            isDisabled: it.not(it.userHasWritePermissionOnResource('compliance')),
          },
      ...
      schema: {
        ...
        settings: [
          ...
          },
          {
            ...
            help_text_default:
              'Enables client-side certification for your Mattermost server. See [documentation](!https://docs.mattermost.com/deployment/certificate-based-authentication.html) to learn more.',
            help_text_markdown: true,
            isHidden: it.not(it.licensedForFeature('SAML')),
            isDisabled: it.not(it.userHasWritePermissionOnResource('experimental')),
          },
          ...
          },
          {
            ...
            help_text_default:
              'Enables a hardened mode for Mattermost that makes user experience trade-offs in the interest of security. See [documentation](!https://docs.mattermost.com/administration/config-settings.html#enable-hardened-mode-experimental) to learn more.',
            help_text_markdown: true,
            isDisabled: it.not(it.userHasWritePermissionOnResource('experimental')),
          },
          {
          ...
          },
          {
            ...
            help_text_default:
              'When enabled, users cannot access new sidebar features including custom, collapsible categories and unread channel filtering. We recommend only enabling the legacy sidebar if users are experiencing breaking changes or bugs.',
            help_text_markdown: true,
          ...
          },
          {
            ...
            help_text_default:
              'When true, users can leave Public and Private Channels by clicking the “x” beside the channel name. When false, users must use the **Leave Channel** option from the channel menu to leave channels. These settings are only available if **Enable Legacy Sidebar** is **Enabled**.',
            help_text_markdown: true,
            isHidden: it.any(
              it.licensedForFeature('Cloud'),
              it.configIsFalse('ServiceSettings', 'EnableLegacySidebar')
          ...
          },
          {
            ...
            help_text_default:
              'When true, direct message conversations with no activity for 7 days will be hidden from the sidebar. When false, conversations remain in the sidebar until they are manually closed. These settings are only available if **Enable Legacy Sidebar** is **Enabled**.',
            help_text_markdown: true,
            isHidden: it.any(
              it.licensedForFeature('Cloud'),
              it.configIsFalse('ServiceSettings', 'EnableLegacySidebar')
          ...
          },
          {
            ...
            help_text_default:
              'When true, hides Town Square in the left-hand sidebar if there are no unread messages in the channel. When false, Town Square is always visible in the left-hand sidebar even if all messages have been read. These settings are only available if **Enable Legacy Sidebar** is **Enabled**.',
            help_text_markdown: true,
            isHidden: it.any(
