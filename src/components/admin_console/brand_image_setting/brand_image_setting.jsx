...
export default class BrandImageSetting extends React.PureComponent {
  ...
  render() {
    ...
    if (this.state.brandImage) {
            ...
            overlay={
              <Tooltip id="removeIcon">
                <div aria-hidden={true}>
                  <FormattedMessage id="admin.team.removeBrandImage" defaultMessage="Remove brand image" />
                </div>
              </Tooltip>
            }
          >
            <button type="button" className="remove-image__btn" onClick={this.handleDeleteButtonPressed}>
      ...
      img = (
        <div className="remove-image__img mb-5">
          <img alt="brand image" src={Client4.getBrandImageUrl(this.state.brandImageTimestamp)} />
          {overlay}
        </div>
      )
    } else {
      ...
      <div data-testid={this.props.id} className="form-group">
        ...
        <div className="col-sm-8">
          <div className="file__upload mt-5">
            <button type="button" className={letbtnDefaultClass} disabled={this.props.disabled}>
              <FormattedMessage id="admin.team.chooseImage" defaultMessage="Select Image" />
            </button>
            <input
