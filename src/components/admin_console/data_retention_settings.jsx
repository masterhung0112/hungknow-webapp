...
export default class DataRetentionSettings extends AdminSettings {
  ...
  renderConfirmModal = () => {
    ...
    if (this.state.enableMessageDeletion === 'true') {
      messageList.push(
        <FormattedMessage
          ...
          values={{
            days: <strong>{this.state.messageRetentionDays}</strong>,
          }}
        />
      )
    } else {
    ...
    const confirmButton = (
      <FormattedMessage id="admin.data_retention.confirmChangesModal.confirm" defaultMessage="Confirm Settings" />
    )
  ...
  renderTitle() {
    return <FormattedMessage id="admin.data_retention.title" defaultMessage="Data Retention Policy" />
  }
  ...
  renderSettings = () => {
    const enableMessageDeletionOptions = [
      {
        value: 'false',
        text: Utils.localizeMessage('admin.data_retention.keepMessagesIndefinitely', 'Keep all messages indefinitely'),
      },
      {
        value: 'true',
    ...
    const enableFileDeletionOptions = [
      ...
      {
        value: 'true',
        text: Utils.localizeMessage('admin.data_retention.keepFilesForTime', 'Keep files for a set amount of time'),
      },
    ]
    ...
    return (
      <SettingsGroup>
        ...
        <DropdownSetting
          ...
          label={
            <FormattedMessage id="admin.data_retention.enableFileDeletion.title" defaultMessage="File Retention:" />
          }
          helpText={
            <FormattedMessage
        ...
        <JobsTable
          ...
          createJobButtonText={
            <FormattedMessage id="admin.data_retention.createJob.title" defaultMessage="Run Deletion Job Now" />
          }
          createJobHelpText={
            <FormattedMessage
