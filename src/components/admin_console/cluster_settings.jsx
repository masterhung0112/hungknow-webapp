...
export default class ClusterSettings extends AdminSettings {
  ...
  renderTitle() {
    return <FormattedMessage id="admin.advance.cluster" defaultMessage="High Availability" />
  }
  ...
  renderSettings = () => {
    ...
    if (Client4.clusterId) {
      configLoadedFromCluster = (
        <div style={style.configLoadedFromCluster} className="alert alert-warning">
          <WarningIcon />
    ...
    return (
      <SettingsGroup>
        ...
        <BooleanSetting
          id="Enable"
          label={<FormattedMessage id="admin.cluster.enableTitle" defaultMessage="Enable High Availability Mode:" />}
          helpText={
            <FormattedMarkdownMessage
        ...
        <TextSetting
          id="ClusterName"
          label={<FormattedMessage id="admin.cluster.ClusterName" defaultMessage="Cluster Name:" />}
        ...
        <TextSetting
          id="OverrideHostname"
          label={<FormattedMessage id="admin.cluster.OverrideHostname" defaultMessage="Override Hostname:" />}
        ...
        <BooleanSetting
          id="UseIpAddress"
          label={<FormattedMessage id="admin.cluster.UseIpAddress" defaultMessage="Use IP Address:" />}
          helpText={
            <FormattedMessage
        ...
        <BooleanSetting
          ...
          label={<FormattedMessage id="admin.cluster.UseExperimentalGossip" defaultMessage="Use Gossip:" />}
          helpText={
            <FormattedMessage
        ...
        <BooleanSetting
          ...
          label={
            <FormattedMessage id="admin.cluster.EnableGossipCompression" defaultMessage="Enable Gossip compression:" />
          }
          helpText={
            <FormattedMessage
        ...
        <TextSetting
          id="GossipPort"
          label={<FormattedMessage id="admin.cluster.GossipPort" defaultMessage="Gossip Port:" />}
        ...
        <TextSetting
          id="StreamingPort"
          label={<FormattedMessage id="admin.cluster.StreamingPort" defaultMessage="Streaming Port:" />}
