...
export default class PushSettings extends AdminSettings {
  ...
  isPushNotificationServerSetByEnv = () => {
    ...
    return (
      this.isSetByEnv('EmailSettings.SendPushNotifications') || this.isSetByEnv('EmailSettings.PushNotificationServer')
    )
  }

  renderTitle() {
    return <FormattedMessage id="admin.environment.pushNotificationServer" defaultMessage="Push Notification Server" />
  }
  ...
  renderSettings = () => {
    ...
    pushNotificationServerTypes.push({
      ...
      text: Utils.localizeMessage('admin.email.pushOff', 'Do not send push notifications'),
    })
    ...
    pushNotificationServerTypes.push({
      value: PUSH_NOTIFICATIONS_CUSTOM,
      text: Utils.localizeMessage('admin.email.selfPush', 'Manually enter Push Notification Service location'),
    })
    ...
    return (
      <SettingsGroup>
        <DropdownSetting
          ...
          label={<FormattedMessage id="admin.email.pushTitle" defaultMessage="Enable Push Notifications: " />}
        ...
        <TextSetting
          ...
          label={<FormattedMessage id="admin.email.pushServerTitle" defaultMessage="Push Notification Server:" />}
