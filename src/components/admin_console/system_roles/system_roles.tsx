  ...
  render() {
      ...
      if (role) {
        rows.push({
          cells: {
            ...
            edit: (
              <span className="SystemRoles_editRow" data-testid={`${role.name}_edit`}>
                <Link to={`/admin_console/user_management/system_roles/${role.id}`}>
                  <FormattedMessage id="admin.permissions.roles.edit" defaultMessage="Edit" />
                </Link>
              </span>
            ),
          },
    ...
    return (
      <div className="wrapper--fixed">
        <FormattedAdminHeader id="admin.permissions.systemRoles" defaultMessage="System Roles (Beta)" />
