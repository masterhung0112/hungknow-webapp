    ...
    return usersToDisplay.map((user) => {
      return {
        cells: {
          ...
          new: (
            <Badge className="NewUserBadge" show={Boolean(usersToAdd[user.id])}>
    ...
    return (
      <AdminPanel
        ...
        button={
          ...
          >
            <FormattedMessage id="admin.permissions.system_role_users.add_people" defaultMessage="Add People" />
          </ToggleModalButton>
        }
      >
        <DataGrid
