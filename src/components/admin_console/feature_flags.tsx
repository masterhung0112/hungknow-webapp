...
const FeatureFlags: React.FC<Props> = (props: Props) => {
  ...
  return (
    <div className="wrapper--admin">
      <FormattedAdminHeader id="admin.feature_flags.title" defaultMessage="Feature Flags" />
              ...
              <table className="table">
                <thead>
                  <tr>
                    <th />
                    <th>
                      <FormattedMessage id="admin.feature_flags.flag" defaultMessage="Flag" />
                    </th>
                    <th>
                      <FormattedMessage id="admin.feature_flags.flag_value" defaultMessage="Value" />
                    </th>
                  </tr>
                </thead>
