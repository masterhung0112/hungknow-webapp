...
export default class ResetEmailModal extends React.PureComponent {
  ...
  render() {
    ...
    const title = <FormattedMessage id="admin.reset_email.titleReset" defaultMessage="Update Email" />
        ...
        <form role="form" className="form-horizontal">
          <Modal.Body>
            <div className="form-group">
              <div className="col-sm-10">
                <div className={urlClass} data-testid="resetEmailForm">
                  <span data-toggle="tooltip" title="New Email" className="input-group-addon email__group-addon">
                    <FormattedMessage id="admin.reset_email.newEmail" defaultMessage="New Email" />
                  </span>
                  <input type="email" ref={this.emailRef} className="form-control" maxLength="128" autoFocus={true} />
                </div>
                {errorMsg}
              </div>
            </div>
          ...
          <Modal.Footer>
            <button type="button" className="btn btn-link" onClick={this.doCancel}>
              <FormattedMessage id="admin.reset_email.cancel" defaultMessage="Cancel" />
            </button>
            <button onClick={this.doSubmit} type="submit" className="btn btn-primary" data-testid="resetEmailButton">
              <FormattedMessage id="admin.reset_email.reset" defaultMessage="Reset" />
            </button>
          </Modal.Footer>
        </form>
      </Modal>
