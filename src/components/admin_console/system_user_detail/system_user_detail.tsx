...
import { Team, TeamMembership } from 'hkclient-ts/lib/types/teams'
...
export default class SystemUserDetail extends React.PureComponent<Props & RouteComponentProps, State> {
  ...
  handleMakeActive = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>): void => {
    e.preventDefault()
    this.props.actions.updateUserActive(this.props.user.id, true).then((data) => this.onUpdateActiveResult(data.error))
  }
  ...
  handleDeactivateMember = (): void => {
    this.props.actions.updateUserActive(this.props.user.id, false).then((data) => this.onUpdateActiveResult(data.error))
  ...
  render(): React.ReactNode {
    ...
    if (!user.id) {
      return <Redirect to={{ pathname: '/admin_console/user_management/users' }} />
    }
    ...
    return (
      <div className="SystemUserDetail wrapper--fixed">
        <div className="admin-console__header with-back">
          <div>
            <BlockableLink to="/admin_console/user_management/users" className="fa fa-angle-left back" />
            <FormattedMessage id="admin.systemUserDetail.title" defaultMessage="User Configuration" />
          </div>
        </div>
              ...
              body={
                <React.Fragment>
                  ...
                  <span className="SystemUserDetail__field-label">
                    {Utils.localizeMessage('admin.userManagement.userDetail.email', 'Email')}
                  </span>
                  <div>
                  ...
                  <span className="SystemUserDetail__field-label">
                    {Utils.localizeMessage('admin.userManagement.userDetail.username', 'Username')}
                  </span>
                  <div>
              ...
              button={
                <div className="add-team-button">
                  <button
                    ...
                    disabled={this.props.isDisabled}
                  >
                    <FormattedMessage id="admin.userManagement.userDetail.addTeam" defaultMessage="Add Team" />
                  </button>
                </div>
              }
            >
        ...
        <div className="admin-console-save">
          ...
          <Overlay show={this.state.errorTooltip} placement="top" target={this.errorMessageRefCurrent}>
