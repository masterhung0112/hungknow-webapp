...
describe('components/admin_console/group_settings/group_details/GroupDetails', () => {
  ...
  test('should set state for each channel when addChannels is called', async () => {
    ...
    const wrapper = shallow(<GroupDetails {...defaultProps} actions={actions} />)
  ...
  test('update name for null slug', async () => {
    const wrapper = shallow(
      <GroupDetails {...defaultProps} group={{ display_name: 'test group', allow_reference: false }} />
    )
  ...
  test('update name for empty slug', async () => {
    const wrapper = shallow(
      <GroupDetails {...defaultProps} group={{ name: '', display_name: 'test group', allow_reference: false }} />
    )
