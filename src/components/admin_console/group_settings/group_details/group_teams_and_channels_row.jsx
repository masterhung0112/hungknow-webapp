...
export default class GroupTeamsAndChannelsRow extends React.PureComponent {
  ...
  displayAssignedRolesDropdown = () => {
    ...
    const channelAdmin = (
      <FormattedMessage id="admin.group_teams_and_channels_row.channelAdmin" defaultMessage="Channel Admin" />
    )
    const teamAdmin = <FormattedMessage id="admin.group_teams_and_channels_row.teamAdmin" defaultMessage="Team Admin" />
    const member = <FormattedMessage id="admin.group_teams_and_channels_row.member" defaultMessage="Member" />
    let dropDown = null
      ...
      dropDown = (
        <div>
          <MenuWrapper isDisabled={isDisabled}>
            ...
            >
              <Menu.ItemAction testid={`${name}_role_to_be`} onClick={this.changeRoles} text={roleToBe} />
            </Menu>
          </MenuWrapper>
        </div>
      )
