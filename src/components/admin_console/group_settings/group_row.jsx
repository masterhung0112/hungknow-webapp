  ...
  renderActions = () => {
    ...
    if (this.props.has_syncables) {
      return (
        ...
        >
          <FormattedMessage id="admin.group_settings.group_row.edit" defaultMessage="Edit" />
        </Link>
      )
    }
    return (
      ...
      >
        <FormattedMessage id="admin.group_settings.group_row.configure" defaultMessage="Configure" />
      </Link>
    )
  }
  ...
  renderLinked = () => {
    ...
    if (this.props.mattermost_group_id) {
      if (this.props.failed) {
        return (
          <a href="#" onClick={this.unlinkHandler} className="warning">
            <i className="icon fa fa-exclamation-triangle" />
            <FormattedMessage id="admin.group_settings.group_row.unlink_failed" defaultMessage="Unlink failed" />
          </a>
        )
      }
      return (
        <a href="#" onClick={this.unlinkHandler} className={this.props.readOnly ? 'disabled' : ''}>
          <i className="icon fa fa-link" />
          <FormattedMessage id="admin.group_settings.group_row.linked" defaultMessage="Linked" />
        </a>
      )
    }
    if (this.props.failed) {
      return (
        <a href="#" onClick={this.linkHandler} className="warning">
          <i className="icon fa fa-exclamation-triangle" />
          <FormattedMessage id="admin.group_settings.group_row.link_failed" defaultMessage="Link failed" />
        </a>
      )
    }
    return (
      <a href="#" onClick={this.linkHandler} className={this.props.readOnly ? 'disabled' : ''}>
        <i className="icon fa fa-unlink" />
        <FormattedMessage id="admin.group_settings.group_row.not_linked" defaultMessage="Not Linked" />
      </a>
    )
  }
      ...
      >
        <div className="group-row">
          <div className="group-name">
            <div className={'group-check ' + (this.props.checked ? 'checked' : '')}>
              {this.props.checked && <CheckboxCheckedIcon />}
            </div>
            <span>{this.props.name}</span>
          </div>
          <div className="group-content">
            <span className="group-description">{this.renderLinked()}</span>
            <span className="group-actions">{this.renderActions()}</span>
          </div>
        </div>
      </div>
    )
