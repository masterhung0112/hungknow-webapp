...
import { GroupSearchOpts, MixedUnlinkedGroupRedux } from 'hkclient-ts/lib/types/groups'
...
export default class GroupsList extends React.PureComponent<Props, State> {
  ...
  public renderSelectionActionButton(): JSX.Element {
    switch (this.selectionActionButtonType()) {
      ...
      default:
        return (
          <button type="button" className="btn btn-inactive disabled" disabled={this.props.readOnly}>
            <i className="icon fa fa-link" />
            <FormattedMessage
              id="admin.group_settings.groups_list.link_selected"
              defaultMessage="Link Selected Groups"
    ...
    return (
      <div className="groups-list--header">
        <div className="group-name">
          <FormattedMessage id="admin.group_settings.groups_list.nameHeader" defaultMessage="Name" />
        </div>
        <div className="group-content">
          <div className="group-description">
            <FormattedMessage id="admin.group_settings.groups_list.mappingHeader" defaultMessage="Mattermost Linking" />
          </div>
    ...
    if (this.props.groups.length === 0) {
      return (
        <div className="groups-list-empty">
          <FormattedMessage id="admin.group_settings.groups_list.no_groups_found" defaultMessage="No groups found" />
        </div>
      )
    }
    ...
    return (
      ...
      >
        <div className="filter-row">
          ...
          <span>
            <FormattedMessage id="admin.group_settings.filters.isLinked" defaultMessage="Is Linked" />
          </span>
        </div>
        <div className="filter-row">
          <span
            ...
            onClick={() =>
              this.handleFilterCheck([
                ['filterIsUnlinked', !this.state.filterIsUnlinked],
                ['filterIsLinked', false],
              ])
            }
          >
          ...
          <span>
            <FormattedMessage id="admin.group_settings.filters.isUnlinked" defaultMessage="Is Not Linked" />
          </span>
        </div>
        <div className="filter-row">
          <span
            ...
            onClick={() =>
              this.handleFilterCheck([
                ['filterIsConfigured', !this.state.filterIsConfigured],
                ['filterIsUnconfigured', false],
              ])
            }
          >
          ...
          <span>
            <FormattedMessage id="admin.group_settings.filters.isConfigured" defaultMessage="Is Configured" />
          </span>
        </div>
        <div className="filter-row">
          <span
            ...
            onClick={() =>
              this.handleFilterCheck([
                ['filterIsUnconfigured', !this.state.filterIsUnconfigured],
                ['filterIsConfigured', false],
              ])
            }
          >
          ...
          <span>
            <FormattedMessage id="admin.group_settings.filters.isUnconfigured" defaultMessage="Is Not Configured" />
          </span>
        </div>
        <a
          onClick={() => {
        ...
        >
          <FormattedMessage id="search_bar.search" defaultMessage="Search" />
        </a>
      </div>
    )
  }
    ...
    return (
      <div className="groups-list">
        <div className="groups-list--global-actions">
          ...
          <div className="group-list-link-unlink">{this.renderSelectionActionButton()}</div>
        </div>
        {this.renderHeader()}
