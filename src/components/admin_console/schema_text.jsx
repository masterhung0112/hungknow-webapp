...
export default class SchemaText extends React.PureComponent {
  ...
  renderTranslated = () => {
    ...
    if (isMarkdown) {
      return <FormattedMarkdownMessage id={text} defaultMessage={textDefault} values={textValues} />
    }

    return <FormattedMessage id={text} values={textValues} defaultMessage={textDefault} />
  }
