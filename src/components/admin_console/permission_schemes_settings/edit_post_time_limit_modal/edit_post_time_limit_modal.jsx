  ...
  save = async () => {
    ...
    if (val !== Constants.UNSET_POST_EDIT_TIME_LIMIT) {
      if (val.toString() === 'NaN' || val <= 0 || val > INT32_MAX) {
        this.setState({
          errorMessage: localizeMessage('edit_post.time_limit_modal.invalid_time_limit', 'Invalid time limit'),
          saving: false,
        })
        return false
      }
    ...
    return (
      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="editPostTimeModalLabel">
            <FormattedMessage
          ...
          <div className="pl-3 pb-3 pt-3">
            <div className="pt-3">
              ...
              <label htmlFor="anytime">
                <FormattedMessage id="edit_post.time_limit_modal.option_label_anytime" defaultMessage="Anytime" />
              </label>
            </div>
            <div className="pt-2">
              <input
              ...
              <input
                ...
                value={
                  this.state.postEditTimeLimit === Constants.UNSET_POST_EDIT_TIME_LIMIT
                    ? ''
        ...
        <Modal.Footer>
          <div className="edit-post-time-limit-modal__error">{this.state.errorMessage}</div>
          <button type="button" className="btn btn-cancel" onClick={this.props.onClose}>
            <FormattedMessage id="confirm_modal.cancel" defaultMessage="Cancel" />
          </button>
          <button
