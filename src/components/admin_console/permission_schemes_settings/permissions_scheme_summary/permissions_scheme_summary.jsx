    ...
    if (teams.length > MAX_TEAMS_PER_SCHEME_SUMMARY) {
      extraTeams = (
        <OverlayTrigger
          ...
          placement="bottom"
          overlay={
            <Tooltip className="team-scheme-extra-teams-overlay" id={scheme.id + '-extra-teams-overlay'}>
      ...
      <div className="permissions-scheme-summary" data-testid="permissions-scheme-summary" onClick={this.goToEdit}>
        ...
        <div className="permissions-scheme-summary--header">
          ...
          <div className="actions">
            ...
            >
              <FormattedMessage id="admin.permissions.permissionsSchemeSummary.edit" defaultMessage="Edit" />
            </Link>
            {'-'}
            <a
              ...
              onClick={this.delete}
            >
              <FormattedMessage id="admin.permissions.permissionsSchemeSummary.delete" defaultMessage="Delete" />
            </a>
          </div>
        </div>
        <div className="permissions-scheme-summary--description">{scheme.description}</div>
