...
describe('components/admin_console/permission_schemes_settings/permission_checkbox', () => {
  ...
  test('should match snapshot on value "checked"', () => {
    const wrapper = shallow(<PermissionCheckbox value="checked" id="uniqId-checked" />)
    expect(wrapper).toMatchSnapshot()
  })

  test('should match snapshot on value "intermediate"', () => {
    const wrapper = shallow(<PermissionCheckbox value="intermediate" id="uniqId-checked" />)
    expect(wrapper).toMatchSnapshot()
  })

  test('should match snapshot on other value', () => {
    const wrapper = shallow(<PermissionCheckbox value="other" id="uniqId-checked" />)
    expect(wrapper).toMatchSnapshot()
  })
})
