...
export default class PermissionsTree extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.ADDITIONAL_VALUES = {
      edit_post: {
        editTimeLimitButton: (
          <EditPostTimeLimitButton onClick={this.openPostTimeLimitModal} isDisabled={this.props.readOnly} />
        ),
      },
    }
        ...
        permissions: [
          {
            id: 'send_invites',
            combined: true,
            permissions: [Permissions.INVITE_USER, Permissions.GET_PUBLIC_LINK, Permissions.ADD_USER_TO_TEAM],
          },
      ...
      },
      {
        ...
        permissions: [
          ...
          Permissions.MANAGE_PUBLIC_CHANNEL_PROPERTIES,
          {
            ...
            combined: true,
            permissions: [Permissions.MANAGE_PUBLIC_CHANNEL_MEMBERS, Permissions.READ_PUBLIC_CHANNEL_GROUPS],
          },
          Permissions.DELETE_PUBLIC_CHANNEL,
          {
            id: 'convert_public_channel_to_private',
            combined: true,
            permissions: [Permissions.CONVERT_PUBLIC_CHANNEL_TO_PRIVATE, Permissions.CONVERT_PRIVATE_CHANNEL_TO_PUBLIC],
          },
        ],
      },
      {
        ...
        permissions: [
          ...
          Permissions.MANAGE_PRIVATE_CHANNEL_PROPERTIES,
          {
            ...
            combined: true,
            permissions: [Permissions.MANAGE_PRIVATE_CHANNEL_MEMBERS, Permissions.READ_PRIVATE_CHANNEL_GROUPS],
          },
      ...
      },
      {
        ...
        permissions: [
          ...
          },
          {
            id: 'reactions',
            combined: true,
            permissions: [Permissions.ADD_REACTION, Permissions.REMOVE_REACTION],
          },
  ...
  updateGroups = () => {
    ...
    if (
      ...
      !integrationsGroup.permissions.includes(Permissions.MANAGE_INCOMING_WEBHOOKS)
    ) {
      integrationsGroup.permissions.push(Permissions.MANAGE_INCOMING_WEBHOOKS)
    }
    if (
      config.EnableOutgoingWebhooks === 'true' &&
      !integrationsGroup.permissions.includes(Permissions.MANAGE_OUTGOING_WEBHOOKS)
    ) {
    ...
    if (
      ...
      !integrationsGroup.permissions.includes(Permissions.MANAGE_SLASH_COMMANDS)
    ) {
    ...
    if (
      ...
      !integrationsGroup.permissions.includes(Permissions.DELETE_OTHERS_EMOJIS)
    ) {
      ...
      <div className="permissions-tree">
        <div className="permissions-tree--header">
          <div className="permission-name">
            <FormattedMessage id="admin.permissions.permissionsTree.permission" defaultMessage="Permission" />
          </div>
          <div className="permission-description">
            <FormattedMessage id="admin.permissions.permissionsTree.description" defaultMessage="Description" />
          </div>
        </div>
        ...
        <EditPostTimeLimitModal onClose={this.closePostTimeLimitModal} show={this.state.editTimeLimitModalIsVisible} />
      </div>
    )
  }
}
