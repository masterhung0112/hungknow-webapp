  ...
  teamOverrideSchemesMigrationView = () => {
    ...
    const docLink = (
      <a
        ...
        target="_blank"
      >
        <FormattedMessage id="admin.permissions.documentationLinkText" defaultMessage="documentation" />
      </a>
    )
    ...
    return (
      <div className="team-override-unavailable">
        <div className="team-override-unavailable__inner">
          <FormattedMessage id={id} defaultMessage={defaultMsg} values={{ documentationLink }} />
        </div>
      </div>
    )
  }
        ...
        >
          ...
          {schemes.length === PAGE_SIZE * (this.state.page + 1) && (
            ...
            >
              ...
              >
                <FormattedMessage id="admin.permissions.loadMoreSchemes" defaultMessage="Load more schemes" />
              </LoadingWrapper>
            </button>
          )}
        </AdminPanelWithLink>
  ...
  render = () => {
    ...
    return (
      <div className="wrapper--fixed">
        <FormattedAdminHeader id="admin.permissions.permissionSchemes" defaultMessage="Permission Schemes" />
