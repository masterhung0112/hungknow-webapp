...
export default class ComplianceReports extends React.PureComponent<Props, State> {
  ...
  componentDidMount() {
    ...
    this.props.actions.getComplianceReports().then(() => this.setState({ loadingReports: false }))
  }
  ...
  render() {
    ...
    if (this.state.loadingReports) {
      ...
      for (let i = 0; i < this.props.reports.length; i++) {
        ...
        if (report.type === 'adhoc') {
          params = (
            <span>
              <FormattedMessage id="admin.compliance_reports.from" defaultMessage="From:" />{' '}
              {this.getDateTime(report.start_at)}
              <br />
              <FormattedMessage id="admin.compliance_reports.to" defaultMessage="To:" />{' '}
              {this.getDateTime(report.end_at)}
              <br />
              <FormattedMessage id="admin.compliance_reports.emails" defaultMessage="Emails:" /> {report.emails}
              <br />
              <FormattedMessage id="admin.compliance_reports.keywords" defaultMessage="Keywords:" /> {report.keywords}
            </span>
          )
        }
        ...
        if (report.status === 'finished') {
          download = (
            <a href={`${Client4.getBaseRoute()}/compliance/reports/${report.id}/download`}>
              <FormattedMessage id="admin.compliance_table.download" defaultMessage="Download" />
            </a>
          )

          status = (
            <span className="status-icon-success">
              <FormattedMessage id="admin.compliance_table.success" defaultMessage="Success" />
            </span>
          )
        } else if (report.status === 'running') {
          status = (
            <span className="status-icon-warning">
              <FormattedMessage id="admin.compliance_table.pending" defaultMessage="Pending" />
            </span>
          )
        } else if (report.status === 'failed') {
          status = (
            <span className="status-icon-error">
              <FormattedMessage id="admin.compliance_table.failed" defaultMessage="Failed" />
            </span>
          )
        }
        ...
        <div style={style.content}>
          <table className="table">
            <thead>
              <tr>
                <th>
                  <FormattedMessage id="admin.compliance_table.status" defaultMessage="Status" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.files" defaultMessage="Files" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.timestamp" defaultMessage="Timestamp" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.records" defaultMessage="Records" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.type" defaultMessage="Type" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.desc" defaultMessage="Description" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.userId" defaultMessage="Requested By" />
                </th>
                <th>
                  <FormattedMessage id="admin.compliance_table.params" defaultMessage="Params" />
                </th>
              </tr>
            </thead>
            <tbody>{list}</tbody>
    ...
    return (
      <div className="panel compliance-panel">
        <h4>
          <FormattedMessage id="admin.compliance_reports.title" defaultMessage="Compliance Reports" />
        </h4>
        <div className="row">
          <div className="col-sm-6 col-md-4 form-group">
            <label>
              <FormattedMessage id="admin.compliance_reports.desc" defaultMessage="Job Name:" />
            </label>
            <LocalizedInput
              type="text"
              ...
              ref={this.descInput}
              placeholder={{
                id: t('admin.compliance_reports.desc_placeholder'),
        ...
        <div className="row">
          <div className="col-sm-6 col-md-4 form-group">
            <label>
              <FormattedMessage id="admin.compliance_reports.emails" defaultMessage="Emails:" />
            </label>
            <LocalizedInput
              type="text"
              className="form-control"
              ...
              placeholder={{
                id: t('admin.compliance_reports.emails_placeholder'),
          ...
          <div className="col-sm-6 col-md-4 form-group">
            <label>
              <FormattedMessage id="admin.compliance_reports.keywords" defaultMessage="Keywords:" />
            </label>
            <LocalizedInput
              type="text"
              className="form-control"
              ...
              placeholder={{
                id: t('admin.compliance_reports.keywords_placeholder'),
        ...
        <div className="clearfix">
          <button
            ...
            disabled={this.props.readOnly}
          >
            <FormattedMessage id="admin.compliance_reports.run" defaultMessage="Run Compliance Report" />
          </button>
        </div>
        {serverError}
        <div className="text-right">
          <button type="submit" className="btn btn-link" disabled={this.state.runningReport} onClick={this.reload}>
            <ReloadIcon />
            <FormattedMessage
