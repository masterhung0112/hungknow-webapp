...
export default class FeatureDiscovery extends React.PureComponent<Props, State> {
  ...
  render() {
    const { titleID, titleDefault, copyID, copyDefault, learnMoreURL, imgPath } = this.props
    ...
    return (
      <div className="FeatureDiscovery">
        <div className="FeatureDiscovery_copyWrapper">
          <div className="FeatureDiscovery_title" data-testid="featureDiscovery_title">
            <FormattedMessage id={titleID} defaultMessage={titleDefault} />
          </div>
          <div className="FeatureDiscovery_copy">
            <FormattedMessage id={copyID} defaultMessage={copyDefault} />
          </div>
          <button
            type="button"
          ...
          >
            ...
            >
              <FormattedMessage id="admin.ldap_feature_discovery.call_to_action.primary" defaultMessage="Start trial" />
            </LoadingWrapper>
          </button>
          <a
          ...
          >
            <FormattedMessage id="admin.ldap_feature_discovery.call_to_action.secondary" defaultMessage="Learn more" />
          </a>
          {gettingTrialError}
        ...
        <div className="FeatureDiscovery_imageWrapper">
          <img className="FeatureDiscovery_image" src={imgPath} alt="Feature Discovery Image" />
        </div>
      </div>
    )
  }
