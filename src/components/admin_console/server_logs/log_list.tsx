  ...
  render() {
    ...
    if (this.props.logs.length >= this.props.perPage) {
      nextButton = (
        ...
        >
          <FormattedMessage id="admin.logs.next" defaultMessage="Next" />
    ...
    if (this.props.page > 0) {
      previousButton = (
        ...
        >
          <FormattedMessage id="generic_icons.previous" defaultMessage="Previous Icon">
            {(title: string) => <i className="fa fa-angle-left" title={title} />}
          </FormattedMessage>
          <FormattedMessage id="admin.logs.prev" defaultMessage="Previous" />
        </button>
      )
    }
