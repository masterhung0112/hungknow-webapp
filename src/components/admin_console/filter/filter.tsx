...
class Filter extends React.PureComponent<Props, State> {
  ...
  renderFilterOptions = () => {
    ...
    return keys.map((key: string) => {
      ...
      return <FilterListComponent option={filter} optionKey={key} updateValues={this.updateValues} key={key} />
    })
  }
    ...
    return (
      <div className="Filter" ref={this.filterRef}>
        ...
        >
          ...
          <FormattedMessage id="admin.filter.filters" defaultMessage="Filters" />
        ...
        >
          <div className="Filter_header">
            <div className="Filter_title">
              <FormattedMessage id="admin.filter.title" defaultMessage="Filter by" />
            </div>

            <a className="Filter_reset" onClick={this.resetFilters}>
              <FormattedMessage id="admin.filter.reset" defaultMessage="Reset filters" />
            </a>
          </div>
          ...
          >
            <FormattedMessage id="admin.filter.apply" defaultMessage="Apply" />
          </button>
        </div>
      </div>
    )
