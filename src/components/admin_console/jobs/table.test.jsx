...
describe('components/admin_console/jobs/table', () => {
  const createJobButtonText = (
    <FormattedMessage id="admin.complianceExport.createJob.title" defaultMessage="Run Compliance Export Job Now" />
  )
  ...
  test('should call create job func', () => {
    const wrapper = shallowWithIntl(<JobTable {...baseProps} />)
  ...
  test('should call cancel job func', () => {
    ...
    wrapper
      ...
      .first()
      .simulate('click', { preventDefault: jest.fn(), currentTarget: { getAttribute: () => '1234' } })
  ...
  test('files column should show', () => {
    ...
    const wrapper = shallowWithIntl(<JobTable {...baseProps} jobType="message_export" downloadExportResults={true} />)
