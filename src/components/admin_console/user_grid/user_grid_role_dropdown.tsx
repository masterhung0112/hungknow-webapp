    ...
    return (
      <MenuWrapper isDisabled={isDisabled}>
        ...
        <Menu ariaLabel={ariaLabel}>
          <Menu.ItemAction show={showMakeAdmin} onClick={this.handleMakeAdmin} text={makeAdmin} />
          <Menu.ItemAction show={showMakeMember} onClick={this.handleMakeUser} text={makeMember} />
        </Menu>
      </MenuWrapper>
    )
  }
