...
export default class UserGrid extends React.PureComponent<Props, State> {
    ...
    return usersToDisplay.map((user) => {
      ...
      return {
        cells: {
          ...
          new: (
            <Badge className="NewUserBadge" show={Boolean(includeUsers[user.id])}>
              <FormattedMessage id="admin.user_grid.new" defaultMessage="New" />
            </Badge>
          ),
          role: (
          ...
          remove: <UserGridRemove user={user} removeUser={this.removeUser} isDisabled={readOnly} />,
        },
      }
    })
  }
  ...
  private getColumns = (): Column[] => {
    const name: JSX.Element = <FormattedMessage id="admin.user_grid.name" defaultMessage="Name" />
    const role: JSX.Element = <FormattedMessage id="admin.user_grid.role" defaultMessage="Role" />
  ...
  public render = (): JSX.Element => {
    ...
    const placeholderEmpty: JSX.Element = (
      <FormattedMessage id="admin.user_grid.notFound" defaultMessage="No users found" />
    )
