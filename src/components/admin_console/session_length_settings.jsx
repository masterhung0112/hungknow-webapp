...
export default class SessionLengthSettings extends AdminSettings {
  getConfigFromState = (config) => {
    ...
    config.ServiceSettings.SessionIdleTimeoutInMinutes = this.parseIntZeroOrMin(
  ...
  renderTitle() {
    return <FormattedMessage id="admin.sessionLengths.title" defaultMessage="Session Lengths" />
  }
    ...
    if (this.props.license.Compliance && !this.state.extendSessionLengthWithActivity) {
      sessionTimeoutSetting = (
        <TextSetting
          ...
          label={
            <FormattedMessage id="admin.service.sessionIdleTimeout" defaultMessage="Session Idle Timeout (minutes):" />
          }
    ...
    return (
      <SettingsGroup>
        ...
        <TextSetting
          ...
          label={
            <FormattedMessage id="admin.service.mobileSessionDays" defaultMessage="Session Length Mobile (days):" />
          }
          placeholder={Utils.localizeMessage('admin.service.sessionDaysEx', 'E.g.: "30"')}
        ...
        <TextSetting
          ...
          label={<FormattedMessage id="admin.service.ssoSessionDays" defaultMessage="Session Length SSO (days):" />}
          placeholder={Utils.localizeMessage('admin.service.sessionDaysEx', 'E.g.: "30"')}
        ...
        <TextSetting
          ...
          label={<FormattedMessage id="admin.service.sessionCache" defaultMessage="Session Cache (minutes):" />}
