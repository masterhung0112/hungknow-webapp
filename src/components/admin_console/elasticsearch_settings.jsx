...
export default class ElasticsearchSettings extends AdminSettings {
  ...
  renderTitle() {
    return <FormattedMessage id="admin.elasticsearch.title" defaultMessage="Elasticsearch" />
  }
    ...
    return (
      <SettingsGroup>
        ...
        <TextSetting
          id="connectionUrl"
          label={
            <FormattedMessage id="admin.elasticsearch.connectionUrlTitle" defaultMessage="Server Connection Address:" />
          }
        ...
        <TextSetting
          id="username"
          label={<FormattedMessage id="admin.elasticsearch.usernameTitle" defaultMessage="Server Username:" />}
        ...
        <TextSetting
          id="password"
          label={<FormattedMessage id="admin.elasticsearch.passwordTitle" defaultMessage="Server Password:" />}
        ...
        <BooleanSetting
          id="sniff"
          label={<FormattedMessage id="admin.elasticsearch.sniffTitle" defaultMessage="Enable Cluster Sniffing:" />}
          helpText={
            <FormattedMessage
        ...
        <RequestButton
          ...
          buttonText={
            <FormattedMessage id="admin.elasticsearch.elasticsearch_test_button" defaultMessage="Test Connection" />
          }
          successMessage={{
        ...
        <div className="form-group">
          <label className="control-label col-sm-4">
            <FormattedMessage id="admin.elasticsearch.bulkIndexingTitle" defaultMessage="Bulk Indexing:" />
          </label>
          <div className="col-sm-8">
            <div className="job-table-setting">
              <JobsTable
                ...
                createJobButtonText={
                  <FormattedMessage id="admin.elasticsearch.createJob.title" defaultMessage="Index Now" />
                }
                createJobHelpText={
                  <FormattedMessage
        ...
        <RequestButton
          ...
          buttonText={<FormattedMessage id="admin.elasticsearch.purgeIndexesButton" defaultMessage="Purge Index" />}
          successMessage={{
          ...
          label={<FormattedMessage id="admin.elasticsearch.purgeIndexesButton.label" defaultMessage="Purge Indexes:" />}
        />
        <BooleanSetting
          id="enableSearching"
          label={
