...
describe('components/LeavePrivateChannelModal', () => {
  ...
  test('should match snapshot, init', () => {
    const wrapper = shallow(<LeavePrivateChannelModal {...baseProps} />)

    expect(wrapper).toMatchSnapshot()
  })

  test('should show and hide the modal dialog', () => {
    const wrapper = shallow<LeavePrivateChannelModal>(<LeavePrivateChannelModal {...baseProps} />)
  ...
  test('should fail to leave channel', (done) => {
    ...
    const wrapper = shallow<LeavePrivateChannelModal>(<LeavePrivateChannelModal {...props} />)
