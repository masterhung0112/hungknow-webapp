...
export default class GeneralTab extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.activeSection === 'open_invite') {
        ...
        inputs = [
          <fieldset key="userOpenInviteOptions">
            <legend className="form-legend hidden-label">
              <FormattedMessage id="team_settings.openInviteDescription.ariaLabel" defaultMessage="Invite Code" />
            </legend>
            <div className="radio">
              <label>
                <input
      ...
      if (this.state.allow_open_invite === true) {
        ...
        describe = Utils.localizeMessage(
          'team_settings.openInviteSetting.groupConstrained',
          ...
          <div className="setting-list__hint">
            <FormattedMessage
              ...
              values={{
                getTeamInviteLink: (
                  <strong>
                    <FormattedMessage id="general_tab.getTeamInviteLink" defaultMessage="Get Team Invite Link" />
                  </strong>
                ),
              }}
            />
    ...
    if (this.props.activeSection === 'description') {
      ...
      let teamDescriptionLabel = <FormattedMessage id="general_tab.teamDescription" defaultMessage="Team Description" />
      if (Utils.isMobile()) {
