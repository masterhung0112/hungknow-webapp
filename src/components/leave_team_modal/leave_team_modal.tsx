  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Modal.Footer>
          <button type="button" className="btn btn-link" onClick={this.props.onHide} id="leaveTeamNo">
            <FormattedMessage id="leave_team_modal.no" defaultMessage="No" />
          </button>
          <button type="button" className="btn btn-danger" onClick={this.handleSubmit} id="leaveTeamYes">
