...
describe('FileAttachmentList', () => {
  ...
  test('should render a FileAttachment for a single file', () => {
    ...
    const wrapper = shallow(<FileAttachmentList {...props} />)
  ...
  test('should render a SingleImageView for a single image', () => {
    const props = {
      ...baseProps,
      fileCount: 1,
      fileInfos: [TestHelper.getFileInfoMock({ id: 'file_id_1', name: 'image.png', extension: 'png' })],
    }
  ...
  test('should render a SingleImageView for an SVG with SVG previews enabled', () => {
    const props = {
      ...
      enableSVGs: true,
      fileCount: 1,
      fileInfos: [TestHelper.getFileInfoMock({ id: 'file_id_1', name: 'image.svg', extension: 'svg' })],
    }
  ...
  test('should match state on handleImageClick', () => {
    const wrapper = shallow<FileAttachmentList>(<FileAttachmentList {...baseProps} />)
