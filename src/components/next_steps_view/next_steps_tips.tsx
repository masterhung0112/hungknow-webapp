...
const getDownloadButtonString = () => {
  if (UserAgent.isWindows()) {
    return <FormattedMessage id="next_steps_view.tips.getForWindows" defaultMessage="Get Mattermost for Windows" />
  }

  if (UserAgent.isMac()) {
    return <FormattedMessage id="next_steps_view.tips.getForMac" defaultMessage="Get Mattermost for Mac" />
  }

  // TODO: isLinux?

  return <FormattedMessage id="next_steps_view.tips.getForDefault" defaultMessage="Get Mattermost" />
}
...
export default function NextStepsTips(props: Props) {
  ...
  const closeNextSteps = openModal({
    ...
    dialogProps: {
      screenTitle: Utils.localizeMessage('sidebar_next_steps.tipsAndNextSteps', 'Tips & Next Steps'),
      onConfirm: () => {
      ...
      <>
        <Card expanded={true}>
          <div className="Card__body">
            ...
            <h3>
              <FormattedMessage id="next_steps_view.tips.connectPlugins" defaultMessage="Connect your favorite tools" />
            </h3>
            <FormattedMessage
            ...
            >
              <FormattedMessage id="next_steps_view.tips.addPlugins.button" defaultMessage="Add plugins" />
            </button>
          </div>
        </Card>
        <Card expanded={true}>
          <div className="Card__body">
            ...
            <h3>
              <FormattedMessage id="next_steps_view.tips.resolveIncidents" defaultMessage="Resolve incidents faster" />
            </h3>
            <FormattedMessage
            ...
            >
              <FormattedMessage id="next_steps_view.tips.resolveIncidents.button" defaultMessage="Open playbooks" />
            </button>
          </div>
        </Card>
      </>
    ...
    nonMobileTips = (
      <>
        <Card expanded={true}>
          <div className="Card__body">
            <h3>
              <FormattedMessage id="next_steps_view.tips.configureLogins" defaultMessage="See who else is here" />
            </h3>
            <FormattedMessage
            ...
            >
              <FormattedMessage id="next_steps_view.tips.viewMembers" defaultMessage="View team members" />
            </button>
          </div>
        </Card>
        <Card expanded={true}>
          <div className="Card__body">
            <h3>
              <FormattedMessage id="next_steps_view.tips.addPluginss" defaultMessage="Learn Keyboard Shortcuts" />
            </h3>
            <FormattedMessage
            ...
            >
              <FormattedMessage id="next_steps_view.tips.addPlugins.buttons" defaultMessage="See shortcuts" />
            </button>
          </div>
        </Card>
      </>
      ...
      <div className="NextStepsView__download">
        ...
        <div className="NextStepsView__downloadText">
          ...
          <div className="NextStepsView__downloadButtons">
            ...
            >
              <FormattedMessage id="next_steps_view.seeAllTheApps" defaultMessage="See all the apps" />
            </button>
          </div>
        </div>
      </div>
  ...
  if (props.isFirstAdmin) {
    channelsSection = (
      <Card expanded={true}>
        <div className="Card__body">
          ...
          <h3>
            <FormattedMessage id="next_steps_view.tips.manageWorkspace" defaultMessage="Manage your workspace" />
          </h3>
          <FormattedMessage
    ...
    channelsSection = (
      <Card expanded={true}>
        <div className="Card__body">
          <h3>
            <FormattedMessage id="next_steps_view.tips.exploreChannels" defaultMessage="Explore channels" />
          </h3>
          <FormattedMessage
          ...
          >
            <FormattedMessage id="next_steps_view.tips.exploreChannels.button" defaultMessage="Browse channels" />
          </button>
        </div>
      </Card>
    )
      ...
      <header className="NextStepsView__header">
        <div className="NextStepsView__header-headerText">
          <h1 className="NextStepsView__header-headerTopText">
            <FormattedMessage id="next_steps_view.tipsAndNextSteps" defaultMessage="Tips & Next Steps" />
          </h1>
          <h2 className="NextStepsView__header-headerBottomText">
            <FormattedMessage id="next_steps_view.otherAreasToExplore" defaultMessage="A few other areas to explore" />
          </h2>
        </div>
        <CloseIcon id="closeIcon" className="close-icon" onClick={() => closeNextSteps(dispatch)} />
      </header>
