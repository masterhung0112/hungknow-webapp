...
const DocumentsSvg = () => (
  <svg width="209" height="132" viewBox="0 0 209 132" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      fillOpacity="0.48"
    />
    <rect x="103" y="19.9999" width="28" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.16" />
    <rect x="103" y="33.9999" width="28" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.16" />
    <rect x="94.9995" y="47.9999" width="36" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="94.9995" y="61.9999" width="36" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="94.9995" y="75.9999" width="36" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="103" y="23.9999" width="28" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="103" y="37.9999" width="28" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="94.9995" y="51.9999" width="36" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="94.9995" y="65.9999" width="36" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <rect x="94.9995" y="79.9999" width="36" height="2" rx="1" fill="var(--center-channel-color)" fillOpacity="0.08" />
    <defs>
      <filter
        id="svg2-filter0_d"
        x="0.898071"
