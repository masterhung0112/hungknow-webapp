...
describe('components/next_steps_view/steps/complete_profile_step', () => {
  ...
  test('should match snapshot', () => {
    const wrapper = shallow(<CompleteProfileStep {...baseProps} />)

    expect(wrapper).toMatchSnapshot()
  })

  test('should only accept files that are of the expected types and within the max size', () => {
    const wrapper: ShallowWrapper<any, any, CompleteProfileStep> = shallow(<CompleteProfileStep {...baseProps} />)
  ...
  test('should update user name correctly', () => {
    ...
    const wrapper: ShallowWrapper<any, any, CompleteProfileStep> = shallow(<CompleteProfileStep {...props} />)
