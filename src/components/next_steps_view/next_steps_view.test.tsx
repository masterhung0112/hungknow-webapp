...
describe('components/next_steps_view', () => {
  ...
  test('should match snapshot', () => {
    const wrapper = shallow(<NextStepsView {...baseProps} />)
  ...
  test('should return complete if pref exists', () => {
    ...
    const wrapper: ShallowWrapper<any, any, NextStepsView> = shallow(<NextStepsView {...props} />)
  ...
  test('should expand next step when previous step is marked complete', () => {
    const wrapper: ShallowWrapper<any, any, NextStepsView> = shallow(<NextStepsView {...baseProps} />)
