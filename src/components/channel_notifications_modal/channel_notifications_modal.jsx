...
export default class ChannelNotificationsModal extends React.PureComponent {
  ...
  getStateFromNotifyProps(channelMemberNotifyProps, currentUserNotifyProps) {
    ...
    if (
      channelMemberNotifyProps.mark_unread === NotificationLevels.MENTION ||
      (currentUserNotifyProps.channel && currentUserNotifyProps.channel === 'false')
    ) {
  ...
  render() {
    ...
    const { channel, channelMember, currentUser, sendPushNotifications } = this.props
    ...
    return (
      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="channelNotificationModalLabel">
            <FormattedMessage id="channel_notifications.preferences" defaultMessage="Notification Preferences for " />
                  ...
                  <div>
                    ...
                    <NotificationSection
                      ...
                      globalNotificationLevel={
                        currentUser.notify_props ? currentUser.notify_props.desktop : NotificationLevels.ALL
                      }
                    ...
                    {sendPushNotifications && (
                      <NotificationSection
                        ...
                        globalNotificationLevel={
                          currentUser.notify_props ? currentUser.notify_props.push : NotificationLevels.ALL
                        }
