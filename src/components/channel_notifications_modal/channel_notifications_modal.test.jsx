...
describe('components/channel_notifications_modal/ChannelNotificationsModal', () => {
  ...
  test('should provide default notify props when missing', () => {
    const wrapper = shallow(<ChannelNotificationsModal {...baseProps} channelMember={{ notify_props: {} }} />)
  ...
  test('should match state on resetStateFromNotifyProps', () => {
    ...
    wrapper
      .instance()
      .resetStateFromNotifyProps({ ...channelMemberNotifyProps, push: NotificationLevels.NONE }, currentUserNotifyProps)
