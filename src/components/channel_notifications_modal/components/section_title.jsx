...
export default function SectionTitle({ section }) {
  if (section === NotificationSections.DESKTOP) {
    return <FormattedMessage id="channel_notifications.sendDesktop" defaultMessage="Send desktop notifications" />
  } else if (section === NotificationSections.PUSH) {
    return <FormattedMessage id="channel_notifications.push" defaultMessage="Send mobile push notifications" />
  } else if (section === NotificationSections.MARK_UNREAD) {
    return <FormattedMessage id="channel_notifications.muteChannel.settings" defaultMessage="Mute Channel" />
