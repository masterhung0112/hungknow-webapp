...
import { getCurrentUser, shouldShowTermsOfService } from 'hkclient-ts/lib/selectors/entities/users'
...
const getChannelURLAction = (channel, teamId) => (dispatch, getState) =>
  browserHistory.push(getChannelURL(getState(), channel, teamId))
