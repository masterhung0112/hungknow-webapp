...
import { StripeError, ConfirmCardSetupData, ConfirmCardSetupOptions, SetupIntent } from '@stripe/stripe-js'

type ConfirmCardSetupType = (
  clientSecret: string,
  data?: ConfirmCardSetupData | undefined,
  options?: ConfirmCardSetupOptions | undefined
) => Promise<{ setupIntent?: SetupIntent | undefined; error?: StripeError | undefined }> | undefined
