    ...
    if (notice.adminOnly) {
      visibleMessage = (
        <div className="system-notice__info">
          ...
          />
          <FormattedMessage id="system_notice.adminVisible" defaultMessage="Only visible to System Admins" />
        </div>
      )
    }
    ...
    return (
      <div className="system-notice bg--white shadow--2">
        ...
        <div className="system-notice__footer">
          <button id="systemnotice_remindme" className="btn btn-transparent" onClick={this.hideAndRemind}>
            <FormattedMessage id="system_notice.remind_me" defaultMessage="Remind Me Later" />
          </button>
          {notice.allowForget && (
            <button id="systemnotice_dontshow" className="btn btn-transparent" onClick={this.hideAndForget}>
              <FormattedMessage id="system_notice.dont_show" defaultMessage="Don't Show Again" />
            </button>
          )}
        </div>
      </div>
