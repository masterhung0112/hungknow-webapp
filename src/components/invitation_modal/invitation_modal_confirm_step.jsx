  ...
  render() {
    ...
    return (
      <div className="InvitationModalConfirmStep">
        ...
        <h2 className="subtitle">{this.getInvitesCountsMessage(invitesSent.length, invitesNotSent.length)}</h2>
        {invitesSent.length > 0 && (
          <div className="invitation-modal-confirm-sent">
            <h2>
              <FormattedMessage id="invitation_modal.confirm.sent-header" defaultMessage="Successful Invites" />
            </h2>
        ...
        {invitesNotSent.length > 0 && (
          <div className="invitation-modal-confirm-not-sent">
            <h2>
              <FormattedMessage id="invitation_modal.confirm.not-sent-header" defaultMessage="Invitations Not Sent" />
            </h2>
            <InvitationModalConfirmStepTable invites={invitesNotSent} />
          </div>
        )}
        <div className="button-input-block">
          <button className="btn invite-more" onClick={onInviteMore}>
            <FormattedMessage id="invitation_modal.invite.more" defaultMessage="Invite More People" />
          </button>
          <button className="btn btn-primary confirm-done" onClick={onDone}>
            <FormattedMessage id="invitation_modal.confirm.done" defaultMessage="Done" />
          </button>
        </div>
      </div>
    )
