...
export default class InvitationModal extends React.PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      ...
      prevState.step !== STEPS_INVITE_MEMBERS &&
  ...
  getBackFunction = () => {
    ...
    if (
      (this.state.step === STEPS_INVITE_MEMBERS || this.state.step === STEPS_INVITE_GUESTS) &&
      this.props.canInviteGuests &&
      this.props.canAddUsers
    ) {
  ...
  onMembersSubmit = async (users, emails, extraText) => {
    ...
    this.setState({
      step: STEPS_INVITE_CONFIRM,
      prevStep: this.state.step,
      invitesSent: invites.sent,
      invitesNotSent: invites.notSent,
      invitesType: InviteTypes.INVITE_MEMBER,
      hasChanges: false,
    })
  }
  ...
  render() {
    const invitationModal = (
      <RootPortal>
        ...
        >
          <div data-testid="invitationModal" className="InvitationModal">
            <ConfirmModal
              show={this.state.confirmModal || this.state.confirmBack}
              title={<FormattedMessage id="invitation-modal.discard-changes.title" defaultMessage="Discard Changes" />}
              message={
                <FormattedMessage
              ...
              confirmButtonText={
                <FormattedMessage id="invitation-modal.discard-changes.button" defaultMessage="Yes, Discard" />
              }
    ...
    return <>{this.props.isFreeTierWithNoFreeSeats ? userLimitModal : invitationModal}</>
  }
}
