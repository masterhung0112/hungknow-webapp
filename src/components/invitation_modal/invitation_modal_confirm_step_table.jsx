      ...
      <div className="InvitationModalConfirmStepTable">
        <div className="table-header">
          <div className="people-header">
            <FormattedMessage id="invitation-modal.confirm.people-header" defaultMessage="People" />
          </div>
          <div className="details-header">
            <FormattedMessage id="invitation-modal.confirm.details-header" defaultMessage="Details" />
          </div>
        </div>
        <div className="rows">
