...
import * as ReduxPostUtils from 'hkclient-ts/lib/utils/post_utils'
...
class RhsRootPost extends React.PureComponent {
  ...
  renderPostTime = (isEphemeral) => {
    ...
    return (
      <PostTime isPermalink={isPermalink} eventTime={post.create_at} postId={post.id} location={Locations.RHS_ROOT} />
    )
  }
  ...
  handlePostFocus = () => {
    ...
    this.setState({
      currentAriaLabel: PostUtils.createAriaLabelForPost(post, author, isFlagged, reactions, this.props.intl, emojiMap),
    })
  }
  ...
  render() {
    ...
    if (isSystemMessage) {
      ...
      if (post.props.override_username && this.props.enablePostUsernameOverride) {
        ...
        userProfile = <UserProfile key={post.user_id} userId={post.user_id} hideStatus={true} disablePopover={true} />
      }
    ...
    if (showFlagIcon) {
      postFlagIcon = <PostFlagIcon location={Locations.RHS_ROOT} postId={post.id} isFlagged={this.props.isFlagged} />
    }
