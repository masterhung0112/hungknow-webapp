  ...
  public render(): JSX.Element {
    ...
    if (this.state.resendStatus === 'success') {
      resendConfirm = (
        <div>
          <br />
          <p data-testid="emailVerifySentMessage" className="alert alert-success">
            <SuccessIcon />
      ...
      resendConfirm = (
        <div>
          ...
          <p className="alert alert-danger">
            <FormattedMessage id="generic_icons.fail" defaultMessage="Faliure Icon">
              {(title: string) => <i className="fa fa-times" title={title} />}
            </FormattedMessage>
        ...
        <div className="col-sm-12">
          <div className="signup-team__container">
            ...
            <div>
              ...
              <button data-testid="emailVerifyResend" onClick={this.handleResend} className="btn btn-primary">
