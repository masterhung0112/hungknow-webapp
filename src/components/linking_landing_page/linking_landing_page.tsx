...
export default class LinkingLandingPage extends PureComponent<Props, State> {
  ...
  renderDownloadLinkText = () => {
    ...
    if (isMobile) {
      return <FormattedMessage id="get_app.dontHaveTheMobileApp" defaultMessage={"Don't have the Mobile App?"} />
    }

    return <FormattedMessage id="get_app.dontHaveTheDesktopApp" defaultMessage={"Don't have the Desktop App?"} />
  }
    ...
    if (this.state.redirectPage) {
      ...
      return (
        <div className="get-app__download-link">
          ...
          <br />
          <a href={downloadLink}>
            <FormattedMessage id="get_app.downloadTheAppNow" defaultMessage="Download the app now." />
          </a>
        </div>
      )
    }
  ...
  renderDialogHeader = () => {
    ...
    let openingLink = <FormattedMessage id="get_app.openingLink" defaultMessage="Opening link in Mattermost..." />
    if (this.props.enableCustomBrand) {
      openingLink = (
        <FormattedMessage id="get_app.openingLinkWhiteLabel" defaultMessage="Opening link in the Desktop App..." />
      )
    }
    ...
    return (
      <div className="get-app__launching">
        <FormattedMessage id="get_app.launching" defaultMessage="Where would you like to view this?" />
        <div className="get-app__alternative">{viewApp}</div>
      </div>
    )
  }
    ...
    return (
      <div className="get-app__dialog-body">
        ...
        <div className="get-app__buttons">
          <div className="get-app__status">{this.renderGoNativeAppMessage()}</div>
          <div className="get-app__status">
            ...
            >
              <FormattedMessage id="get_app.continueToBrowser" defaultMessage="View in Browser" />
            </a>
          </div>
        </div>
        <div className="get-app__preference">
          ...
          <FormattedMessage id="get_app.rememberMyPreference" defaultMessage="Remember my preference" />
        </div>
        {this.renderDownloadLinkSection()}
      </div>
    )
  ...
  renderHeader = () => {
    let header = (
      <div className="get-app__header">
        <img src={MattermostLogoSvg} className="get-app__logo" />
      </div>
    )
    if (this.props.enableCustomBrand && this.props.brandImageUrl) {
      ...
      if (this.props.brandImageUrl && !this.state.brandImageError) {
        customLogo = (
          <img src={this.props.brandImageUrl} onError={this.handleBrandImageError} className="get-app__custom-logo" />
        )
      }
    ...
    return (
      <div className="get-app">
        ...
        <div className="get-app__dialog">
          <div className={`get-app__graphic ${isMobile ? 'mobile' : ''}`}>{this.renderGraphic()}</div>
