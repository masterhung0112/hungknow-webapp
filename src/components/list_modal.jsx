        ...
        >
          <Modal.Header closeButton={true}>
            ...
            {this.props.titleBarButtonText && this.props.titleBarButtonOnClick && (
              <a className="btn btn-md btn-primary" href="#" onClick={this.props.titleBarButtonOnClick}>
          ...
          <Modal.Body>
            <div className="filtered-user-list">
              ...
              <div className="filter-controls">
                {this.state.page > 0 && (
                  <button onClick={this.onPrev} className="btn btn-link filter-control filter-control__prev">
                ...
                {this.state.items.length >= this.props.numPerPage && endCount !== this.state.totalCount && (
                  <button onClick={this.onNext} className="btn btn-link filter-control filter-control__next">
