    ...
    if (this.state.clientError) {
      clientError = (
        <div className="file-status">
          <FormattedMessage id="setting_upload.noFile" defaultMessage="No file selected." />
        </div>
      )
    }
          ...
          <ul className="setting-list">
            <li className="setting-list-item">
              <input
                ...
                aria-hidden={true}
              />
              <button onClick={this.openFileSelect} className="btn btn-sm btn-primary btn-file sel-btn">
                <FormattedMessage id="setting_upload.select" defaultMessage="Select file" />
              </button>
              <a className={submitButtonClass} onClick={this.doSubmit}>
                <FormattedMessage id="setting_upload.import" defaultMessage="Import" />
              </a>
              {fileNameText}
              {serverError}
              {clientError}
