    ...
    if (this.props.mfa && this.props.enforceMultifactorAuthentication) {
      backButton = (
        <div className="signup-header">
          <button className="style--none color--link" onClick={this.handleOnClick}>
            <LogoutIcon />
          ...
          <div>
            ...
            <div className="col-sm-12">
              <div className="signup-team__container">
                <h3>
                  <FormattedMessage id="mfa.setupTitle" defaultMessage="Multi-factor Authentication Setup" />
                </h3>
                ...
                <div id="mfa">
                  <Switch>
                    <Route
                      ...
                      render={(props) => <Setup state={this.state} updateParent={this.updateParent} {...props} />}
                    />
                    <Route
                      path={`${this.props.match.url}/confirm`}
                      render={(props) => <Confirm state={this.state} updateParent={this.updateParent} {...props} />}
                    />
                  </Switch>
                </div>
              </div>
