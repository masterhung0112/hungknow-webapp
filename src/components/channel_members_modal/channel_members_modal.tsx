      ...
      <div>
        ...
        >
          <Modal.Header closeButton={true}>
            <Modal.Title componentClass="h1" id="channelMembersModalLabel">
            ...
            {this.props.canManageChannelMembers && !channelIsArchived && (
              <a id="showInviteModal" className="btn btn-md btn-primary" href="#" onClick={this.onAddNewMembersButton}>
                <FormattedMessage id="channel_members_modal.addNew" defaultMessage=" Add Members" />
              </a>
            )}
          </Modal.Header>
          <Modal.Body>
