...
import { getFilePreviewUrl, getFileUrl } from 'hkclient-ts/lib/utils/file_utils'
...
export default class SingleImageView extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    const fileHeader = (
      <div data-testid="image-name" className={imageNameClass}>
        ...
        <div className="file__image">
          ...
          {this.props.isEmbedVisible && (
            <div className="image-container" style={imageContainerStyle}>
              <div className={`image-loaded ${fadeInClass} ${svgClass}`} style={styleIfSvgWithDimensions}>
                <SizeAwareImage
