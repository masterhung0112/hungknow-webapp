...
export default class ErrorPage extends React.PureComponent<Props> {
  ...
  public render() {
    ...
    if (type === ErrorPageTypes.PERMALINK_NOT_FOUND && returnTo) {
      backButton = (
        <Link to={returnTo}>
          <FormattedMessage id="error.generic.link" defaultMessage="Back to Mattermost" />
        </Link>
      )
      ...
      backButton = (
        <Link to="/">
          <FormattedMessage id="error.channelNotFound.guest_link" defaultMessage="Back" />
        </Link>
      )
      ...
      backButton = (
        <Link to="/">
          <FormattedMessage id="error.generic.link_login" defaultMessage="Back to Login Page" />
        </Link>
      )
    ...
    let errorPage = (
      <div className="container-fluid">
        <div className="error__container">
          ...
          <ErrorMessage type={type} message={message} service={service} isGuest={isGuest} />
          {backButton}
        </div>
      </div>
    )
