...
const ErrorMessage: React.FC<Props> = ({ type, message, service, isGuest }: Props) => {
  ...
  if (type) {
      ...
      case ErrorPageTypes.LOCAL_STORAGE:
        errorMessage = (
          <div>
            ...
            <ul>
              <li>
                <FormattedMessage id="error.local_storage.help1" defaultMessage="Enable cookies" />
              </li>
              <li>
                <FormattedMessage id="error.local_storage.help2" defaultMessage="Turn off private browsing" />
              </li>
              <li>
                <FormattedMessage
    ...
    errorMessage = (
      <p>
        <FormattedMessage id="error.generic.message" defaultMessage="An error has occurred." />
      </p>
    )
  }
