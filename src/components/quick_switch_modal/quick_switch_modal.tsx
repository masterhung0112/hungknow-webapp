...
export default class QuickSwitchModal extends React.PureComponent<Props, State> {
  ...
  public render = (): JSX.Element => {
    ...
    let header = (
      <h1>
        <FormattedMessage id="quick_switch_modal.switchChannels" defaultMessage="Switch Channels" />
      </h1>
    )
      ...
      header = (
        <div className="nav nav-tabs">
          <li className={channelsActiveClass}>
            <a data-mode={'channel'} href="#" onClick={this.handleOnClick}>
          ...
          <li className={teamsActiveClass}>
            <a data-mode={'team'} href="#" onClick={this.handleOnClick}>
    ...
    let help
    if (Utils.isMobile()) {
      help = <FormattedMarkdownMessage id="quick_switch_modal.help_mobile" defaultMessage="Type to find a channel." />
      ...
      >
        ...
        <Modal.Body>
          <div className="channel-switcher__header">
            {header}
            <div className="channel-switcher__hint" id="quickSwitchHint">
              {help}
            </div>
          </div>
