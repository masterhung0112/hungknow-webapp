    ...
    return (
      <React.Fragment>
        {ReactDOM.createPortal(
          <div style={tooltipContainerStyles} ref={this.tooltipContainerRef}>
            <Pluggable href={href} show={this.state.show} pluggableName="LinkTooltip" />
          </div>,
          document.getElementById('root') as HTMLElement
        )}
        <span onMouseOver={this.showTooltip} onMouseLeave={this.hideTooltip} {...dataAttributes}>
          {children}
        </span>
      </React.Fragment>
    )
