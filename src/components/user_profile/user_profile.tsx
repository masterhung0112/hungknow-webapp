  ...
  render(): React.ReactNode {
    ...
    return (
      <React.Fragment>
        ...
        >
          <button aria-label={ariaName} className="user-popover style--none">
            {name}
          </button>
        </OverlayTrigger>
        <BotBadge show={Boolean(user && user.is_bot)} className="badge-popoverlist" />
        <GuestBadge show={Boolean(user && isGuest(user))} className="badge-popoverlist" />
      </React.Fragment>
    )
  }
}
