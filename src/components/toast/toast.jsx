  ...
  render() {
      ...
      closeTooltip = (
        <Tooltip id="toast-close__tooltip">
          ...
          <div className="tooltip__shortcut--txt">
            <FormattedMessage id="general_button.esc" defaultMessage="esc" />
          </div>
        </Tooltip>
      )
    }
    ...
    return (
      <div className={toastClass}>
        <div className={toastActionClass} onClick={showActions ? this.props.onClick : null}>
        ...
        >
          <OverlayTrigger delayShow={Constants.OVERLAY_TIME_DELAY} placement="bottom" overlay={closeTooltip}>
