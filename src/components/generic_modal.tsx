...
export default class GenericModal extends React.PureComponent<Props, State> {
  ...
  render() {
    let confirmButton
    if (this.props.handleConfirm) {
      let confirmButtonText: React.ReactNode = <FormattedMessage id="generic_modal.confirm" defaultMessage="Confirm" />
    ...
    let cancelButton
    if (this.props.handleCancel) {
      let cancelButtonText: React.ReactNode = <FormattedMessage id="generic_modal.cancel" defaultMessage="Cancel" />
      if (this.props.cancelButtonText) {
        cancelButtonText = this.props.cancelButtonText
      }

      cancelButton = (
        <button type="button" className="GenericModal__button cancel" onClick={this.handleCancel}>
          {cancelButtonText}
        </button>
      )
    }
