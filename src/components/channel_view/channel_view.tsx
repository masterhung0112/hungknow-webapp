...
import { Action, ActionFunc } from 'hkclient-ts/lib/types/actions'
...
export default class ChannelView extends React.PureComponent<Props, State> {
  ...
  componentDidUpdate(prevProps: Props) {
    if (prevProps.channelId !== this.props.channelId || prevProps.channelIsArchived !== this.props.channelIsArchived) {
      ...
      clearMarks(['SidebarChannelLink#click', 'ChannelView#componentDidUpdate', 'TeamLink#click'])
  ...
  render() {
    ...
    if (this.props.deactivatedChannel) {
      createPost = (
        <div className="post-create__container" id="post-create">
          <div className="channel-archived__message">
            ...
            />
            <button className="btn btn-primary channel-archived__close-btn" onClick={this.onClickCloseChannel}>
              <FormattedMessage id="center_panel.archived.closeChannel" defaultMessage="Close Channel" />
            </button>
          </div>
        </div>
      )
      ...
      createPost = (
        <div className="post-create__container" id="post-create">
          <div id="channelArchivedMessage" className="channel-archived__message">
            <FormattedMarkdownMessage
    ...
    return (
      <div ref={this.channelViewRef} id="app-content" className="app__content">
