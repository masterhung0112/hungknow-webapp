...
export const SidebarCategoryHeaderStatic = React.forwardRef((props: StaticProps, ref?: React.Ref<HTMLDivElement>) => {
  return (
    ...
    >
      <div ref={ref} className="SidebarChannelGroupHeader_groupButton">
        <div className="SidebarChannelGroupHeader_text">{wrapEmojis(props.displayName)}</div>
        {props.children}
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="SidebarChannelGroupHeader_text" {...props.dragHandleProps}>
