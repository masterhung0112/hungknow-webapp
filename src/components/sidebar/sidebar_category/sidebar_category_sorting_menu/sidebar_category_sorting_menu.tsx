...
export class SidebarCategorySortingMenu extends React.PureComponent<Props, State> {
      ...
      <React.Fragment>
        <Menu.Group>
          <Menu.ItemSubMenu
            ...
            selectedValueText={
              category.sorting === CategorySorting.Alphabetical
                ? intl.formatMessage({ id: 'user.settings.sidebar.sortAlpha', defaultMessage: 'Alphabetically' })
                : intl.formatMessage({ id: 'user.settings.sidebar.recent', defaultMessage: 'Recent Activity' })
            }
            icon={
              category.sorting === CategorySorting.Alphabetical ? (
          ...
          <Menu.ItemSubMenu
            ...
            selectedValueText={
              this.props.selectedDmNumber === 10000
                ? intl.formatMessage({ id: 'channel_notifications.levels.all', defaultMessage: 'All' })
                : this.props.selectedDmNumber
            }
  ...
  render() {
    const { intl, isCollapsed, isMenuOpen } = this.props
