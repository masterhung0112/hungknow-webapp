...
describe('components/sidebar/sidebar_menu', () => {
  ...
  test('should match snapshot', () => {
    const wrapper = shallow(<SidebarMenu {...baseProps} />)
  ...
  test('should set menu state and set position when menu is toggled', () => {
    const props = {
      ...baseProps,
      children: [<li key="test-item" id="test-item" />],
    }

    const wrapper = shallow<SidebarMenu>(<SidebarMenu {...props} />)
  ...
  test('should call external onToggle when menu is toggled', () => {
    const wrapper = mount<SidebarMenu>(<SidebarMenu {...baseProps} />)
  ...
  test('should set the openUp and width properties correctly based on window and ref information', () => {
    ...
    const wrapper = shallow<SidebarMenu>(<SidebarMenu {...baseProps} />)
