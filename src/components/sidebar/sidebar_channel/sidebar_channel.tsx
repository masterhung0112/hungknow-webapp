...
export default class SidebarChannel extends React.PureComponent<Props, State> {
  ...
  componentDidUpdate(prevProps: Props) {
    if (
      this.isCollapsed(this.props) !== this.isCollapsed(prevProps) &&
      this.props.draggingState.state !== DraggingStates.CAPTURE &&
      this.props.draggingState.state !== DraggingStates.BEFORE
    ) {
  ...
  render() {
    ...
    let ChannelComponent: React.ComponentType<{
      channel: Channel
      currentTeamName: string
      isCollapsed: boolean
    }> = SidebarBaseChannel
              ...
              <li
                ...
                className={classNames('SidebarChannel', {
                  ...
                  fadeOnDrop:
                    ...
                    autoSortedCategoryIds.has(snapshot.draggingOver),
