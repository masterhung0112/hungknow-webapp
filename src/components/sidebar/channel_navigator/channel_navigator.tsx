  ...
  render() {
    ...
    const jumpToButton = (
      ...
      >
        ...
        <FormattedMessage id="sidebar_left.channel_navigator.jumpTo" defaultMessage="Find channel" />
        <div className={'SidebarChannelNavigator_shortcutText'}>{channelSwitchTextShortcutDefault}</div>
      </button>
    )
