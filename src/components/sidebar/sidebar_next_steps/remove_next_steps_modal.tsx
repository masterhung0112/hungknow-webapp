    ...
    <>
      {ReactDOM.createPortal(
        <div className="RemoveNextStepsModal__helpBox">
          <img className="RemoveNextStepsModal__arrow" src={closeNextStepsArrow} />
      ...
      <GenericModal
        ...
        confirmButtonText={<FormattedMessage id={'remove_next_steps_modal.confirm'} defaultMessage="Remove" />}
      >
        <FormattedMessage
