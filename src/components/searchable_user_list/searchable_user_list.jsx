      ...
      filterRow = (
        <div className="col-xs-12">
          <label className="hidden-label" htmlFor="searchUsersInput">
            <FormattedMessage id="filtered_user_list.search" defaultMessage="Search users" />
          </label>
          <QuickInput
            id="searchUsersInput"
            ref="filter"
      ...
      <div className="filtered-user-list">
        <div className="filter-row">
          ...
          <div className="col-sm-12">
            <span id="searchableUserListTotal" className="member-count pull-left" aria-live="polite">
