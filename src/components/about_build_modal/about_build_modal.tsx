...
export default class AboutBuildModal extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    if (license.Cloud === 'true') {
      return <AboutBuildModalCloud {...this.props} {...this.state} doHide={this.doHide} />
    }
    ...
    const termsOfService = (
      <a target="_blank" id="tosLink" rel="noopener noreferrer" href={AboutLinks.TERMS_OF_SERVICE}>
        <FormattedMessage id="about.tos" defaultMessage="Terms of Service" />
      </a>
    )

    const privacyPolicy = (
      <a target="_blank" id="privacyLink" rel="noopener noreferrer" href={AboutLinks.PRIVACY_POLICY}>
        ...
        <Modal.Body>
          <div className="about-modal__content">
            ...
            <div>
              ...
              <div className="form-group less">
                <div>
                  <FormattedMessage id="about.version" defaultMessage="Mattermost Version:" />
                  <span id="versionString">{'\u00a0' + mmversion}</span>
                </div>
                <div>
                  <FormattedMessage id="about.dbversion" defaultMessage="Database Schema Version:" />
          ...
          <div className="about-modal__hash">
            <p>
              ...
              <br />
              <FormattedMessage id="about.hashwebapp" defaultMessage="Webapp Build Hash:" />
              <Nbsp />
              {
                /* global COMMIT_HASH */ this.props.webappBuildHash ||
