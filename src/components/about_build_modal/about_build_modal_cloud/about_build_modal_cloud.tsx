...
export default function AboutBuildModalCloud(props: Props) {
  ...
  const title = <FormattedMessage id="about.cloudEdition" defaultMessage="Cloud" />

  const subTitle = (
    <FormattedMessage id="about.enterpriseEditionSst" defaultMessage="High trust messaging for the enterprise" />
  )
