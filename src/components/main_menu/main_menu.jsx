...
class MainMenu extends React.PureComponent {
  ...
  render() {
    ...
    const someIntegrationEnabled =
      ...
      this.props.canManageSystemBots
    ...
    return (
      ...
      >
        ...
        <Menu.Group>
          <TeamPermissionGate teamId={this.props.teamId} permissions={[Permissions.MANAGE_TEAM]}>
            <Menu.ItemToggleModalRedux
              id="addGroupsToTeam"
        ...
        <Menu.Group>
          ...
          />
          <TeamPermissionGate teamId={this.props.teamId} permissions={[Permissions.MANAGE_SYSTEM]}>
            <Menu.ItemToggleModalRedux
              id="marketplaceModal"
        ...
        <Menu.Group>
          ...
          <Menu.ItemAction
            ...
            text={formatMessage({
              id: this.props.showNextStepsTips
                ? 'sidebar_next_steps.tipsAndNextSteps'
                : 'navbar_dropdown.gettingStarted',
              defaultMessage: this.props.showNextStepsTips ? 'Tips & Next Steps' : 'Getting Started',
            })}
          />
          <Menu.ItemAction
          ...
          <Menu.ItemToggleModalRedux
            ...
            text={formatMessage(
              { id: 'navbar_dropdown.about', defaultMessage: 'About {appTitle}' },
