  ...
  render() {
    ...
    return (
      <div key={this.props.user.id} className="more-modal__row">
        ...
        />
        <div className="more-modal__details" data-testid="userListItemDetails">
          <div className="d-flex whitespace--nowrap">
            <div id={userCountID} className="more-modal__name">
              <UserProfile userId={this.props.user.id} hasMention={true} displayUsername={true} />
              <Nbsp />
              {this.props.user.first_name || this.props.user.last_name || this.props.user.nickname ? '-' : null}
              <Nbsp />
        ...
        <div data-testid="userListItemActions" className="more-modal__actions">
          {buttons}
        </div>
      </div>
    )
