...
export default class CreateTeam extends React.PureComponent<Props & RouteComponentProps, State> {
  ...
  render() {
    const { currentChannel, currentTeam, customDescriptionText, match, siteName } = this.props
            ...
            <div className="signup__content">
              <Switch>
                <Route
                  ...
                  render={(props) => <DisplayName state={this.state} updateParent={this.updateParent} {...props} />}
                />
                <Route
                  path={`${this.props.match.url}/team_url`}
                  render={(props) => <TeamUrl state={this.state} updateParent={this.updateParent} {...props} />}
                />
