...
export default class TeamUrl extends React.PureComponent<Props, State> {
  ...
  public submitNext = async (e: React.MouseEvent<Button, MouseEvent>) => {
    ...
    if (!name) {
      this.setState({
        nameError: <FormattedMessage id="create_team.team_url.required" defaultMessage="This field is required" />,
      })
      return
    }
  ...
  render() {
    ...
    if (this.state.isLoading) {
      finishMessage = <FormattedMessage id="create_team.team_url.creatingTeam" defaultMessage="Creating team..." />
    }
      ...
      <div>
        <form>
            ...
            <div className="row">
              <div className="col-sm-11">
                <div className="input-group input-group--limit">
                  <OverlayTrigger delayShow={Constants.OVERLAY_TIME_DELAY} placement="top" overlay={urlTooltip}>
          ...
          <ul className="color--light">
            <li>
              <FormattedMessage id="create_team.team_url.hint1" defaultMessage="Short and memorable is best" />
            </li>
            <li>
              <FormattedMessage
