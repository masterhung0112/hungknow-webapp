...
export default class TeamSignupDisplayNamePage extends React.PureComponent {
  ...
  submitNext = (e) => {
    ...
    if (!displayName) {
      this.setState({
        nameError: <FormattedMessage id="create_team.display_name.required" defaultMessage="This field is required" />,
      })
      return
    } else if (
    ...
    return (
      <div>
        <form>
          ...
          <button id="teamNameNextButton" type="submit" className="btn btn-primary mt-8" onClick={this.submitNext}>
