...
describe('components/MaxLengthInput', () => {
  ...
  test.each([[undefined], ['less than 20'], ['Where is Jessica Hyde?']])('should match snapshot', (defaultValue) => {
    const wrapper = shallow(<MaxLengthInput {...requiredProps} defaultValue={defaultValue} />)
