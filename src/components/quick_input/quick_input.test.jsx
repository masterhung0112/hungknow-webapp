...
describe('components/QuickInput', () => {
  ...
  describe('should render clear button', () => {
    ...
    test('with customized tooltip text', () => {
      const wrapper = mount(
        <QuickInput value="mock" clearable={true} clearableTooltipText="Custom" onClear={() => {}} />
      )
    ...
    test('with customized tooltip component', () => {
      const wrapper = mount(
        <QuickInput value="mock" clearable={true} clearableTooltipText={<span>{'Custom'}</span>} onClear={() => {}} />
      )
  ...
  test('should dismiss clear button', () => {
    ...
    const wrapper = mount(<QuickInput value="mock" clearable={true} onClear={() => {}} inputComponent={MockComp} />)
