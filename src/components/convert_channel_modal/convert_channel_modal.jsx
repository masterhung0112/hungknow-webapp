    ...
    return (
      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="convertChannelModalLabel">
            <FormattedMessage
        ...
        <Modal.Footer>
          <button type="button" className="btn btn-link" onClick={this.onHide}>
            <FormattedMessage id="convert_channel.cancel" defaultMessage="No, cancel" />
          </button>
          <button
            type="button"
          ...
          >
            <FormattedMessage id="convert_channel.confirm" defaultMessage="Yes, convert to private channel" />
          </button>
        </Modal.Footer>
      </Modal>
    )
