...
describe('components/analytics/doughnut_chart.tsx', () => {
  test('should match snapshot, on loading', () => {
    const wrapper = shallow(<DoughnutChart title="Test" height={400} width={600} />)
  ...
  test('should match snapshot, loaded without data', () => {
    ...
    const wrapper = mount(<DoughnutChart title="Test" height={400} width={600} data={data} />)
  ...
  test('should create and destroy the chart on mount and unmount with data', () => {
    ...
    const wrapper = mount<DoughnutChart>(<DoughnutChart title="Test" height={400} width={600} data={data} />)
  ...
  test('should update the chart on data change', () => {
    ...
    const wrapper = mount<DoughnutChart>(<DoughnutChart title="Test" height={400} width={600} data={oldData} />)
