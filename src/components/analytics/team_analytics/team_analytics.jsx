    ...
    if (stats[StatTypes.TOTAL_POSTS] === -1) {
      ...
      userActiveGraph = (
        <div className="row">
          <LineChart
            key={this.state.team.id}
            title={<FormattedMessage id="analytics.team.activeUsers" defaultMessage="Active Users With Posts" />}
      ...
      <div className="wrapper--fixed team_statistics">
        ...
        <div className="admin-console__wrapper">
          <div className="admin-console__content">
            ...
            <div className="row">
              <StatisticCount
                title={<FormattedMessage id="analytics.team.totalUsers" defaultMessage="Total Active Users" />}
                icon="fa-users"
            ...
            <div className="row">
              <TableChart
                title={<FormattedMessage id="analytics.team.recentUsers" defaultMessage="Recent Active Users" />}
                data={recentActiveUsers}
              />
              <TableChart
                title={<FormattedMessage id="analytics.team.newlyCreated" defaultMessage="Newly Created Users" />}
