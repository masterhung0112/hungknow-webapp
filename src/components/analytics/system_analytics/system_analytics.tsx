  ...
  public render() {
    ...
    if (skippedIntensiveQueries) {
      ...
      botPostTotalGraph = (
        <div className="row">
          <LineChart
            title={<FormattedMessage id="analytics.system.totalBotPosts" defaultMessage="Total Posts from Bots" />}
      ...
      activeUserGraph = (
        <div className="row">
          <LineChart
            title={<FormattedMessage id="analytics.system.activeUsers" defaultMessage="Active Users With Posts" />}
    ...
    if (this.props.isLicensed) {
      ...
      incomingCount = (
        <StatisticCount
          id="incomingWebhooks"
          title={<FormattedMessage id="analytics.system.totalIncomingWebhooks" defaultMessage="Incoming Webhooks" />}
          icon="fa-arrow-down"
      ...
      outgoingCount = (
        <StatisticCount
          id="outgoingWebhooks"
          title={<FormattedMessage id="analytics.system.totalOutgoingWebhooks" defaultMessage="Outgoing Webhooks" />}
          icon="fa-arrow-up"
      ...
      advancedStats = (
        <div>
          <StatisticCount
            id="websocketConns"
            title={<FormattedMessage id="analytics.system.totalWebsockets" defaultMessage="WebSocket Conns" />}
            icon="fa-user"
            count={this.getStatValue(stats[StatTypes.TOTAL_WEBSOCKET_CONNECTIONS])}
          />
          <StatisticCount
            id="masterDbConns"
            title={<FormattedMessage id="analytics.system.totalMasterDbConnections" defaultMessage="Master DB Conns" />}
            icon="fa-terminal"
            count={this.getStatValue(stats[StatTypes.TOTAL_MASTER_DB_CONNECTIONS])}
          />
          <StatisticCount
            id="replicaDbConns"
            title={<FormattedMessage id="analytics.system.totalReadDbConnections" defaultMessage="Replica DB Conns" />}
            icon="fa-terminal"
      ...
      if (stats[StatTypes.TOTAL_POSTS] !== -1) {
        postTypeGraph = (
          <DoughnutChart
            title={<FormattedMessage id="analytics.system.postTypes" defaultMessage="Posts, Files and Hashtags" />}
            data={postTypeData}
            width={300}
            height={225}
          />
    ...
    const userCount = (
      <StatisticCount
        id="totalActiveUsers"
        title={<FormattedMessage id="analytics.system.totalUsers" defaultMessage="Total Active Users" />}
        icon="fa-user"
    ...
    const monthlyActiveUsers = (
      <StatisticCount
        ...
        title={<FormattedMessage id="analytics.system.monthlyActiveUsers" defaultMessage="Monthly Active Users" />}
        icon="fa-users"
    ...
    return (
      <div className="wrapper--fixed team_statistics">
        <FormattedAdminHeader id="analytics.system.title" defaultMessage="System Statistics" />
