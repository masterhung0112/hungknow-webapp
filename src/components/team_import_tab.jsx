...
class TeamImportTab extends React.PureComponent {
  ...
  render() {
    const uploadDocsLink = (
      ...
      >
        <FormattedMessage id="team_import_tab.importHelpDocsLink" defaultMessage="documentation" />
      </a>
    )
    ...
    const uploadExporterLink = (
      <a href="https://github.com/grundleborg/slack-advanced-exporter" target="_blank" rel="noopener noreferrer">
        <FormattedMessage id="team_import_tab.importHelpExporterLink" defaultMessage="Slack Advanced Exporter" />
      </a>
    )
    ...
    const importCliLink = (
      <a
        ...
        rel="noopener noreferrer"
      >
        <FormattedMessage id="team_import_tab.importHelpCliDocsLink" defaultMessage="CLI tool for Slack import" />
      </a>
    )
    ...
    switch (this.state.status) {
      ...
      case 'done':
        messageSection = (
          <p className="confirm-import alert alert-success">
            <SuccessIcon />
            <FormattedMessage id="team_import_tab.successful" defaultMessage=" Import successful: " />
            <a href={this.state.link} download="MattermostImportSummary.txt">
              <FormattedMessage id="team_import_tab.summary" defaultMessage="View Summary" />
            </a>
          </p>
        )
        break
      case 'fail':
        messageSection = (
          <p className="confirm-import alert alert-warning">
            <WarningIcon />
            <FormattedMessage id="team_import_tab.failure" defaultMessage=" Import failure: " />
            <a href={this.state.link} download="MattermostImportSummary.txt">
              <FormattedMessage id="team_import_tab.summary" defaultMessage="View Summary" />
            </a>
          </p>
