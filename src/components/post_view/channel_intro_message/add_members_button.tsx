...
const AddMembersButton: React.FC<AddMembersButtonProps> = ({
  ...
  return inviteUsers && !isPrivate ? lessThanMaxFreeUsers(setHeader, theme) : moreThanMaxFreeUsers(channel, setHeader)
}
        ...
        <div className="titleAndButton">
          ...
          >
            <FormattedMessage id="generic_icons.add" defaultMessage="Add Icon">
              {(title: string) => <i className="icon-email-plus-outline" title={title} />}
            </FormattedMessage>
            <FormattedMessage
  ...
  return (
    <div className="MoreThanMaxFreeUsersWrapper">
      <div className="MoreThanMaxFreeUsers">
        ...
        >
          <ToggleModalButton className="intro-links color--link" dialogType={modal} dialogProps={{ channel }}>
            <FormattedMessage id="generic_icons.add" defaultMessage="Add Icon">
              {(title: string) => <i className="icon-account-plus-outline" title={title} />}
            </FormattedMessage>
