...
export default class ShowMore extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    const { children, isAttachmentText, compactDisplay } = this.props
    ...
    if (isOverflow) {
      ...
      attachmentTextOverflow = (
        <div className="post-collapse">
          <div id="collapseGradient" className={collapseGradientClass} />
          <div className={collapseShowMoreClass}>
            <div className="post-collapse__show-more-line" />
            <button id="showMoreButton" className="post-collapse__show-more-button" onClick={this.toggleCollapse}>
