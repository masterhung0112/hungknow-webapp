...
const DATE_RANGES = [RelativeRanges.TODAY_TITLE_CASE, RelativeRanges.YESTERDAY_TITLE_CASE]
...
const DateSeparator: FC<Props> = ({ date }) => {
  return (
    <BasicSeparator>
      <Timestamp value={date} useTime={false} useSemanticOutput={false} ranges={DATE_RANGES} />
    </BasicSeparator>
  )
}
