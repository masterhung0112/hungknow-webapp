...
import { isMeMessage as checkIsMeMessage } from 'hkclient-ts/lib/utils/post_utils'
...
class Post extends React.PureComponent {
  ...
  render() {
    ...
    const hideProfilePicture =
      this.hasSameRoot(this.props) &&
      this.props.consecutivePostByUser &&
      !post.root_id &&
      this.props.replyCount === 0 &&
      !fromBot
    if (!hideProfilePicture) {
      profilePic = <PostProfilePicture compactDisplay={this.props.compactDisplay} post={post} userId={post.user_id} />
