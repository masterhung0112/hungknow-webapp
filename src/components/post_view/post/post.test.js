...
describe('Post', () => {
  ...
  describe('getClassName', () => {
    test('should not show cursor pointer normally', () => {
      ...
      expect(wrapper.instance().getClassName(baseProps.post, false, false, false, false, false)).not.toContain(
        'cursor--pointer'
      )
    })
    ...
    test('should show cursor pointer when alt is held', () => {
      ...
      expect(wrapper.instance().getClassName(baseProps.post, false, false, false, false, false)).toContain(
        'cursor--pointer'
      )
    })
