...
export default class Reaction extends React.PureComponent<Props, State> {
  ...
  handleClick = (): void => {
    ...
    if (!(this.props.canAddReaction && this.props.canRemoveReaction) || this.animating) {
      return
    }
      ...
      >
        ...
        >
          <span className="d-flex align-items-center">
            ...
            />
            <span ref={this.reactionCountRef} className="Reaction__count">
              <span className="Reaction__number">
                <span className="Reaction__number--display">{display}</span>
                <span className="Reaction__number--unreacted" onAnimationEnd={this.handleAnimationEnded}>
                  {unreacted}
                </span>
