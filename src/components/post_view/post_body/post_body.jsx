...
export default class PostBody extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.isFirstReply && parentPost && post.type !== Constants.PostTypes.EPHEMERAL) {
      comment = (
        <CommentedOn post={parentPost} parentPostUser={parentPostUser} onCommentClick={this.props.handleCommentClick} />
      )
    }
    ...
    if (
      ...
      fileAttachmentHolder = <FileAttachmentListContainer post={post} compactDisplay={this.props.compactDisplay} />
    }
    ...
    const messageWrapper = (
      <React.Fragment>
        ...
        <PostMessageView post={this.props.post} compactDisplay={this.props.compactDisplay} hasMention={true} />
      </React.Fragment>
    )
    ...
    if (this.props.post.state === Posts.POST_DELETED || hasPlugin) {
      ...
      messageWithAdditionalContent = (
        <PostBodyAdditionalContent post={this.props.post} isEmbedVisible={this.props.isEmbedVisible}>
          {messageWrapper}
    ...
    return (
      <div>
        ...
        >
          ...
          <ReactionList post={post} isReadOnly={this.props.isReadOnly} />
        </div>
      </div>
    )
  }
