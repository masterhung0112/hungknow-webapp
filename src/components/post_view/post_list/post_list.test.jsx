...
const actionsProp = {
  loadPostsAround: jest
    .fn()
    .mockImplementation(() => Promise.resolve({ atLatestMessage: true, atOldestmessage: true })),
...
describe('components/post_view/post_list', () => {
  it('snapshot for loading when there are no posts', () => {
    const wrapper = shallow(<PostList {...{ ...baseProps, postListIds: [] }} />)
    expect(wrapper).toMatchSnapshot()
  })

  it('snapshot with couple of posts', () => {
    const postIds = createFakePosIds(2)
    const wrapper = shallow(<PostList {...{ ...baseProps, postListIds: postIds }} />)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  it('Should call postsOnLoad', async () => {
    ...
    const wrapper = shallow(<PostList {...{ ...baseProps, postListIds: emptyPostList }} />)
  ...
  it('getOldestVisiblePostId and getLatestVisiblePostId should return based on postListIds', async () => {
    ...
    const wrapper = shallow(<PostList {...{ ...baseProps, postListIds: postIds, formattedPostIds }} />)
  ...
  it('Should call for permalink posts', async () => {
    ...
    const wrapper = shallow(<PostList {...{ ...baseProps, focusedPostId }} />)
  ...
  it('Should call for loadLatestPosts', async () => {
    const wrapper = shallow(<PostList {...{ ...baseProps, postListIds: [], isFirstLoad: false }} />)
  ...
  describe('markChannelAsReadAndViewed', () => {
    ...
    test('Should not call markChannelAsReadAndViewed as it is a permalink', async () => {
      const emptyPostList = []
      const focusedPostId = 'new'
      shallow(<PostList {...{ ...baseProps, postListIds: emptyPostList, focusedPostId }} />)
