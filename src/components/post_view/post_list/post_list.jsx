...
export default class PostList extends React.PureComponent {
  ...
  render() {
    if (!this.props.postListIds) {
      return <LoadingScreen position="absolute" key="loading" />
    }

    return (
      <div ref="postlist" className="post-list-holder-by-time" key={'postlist-' + this.props.channelId}>
        <div className="post-list__table">
          <div id="virtualizedPostListContent" ref="postListContent" className="post-list__content">
            <VirtPostList
