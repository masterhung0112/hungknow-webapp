...
export default class PostHeader extends React.PureComponent<Props> {
  render(): JSX.Element {
    ...
    let userProfile = <UserProfile userId={post.user_id} hasMention={true} />
    let indicator
    let colon
    ...
    if (fromWebhook) {
      if (post.props.override_username && this.props.enablePostUsernameOverride) {
        ...
        userProfile = <UserProfile userId={post.user_id} hideStatus={true} />
      }
      ...
      userProfile = <UserProfile userId={post.user_id} hideStatus={true} hasMention={true} />
