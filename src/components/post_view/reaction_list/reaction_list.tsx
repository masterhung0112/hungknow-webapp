...
import { isCustomEmoji } from 'hkclient-ts/lib/utils/emoji_utils'
...
export default class ReactionList extends React.PureComponent<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    if (this.props.enableEmojiPicker) {
      const addReactionTooltip = (
        <Tooltip id="addReactionTooltip">
          <FormattedMessage id="reaction_list.addReactionTooltip" defaultMessage="Add a reaction" />
        </Tooltip>
      )
      ...
      emojiPicker = (
        <span className="emoji-picker__container">
          ...
          >
            <OverlayTrigger placement="top" delayShow={Constants.OVERLAY_TIME_DELAY} overlay={addReactionTooltip}>
              <button
    ...
    return (
      <div aria-label={localizeMessage('reaction.container.ariaLabel', 'reactions')} className="post-reaction-list">
        {reactions}
