  ...
  .add('Multiple Cards', () => {
    const WrapperComponent = () => {
      return (
        <>
          <Card expanded={true}>
            <Card.Header>{'This is a regular header'}</Card.Header>
            <Card.Body>{'Hello this is card content!'}</Card.Body>
          </Card>
          <Card expanded={true} className={'console'}>
            <Card.Header>
              <TitleAndButtonCardHeader
                ...
                buttonText={
                  <FormattedMessage id="admin.data_retention.customPolicies.addPolicy" defaultMessage="Add policy" />
                }
                onClick={() => {}}
              />
            </Card.Header>
