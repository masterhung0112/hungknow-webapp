...
describe('components/permissions_gates', () => {
  ...
  describe('ChannelPermissionGate', () => {
    test('should match snapshot when user have permission', () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'channel_id'} teamId={'team_id'} permissions={['test_channel_permission']}>
    ...
    test('should match snapshot when user have at least on of the permissions', () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'team_id'} permissions={['test_team_permission', 'not_existing_permission']}>
            <p>{'Valid permission (shown)'}</p>
          </TeamPermissionGate>
        </Provider>
      )
    ...
    test("should match snapshot when user haven't permission", () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'channel_id'} teamId={'team_id'} permissions={['invalid_permission']}>
    ...
    test("should match snapshot when the channel doesn't exists", () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'invalid_id'} teamId={'team_id'} permissions={['test_channel_permission']}>
    ...
    test('should match snapshot when user have permission team wide', () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'channel_id'} teamId={'team_id'} permissions={['test_team_permission']}>
            <p>{'Valid permission (shown)'}</p>
          </ChannelPermissionGate>
        </Provider>
      )
    ...
    test('should match snapshot when user have permission system wide', () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'channel_id'} teamId={'team_id'} permissions={['test_system_permission']}>
            <p>{'Valid permission (shown)'}</p>
          </ChannelPermissionGate>
        </Provider>
      )
    ...
    test('should match snapshot when user have permissions in DM and GM', () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'channel_id'} teamId={''} permissions={['test_channel_permission']}>
            <p>{'Valid permission (shown)'}</p>
          </ChannelPermissionGate>
        </Provider>
      )
    ...
    test('should match snapshot when user does not have permissions in DM and GM', () => {
      const wrapper = mount(
        <Provider store={store}>
          <ChannelPermissionGate channelId={'channel_id'} teamId={''} permissions={['invalid_permission']}>
            <p>{'Invalid permission (not shown)'}</p>
          </ChannelPermissionGate>
        </Provider>
      )
