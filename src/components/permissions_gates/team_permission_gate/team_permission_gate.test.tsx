...
describe('components/permissions_gates', () => {
  ...
  describe('TeamPermissionGate', () => {
    test('should match snapshot when user have permission', () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'team_id'} permissions={['test_team_permission']}>
    ...
    test('should match snapshot when user have permission and use invert', () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'team_id'} permissions={['test_team_permission']} invert={true}>
    ...
    test('should match snapshot when user not have permission and use invert', () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'team_id'} permissions={['invalid_permission']} invert={true}>
    ...
    test("should match snapshot when user haven't permission", () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'team_id'} permissions={['invalid_permission']}>
    ...
    test("should match snapshot when the team doesn't exists", () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'invalid_id'} permissions={['test_team_permission']}>
    ...
    test('should match snapshot when user have permission system wide', () => {
      const wrapper = mount(
        <Provider store={store}>
          <TeamPermissionGate teamId={'team_id'} permissions={['test_system_permission']}>
            <p>{'Valid permission (shown)'}</p>
          </TeamPermissionGate>
        </Provider>
      )
