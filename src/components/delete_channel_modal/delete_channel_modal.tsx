    ...
    return (
      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="deleteChannelModalLabel">
            <FormattedMessage id="delete_channel.confirm" defaultMessage="Confirm ARCHIVE Channel" />
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          ...
          >
            <FormattedMessage id="delete_channel.del" defaultMessage="Archive" />
          </button>
        </Modal.Footer>
      </Modal>
    )
