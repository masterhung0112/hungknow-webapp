...
import { Channel, ChannelType } from 'hkclient-ts/lib/types/channels'
...
describe('components/delete_channel_modal', () => {
  ...
  test('should match state when onHide is called', () => {
    const wrapper = shallow<DeleteChannelModal>(<DeleteChannelModal {...baseProps} />)
  ...
  test('should have called actions.deleteChannel when handleDelete is called', () => {
    ...
    const wrapper = shallow<DeleteChannelModal>(<DeleteChannelModal {...props} />)
