  ...
  render() {
        ...
        previewImage = (
          <span className="sprite-preview">
            <img
              ...
              src={imgTrans}
              className={
                'emojisprite-preview emoji-category-' + emoji.category + '-' + emoji.batch + ' emoji-' + emoji.filename
              }
            />
          </span>
        )
      ...
      return (
        <div className="emoji-picker__preview">
          ...
          <div className="emoji-picker__preview-image-label-box">
            ...
            <span id="emojiPickerAliasesPreview" className="emoji-picker__preview-aliases">
              {':' + aliases.join(': :') + ':'}
            </span>
          </div>
        </div>
    ...
    return (
      <div className="emoji-picker__preview emoji-picker__preview-placeholder">
        <FormattedMessage id="emoji_picker.emojiPicker" defaultMessage="Emoji Picker" />
      </div>
    )
  }
}
