    ...
    return (
      <div ref={this.divRef}>
        <div className="emoji-picker-items__container">
          <div className="emoji-picker__category-header" id={`emojipickercat-${this.props.categoryName}`}>
            <FormattedMessage id={'emoji_picker.' + this.props.categoryName} />
          </div>
        </div>
        <div className="emoji-picker-items__container">{this.props.children}</div>
      </div>
    )
  }
}
