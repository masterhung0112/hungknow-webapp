...
export default class EmojiPickerTabs extends PureComponent {
  ...
  render() {
    ...
    if (this.props.enableGifPicker && typeof this.props.onGifClick != 'undefined') {
      return (
        <Tabs defaultActiveKey={1} id="emoji-picker-tabs" style={pickerStyle} className={pickerClass} justified={true}>
          <EmojiPickerHeader handleEmojiPickerClose={this.handleEmojiPickerClose} />
          <Tab eventKey={1} onEnter={this.handleEnterEmojiTab} onExit={this.handleExitEmojiTab} title={<EmojiIcon />}>
            <EmojiPicker
          ...
          <Tab eventKey={2} title={<GfycatIcon />} mountOnEnter={true} unmountOnExit={true}>
            <GifPicker
    ...
    return (
      <div id="emojiPicker" style={pickerStyle} className={`a11y__popup ${pickerClass} emoji-picker--single`}>
        <EmojiPickerHeader handleEmojiPickerClose={this.handleEmojiPickerClose} />
        <EmojiPicker
          style={this.props.style}
          onEmojiClose={this.props.onEmojiClose}
