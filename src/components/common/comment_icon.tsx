...
export default class CommentIcon extends React.PureComponent<Props> {
  ...
  public render(): JSX.Element {
    ...
    if (this.props.commentCount > 0) {
      ...
      commentCountSpan = <span className="post-menu__comment-count">{this.props.commentCount}</span>
    ...
    const tooltip = (
      <Tooltip id="comment-icon-tooltip" className="hidden-xs">
        <FormattedMessage id="post_info.comment_icon.tooltip.reply" defaultMessage="Reply" />
      </Tooltip>
    )
