        ...
        <div>
          <div className="signup-team__container terms-of-service__container">
            <div className={termsMarkdownClasses}>
              <div className="medium-center" data-testid="termsOfService">
                {messageHtmlToComponent(this.formattedText(this.state.customTermsOfServiceText), false, {
                  mentions: false,
                })}
              </div>
            </div>
            <div className="terms-of-service__footer medium-center">
              <ButtonGroup className="terms-of-service__button-group">
                ...
                >
                  ...
                  <FormattedMessage id="terms_of_service.agreeButton" defaultMessage={'I Agree'} />
                </Button>
                <Button
                  bsStyle={'link'}
                  disabled={this.state.loadingAgree || this.state.loadingDisagree}
                ...
                >
                  ...
                  <FormattedMessage id="terms_of_service.disagreeButton" defaultMessage={'I Disagree'} />
                </Button>
              </ButtonGroup>
