...
const RenewalLink: React.FC<RenewalLinkProps> = (props: RenewalLinkProps) => {
  ...
  return (
    <>
      <button className="annnouncementBar__renewLicense" onClick={(e) => handleLinkClick(e)}>
        <FormattedMessage id="announcement_bar.warn.renew_license_now" defaultMessage="Renew license now" />
      </button>
    </>
  )
}
