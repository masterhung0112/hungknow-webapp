...
import { CloudCustomer, Subscription } from 'hkclient-ts/lib/types/cloud'
  ...
  render() {
    ...
    return (
      <AnnouncementBar
        ...
        message={
          this.isMostRecentPaymentFailed()
            ? t('admin.billing.subscription.mostRecentPaymentFailed')
            : t('admin.billing.subscription.creditCardExpired')
        }
