...
import { WarnMetricStatus } from 'hkclient-ts/lib/types/config'
...
export default class AnnouncementBar extends React.PureComponent<Props> {
  ...
  render() {
    ...
    if (this.props.showCloseButton) {
      closeButton = (
        <a href="#" className="announcement-bar__close" style={linkStyle} onClick={this.handleClose}>
          {'×'}
        </a>
      )
    }
    ...
    const announcementTooltip = (
      <Tooltip id="announcement-bar__tooltip">{this.props.tooltipMsg ? this.props.tooltipMsg : message}</Tooltip>
    )

    return (
      <div className={barClass} style={barStyle}>
        <OverlayTrigger delayShow={Constants.OVERLAY_TIME_DELAY} placement="bottom" overlay={announcementTooltip}>
          <span>
            ...
            {!this.props.showLinkAsButton && (
              <span className="announcement-bar__link">
                {this.props.showModal && (
                  <FormattedMessage id={this.props.modalButtonText} defaultMessage={this.props.modalButtonDefaultText}>
                    {(linkmessage) => (
            ...
            {this.props.showLinkAsButton && (
              <button className="upgrade-button" onClick={this.props.onButtonClick}>
                <FormattedMessage id={this.props.modalButtonText} defaultMessage={this.props.modalButtonDefaultText} />
              </button>
            )}
          </span>
