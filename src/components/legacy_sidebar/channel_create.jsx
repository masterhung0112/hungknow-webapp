...
export default class ChannelCreate extends React.PureComponent {
  ...
  renderPublic = () => {
    ...
    const tooltip = (
      <Tooltip id="new-channel-tooltip">
        <FormattedMessage id="sidebar.createChannel" defaultMessage="Create a public channel" />
      </Tooltip>
    )
  ...
  renderPrivate = () => {
    ...
    const tooltip = (
      <Tooltip id="new-group-tooltip">
        <FormattedMessage id="sidebar.createGroup" defaultMessage="Create a private channel" />
      </Tooltip>
    )
  ...
  renderDirect = () => {
    ...
    const tooltip = (
      <Tooltip id="new-group-tooltip" className="hidden-xs">
        <FormattedMessage id="sidebar.createDirectMessage" defaultMessage="Write a direct message" />
      </Tooltip>
    )
    ...
    return (
      ...
      >
        <OverlayTrigger className="hidden-xs" delayShow={500} placement="top" overlay={tooltip}>
          <span>{'+'}</span>
        </OverlayTrigger>
      </button>
    )
  ...
  renderCombined = () => {
    ...
    const tooltip = (
      <Tooltip id="new-group-tooltip" className="hidden-xs">
        <FormattedMessage id="sidebar.createPublicPrivateChannel" defaultMessage="Create a public or private channel" />
      </Tooltip>
    )
