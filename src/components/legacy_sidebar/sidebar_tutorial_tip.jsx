...
export default class SidebarTutorialTip extends React.PureComponent {
  ...
  render = () => {
    ...
    screens.push(
      <div>
        <h4>
          <FormattedMessage id="sidebar.tutorialScreen1.title" defaultMessage="Channels" />
        </h4>
        <p>
    ...
    screens.push(
      <div>
        <h4>
          <FormattedMessage id="sidebar.tutorialScreen3.title" defaultMessage="Creating and Joining Channels" />
        </h4>
        <p>
          <FormattedMarkdownMessage
