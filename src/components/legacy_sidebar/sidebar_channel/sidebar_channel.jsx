...
class SidebarChannel extends React.PureComponent {
  ...
  render = () => {
    ...
    if (this.props.channelFake) {
      link = `/${this.props.currentTeamName}/channels/${this.props.channelName}?fakechannel=${encodeURIComponent(
        this.props.channelStringified
      )}`
    ...
    return (
      <li key={this.props.channelName} ref={'channel'} className={linkClass}>
