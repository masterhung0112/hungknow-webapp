...
class ChannelMore extends React.PureComponent {
  ...
  render() {
    const { sectionType, moreDirectMessages, browsePublicDirectChannels, viewArchivedChannels } = this.props
    ...
    switch (sectionType) {
      case 'public':
        return (
          <TeamPermissionGate teamId={this.props.currentTeamId} permissions={[Permissions.JOIN_PUBLIC_CHANNELS]}>
            <li key="public-channel-more" data-testid="morePublicButton">
              <button
              ...
              <li key="public-channel-more" data-testid="morePublicButton">
                <button
                  ...
                  aria-label={formatMessage({
                    id: 'sidebar.morePublicAria',
                    defaultMessage: 'See more public channels',
                  })}
                  className="nav-more cursor--pointer style--none btn--block"
        ...
        return (
          <li key="public-dm-more" id="moreRecentAlphaButton">
            <button
              ...
              aria-label={formatMessage({
                id: 'sidebar.morePublicDmAria',
                defaultMessage: 'See more public channels direct messages',
              })}
              className="nav-more cursor--pointer style--none btn--block"
