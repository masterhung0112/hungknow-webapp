      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="morePublicModalLabel">
            <FormattedMessage id="more_public_direct_channels.title" defaultMessage="Channels and Direct Messages" />
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Tabs
            ...
            unmountOnExit={true}
          >
            <Tab eventKey="channels" title={localizeMessage('more_public_direct_channels.channels', 'Channels')}>
              <MorePublicChannels
            ...
            >
              <MoreDirectMessages onModalDismissed={this.handleHide} isExistingChannel={false} bodyOnly={true} />
            </Tab>
          </Tabs>
        </Modal.Body>
      </Modal>
