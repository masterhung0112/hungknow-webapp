  ...
  render() {
    ...
    if (this.props.channelIsArchived) {
      ...
      if (this.props.teammateId && this.props.teammateDeletedAt) {
        ...
        if (this.props.botIconUrl && this.props.botIconUrl !== this.state.svgErrorUrl) {
          icon = (
            <span className="icon icon__bot">
              <Svg src={this.props.botIconUrl} onLoad={this.onSvgLoad} onError={this.onSvgLoadError} />
            </span>
          )
        }
      } else {
        icon = <StatusIcon type="avatar" status={this.props.channelStatus} />
      }
    }
    return icon
  }
