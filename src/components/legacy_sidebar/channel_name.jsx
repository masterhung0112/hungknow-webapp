...
export default class ChannelName extends React.PureComponent {
  ...
  render() {
    ...
    let name = <FormattedMessage id={formattedMessageId} defaultMessage={channelName} />
    ...
    if (clickableChannelHeader.indexOf(sectionType) !== -1) {
      ...
      name = (
        ...
        >
          <div role="presentation" className="public_direct_name" onClick={browsePublicDirectChannels}>
            {name}
          </div>
        </OverlayTrigger>
      )
