...
export default class SidebarHeaderDropdownButton extends React.PureComponent {
  ...
  render() {
    ...
    let teamNameWithToolTip = (
      <h1 id="headerTeamName" className="team__name" data-teamid={this.props.teamId}>
    ...
    return (
      <div className="SidebarHeaderDropdownButton" id="sidebarHeaderDropdownButton">
        {tutorialTip}
        <div id="headerInfo" className="header__info">
          {teamNameWithToolTip}
          <div id="headerInfoContent" className="header__info__content">
