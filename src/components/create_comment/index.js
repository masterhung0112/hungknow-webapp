...
import {
  getAllChannelStats,
  getChannelMemberCountsByGroup as selectChannelMemberCountsByGroup,
} from 'hkclient-ts/lib/selectors/entities/channels'
import { makeGetMessageInHistoryItem } from 'hkclient-ts/lib/selectors/entities/posts'
import { resetCreatePostRequest, resetHistoryIndex } from 'hkclient-ts/lib/actions/posts'
import { getChannelTimezones, getChannelMemberCountsByGroup } from 'hkclient-ts/lib/actions/channels'
import { Permissions, Preferences, Posts } from 'hkclient-ts/lib/constants'
import { getAssociatedGroupsForReferenceByMention } from 'hkclient-ts/lib/selectors/entities/groups'
...
function makeMapStateToProps() {
  ...
  return (state, ownProps) => {
    ...
    const channelMembersCount = getAllChannelStats(state)[ownProps.channelId]
    ...
    const groupsWithAllowReference = useGroupMentions
      ? getAssociatedGroupsForReferenceByMention(state, channel.team_id, channel.id)
      : null
