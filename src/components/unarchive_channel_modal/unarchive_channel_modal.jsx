    ...
    return (
      ...
      >
        <Modal.Header closeButton={true}>
          <Modal.Title componentClass="h1" id="unarchiveChannelModalLabel">
            <FormattedMessage id="unarchive_channel.confirm" defaultMessage="Confirm UNARCHIVE Channel" />
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <button type="button" className="btn btn-link" onClick={this.onHide}>
            <FormattedMessage id="unarchive_channel.cancel" defaultMessage="Cancel" />
          </button>
          <button
            type="button"
          ...
          >
            <FormattedMessage id="unarchive_channel.del" defaultMessage="Unarchive" />
          </button>
        </Modal.Footer>
      </Modal>
    )
