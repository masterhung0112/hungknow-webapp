...
export default class TextboxLinks extends React.PureComponent<Props> {
  ...
  render() {
    ...
    if (isMarkdownPreviewEnabled) {
      previewLink = (
        <button id="previewLink" onClick={this.togglePreview} className="style--none textbox-preview-link color--link">
          {this.props.showPreview ? editHeader : <FormattedMessage id="textbox.preview" defaultMessage="Preview" />}
        </button>
      )
    }
    ...
    const helpText = (
      ...
      >
        ...
        <i>
          <FormattedMessage id="textbox.italic" defaultMessage="*italic*" />
        </i>
        <span>
          {'~~'}
          <s>
    ...
    return (
      <div className={'help__text ' + helpTextClass}>
        {helpText}
        {previewLink}
        <Link target="_blank" rel="noopener noreferrer" to="/help/messaging" className="textbox-help-link">
