  ...
  render() {
    ...
    const tooltip = (
      <Tooltip id="userGuideHelpTooltip" className="hidden-xs">
        <FormattedMessage id={'channel_header.userHelpGuide'} defaultMessage="Help" />
      </Tooltip>
    )

    return (
      <MenuWrapper className="userGuideHelp" onToggle={this.buttonToggleState}>
        <OverlayTrigger delayShow={500} placement="bottom" overlay={this.state.buttonActive ? <></> : tooltip}>
          <button
