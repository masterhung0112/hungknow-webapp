  ...
  public render(): JSX.Element {
    ...
    for (let i = 0; i < postsLength; i++) {
      ...
      if (currentPostDay.toDateString() !== previousPostDay.toDateString()) {
        ...
        commentsLists.push(<DateSeparator key={currentPostDay.toString()} date={currentPostDay} />)
      }
    ...
    if (!isFakeDeletedPost) {
      if (channelIsArchived) {
        ...
        createComment = (
          <div className="post-create__container" ref={this.postCreateContainerRef}>
            <CreateComment
    ...
    return (
      <div id="rhsContainer" className="sidebar-right__body" ref={this.containerRef}>
        <FloatingTimestamp
        ...
        >
          <div className="post-right__scroll">
            ...
            >
              ...
              <div ref={this.rhspostlistRef} className="post-right-comments-container" id="rhsPostList">
                {commentsLists}
              </div>
            </div>
            {createComment}
