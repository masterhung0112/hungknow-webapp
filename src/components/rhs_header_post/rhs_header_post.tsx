  ...
  render() {
    ...
    const closeSidebarTooltip = (
      <Tooltip id="closeSidebarTooltip">
        <FormattedMessage id="rhs_header.closeSidebarTooltip" defaultMessage="Close" />
      </Tooltip>
    )
    ...
    switch (this.props.previousRhsState) {
      ...
      case RHSStates.FLAG:
        backToResultsTooltip = (
          <Tooltip id="backToResultsTooltip">
            <FormattedMessage id="rhs_header.backToFlaggedTooltip" defaultMessage="Back to saved posts" />
          </Tooltip>
        )
        break
      case RHSStates.PIN:
    ...
    const shrinkSidebarTooltip = (
      <Tooltip id="shrinkSidebarTooltip">
        <FormattedMessage id="rhs_header.collapseSidebarTooltip" defaultMessage="Collapse Sidebar" />
      </Tooltip>
    )
    ...
    if (backToResultsTooltip) {
      back = (
        <OverlayTrigger delayShow={Constants.OVERLAY_TIME_DELAY} placement="top" overlay={backToResultsTooltip}>
          <a href="#" onClick={this.handleBack} className="sidebar--right__back">
            <FormattedMessage id="generic_icons.back" defaultMessage="Back Icon">
              {(ariaLabel: string) => <i className="icon icon-arrow-back-ios" aria-label={ariaLabel} />}
            </FormattedMessage>
          </a>
        </OverlayTrigger>
      )
    ...
    return (
      <div className="sidebar--right__header">
        <span className="sidebar--right__title">
          {back}
          <FormattedMessage id="rhs_header.details" defaultMessage="Thread" />
          {channelName && (
            <button onClick={this.handleJumpClick} className="style--none sidebar--right__title__channel">
              {channelName}
            </button>
          )}
        </span>
        <div className="pull-right">
          ...
          >
            ...
            >
              <FormattedMessage id="rhs_header.expandSidebarTooltip.icon" defaultMessage="Expand Sidebar Icon">
                {(ariaLabel: string) => <i className="icon icon-arrow-expand" aria-label={ariaLabel} />}
              </FormattedMessage>
              <FormattedMessage id="rhs_header.collapseSidebarTooltip.icon" defaultMessage="Collapse Sidebar Icon">
                {(ariaLabel: string) => <i className="icon icon-arrow-collapse" aria-label={ariaLabel} />}
              </FormattedMessage>
            </button>
          </OverlayTrigger>
          ...
          <OverlayTrigger delayShow={Constants.OVERLAY_TIME_DELAY} placement="top" overlay={closeSidebarTooltip}>
            ...
            >
              <FormattedMessage id="rhs_header.closeTooltip.icon" defaultMessage="Close Sidebar Icon">
                {(ariaLabel: string) => <i className="icon icon-close" aria-label={ariaLabel} />}
              </FormattedMessage>
            </button>
          </OverlayTrigger>
        </div>
