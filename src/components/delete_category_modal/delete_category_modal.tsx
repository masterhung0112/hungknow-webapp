  ...
  render() {
    return (
      <GenericModal
        ...
        modalHeaderText={
          <FormattedMessage id="delete_category_modal.deleteCategory" defaultMessage="Delete this category?" />
        }
        handleConfirm={this.handleConfirm}
        confirmButtonText={<FormattedMessage id="delete_category_modal.delete" defaultMessage="Delete" />}
