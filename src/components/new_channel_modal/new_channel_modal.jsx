  ...
  render() {
      ...
      serverError = (
        <div className="form-group has-error">
          <div className="col-sm-12">
            <p id="createChannelError" className="input__help error">
    ...
    const publicChannelDesc = (
      <div className="flex-parent">
        ...
        <FormattedMessage id="channel_modal.publicName" defaultMessage="Public" />
        <FormattedMessage id="channel_modal.publicHint" defaultMessage=" - Anyone can join this channel" />
      </div>
    )
    ...
    const privateChannelDesc = (
      <div className="flex-parent">
        ...
        <FormattedMessage id="channel_modal.privateName" defaultMessage="Private" />
        <FormattedMessage
      ...
      <span>
        ...
        >
          <Modal.Header>
            ...
            <Modal.Title componentClass="h1" id="newChannelModalLabel">
          ...
          <form role="form" className="form-horizontal">
            <Modal.Body>
              <div className="form-group">
                <label className="col-sm-3 form__label control-label" id="channelModalTypeLabel">
                  <FormattedMessage id="channel_modal.type" defaultMessage="Type" />
                </label>
                <div className="col-sm-9">{typeOptions}</div>
              </div>
              <div className={displayNameClass}>
                <label className="col-sm-3 form__label control-label" htmlFor="newChannelName">
                ...
                <div className="col-sm-9">
                  ...
                  <p className="input__help dark">
                    ...
                    <button className="color--link style--none" onClick={this.handleOnURLChange}>
              ...
              <div className="form-group">
                <div className="col-sm-3">
                  <label className="form__label control-label" htmlFor="newChannelPurpose">
              ...
              <div className="form-group less">
                <div className="col-sm-3">
                  <label className="form__label control-label" htmlFor="newChannelHeader">
            ...
            <Modal.Footer>
              ...
              <button id="submitNewChannel" onClick={this.handleSubmit} type="submit" className="btn btn-primary">
                <FormattedMessage id="channel_modal.createNew" defaultMessage="Create Channel" />
              </button>
            </Modal.Footer>
          </form>
        </Modal>
