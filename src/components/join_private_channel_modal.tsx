...
function JoinPrivateChannelModal({ channelName, onCancel, onHide, onJoin }: Props) {
  ...
  return (
    <ConfirmModal
      show={show}
      title={<FormattedMessage id="permalink.show_dialog_warn.title" defaultMessage="Join private channel" />}
      message={
        <FormattedMessage
      ...
      confirmButtonText={<FormattedMessage id="permalink.show_dialog_warn.join" defaultMessage="Join" />}
