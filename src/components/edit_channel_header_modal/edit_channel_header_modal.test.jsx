...
describe('components/EditChannelHeaderModal', () => {
  ...
  test('should match snapshot, init', () => {
    const wrapper = shallowWithIntl(<EditChannelHeaderModal {...baseProps} />)
  ...
  test('edit direct message channel', () => {
    ...
    const wrapper = shallowWithIntl(<EditChannelHeaderModal {...baseProps} channel={dmChannel} />)
  ...
  test('patch on enter keypress event with ctrl', () => {
    const wrapper = shallowWithIntl(<EditChannelHeaderModal {...baseProps} ctrlSend={true} />)
