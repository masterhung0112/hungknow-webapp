...
describe('components/search_bar/SearchBar', () => {
  ...
  it('should match snapshot without search', () => {
    const wrapper = shallow(wrapIntl(<SearchBar {...baseProps} />))
    expect(wrapper).toMatchSnapshot()
  })

  it('should match snapshot without search on focus', () => {
    const wrapper = shallow(wrapIntl(<SearchBar {...baseProps} isFocussed={true} />))
    expect(wrapper).toMatchSnapshot()
  })
  ...
  it('should match snapshot with search', () => {
    const wrapper = shallow(wrapIntl(<SearchBar {...baseProps} searchTerms={'test'} />))
    expect(wrapper).toMatchSnapshot()
  })
})
