...
class CreatePost extends React.PureComponent {
  ...
  handleSubmit = async (e) => {
    ...
    if (notificationsToChannel && currentChannelMembersCount > Constants.NOTIFY_ALL_MEMBERS && !notContainsAtChannel) {
  ...
  createTutorialTip() {
    ...
    screens.push(
      <div>
        <h4>
          <FormattedMessage id="create_post.tutorialTip.title" defaultMessage="Sending Messages" />
        </h4>
        <p>
  ...
  render() {
    const { currentChannel, draft, fullWidthTextBox, showTutorialTip, canPost } = this.props
        ...
        >
          <div className="post-create-body">
            ...
            >
              ...
              />
              <span ref={this.createPostControlsRef} className="post-body__actions">
                {callButton}
                {fileUpload}
                {emojiPicker}
                <a
