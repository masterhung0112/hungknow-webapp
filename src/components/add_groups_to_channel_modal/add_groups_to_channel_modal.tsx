...
import { Group, SyncablePatch } from 'hkclient-ts/lib/types/groups'
...
export type Props = {
  ...
  actions: {
    getGroupsNotAssociatedToChannel: (
      ...
      page?: number | null,
      perPage?: number | null,
      filterParentTeamPermitted?: boolean
    ) => Promise<ActionFunc>
    ...
    ) => Promise<{ error?: ServerError; data?: null }>
        ...
        <Modal.Header closeButton={true}>
          <Modal.Title>
            <FormattedMessage
              ...
              values={{
                channelName: <strong>{this.props.currentChannelName}</strong>,
              }}
            />
          </Modal.Title>
        </Modal.Header>
