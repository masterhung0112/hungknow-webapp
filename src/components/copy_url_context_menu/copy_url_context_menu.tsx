    ...
    const contextMenu = (
      <ContextMenu id={'copy-url-context-menu' + this.props.menuId}>
        <MenuItem onClick={this.copy}>
          <FormattedMessage id="copy_url_context_menu.getChannelLink" defaultMessage="Copy Link" />
        </MenuItem>
      </ContextMenu>
    )

    const contextMenuTrigger = (
      <ContextMenuTrigger id={'copy-url-context-menu' + this.props.menuId} holdToDisplay={-1}>
        {this.props.children}
      </ContextMenuTrigger>
    )
