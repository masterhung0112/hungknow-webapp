...
describe('components/MoreChannels', () => {
  ...
  test('should match snapshot and state', () => {
    const wrapper: ShallowWrapper<any, any, MoreChannels> = shallow(<MoreChannels {...baseProps} />)
  ...
  test('should attempt to join the channel and fail', (done) => {
    ...
    const wrapper: ShallowWrapper<any, any, MoreChannels> = shallow(<MoreChannels {...props} />)
    ...
    expect(wrapper.instance().props.actions.joinChannel).toHaveBeenCalledWith(
