  ...
  createScreenOne() {
    ...
    return (
      <div id="tutorialIntroOne">
        <h3>
          <FormattedMessage id="tutorial_intro.screenOne.title1" defaultMessage="Welcome to:" />
        </h3>
        <h1>
          <FormattedMessage id="tutorial_intro.screenOne.title2" defaultMessage="Mattermost" />
        </h1>
        <p>
          <FormattedMessage
  ...
  createScreenTwo() {
    ...
    if (this.props.appDownloadLink) {
      ...
      appDownloadLink = (
        <FormattedMessage
          ...
          values={{
            link: (
              <a id="appDownloadLink" href={link} target="_blank" rel="noopener noreferrer">
                <FormattedMessage id="tutorial_intro.mobileAppsLinkText" defaultMessage="PC, Mac, iOS and Android" />
              </a>
            ),
          }}
        />
      ...
      appDownloadImage = (
        <a id="appDownloadImage" href={link} target="_blank" rel="noopener noreferrer">
          <img alt={'tutorial icons'} className="tutorial__app-icons" src={AppIcons} />
        </a>
      )
    }
    ...
    return (
      <div id="tutorialIntroTwo">
        <h3>
          <FormattedMessage id="tutorial_intro.screenTwo.title" defaultMessage="How Mattermost Works:" />
        </h3>
        <p>
          <FormattedMessage
  ...
  createScreenThree() {
    ...
    if (!this.props.isLicensed || !this.props.restrictTeamInvite) {
      inviteModalLink = (
        ...
        >
          <FormattedMessage id="tutorial_intro.invite" defaultMessage="Invite Teammates" />
        </ModalToggleButtonRedux>
      )
      ...
      inviteText = (
        <p>
          {inviteModalLink}
          <FormattedMessage id="tutorial_intro.whenReady" defaultMessage={" when you're ready."} />
        </p>
      )
    }
    ...
    if (this.props.supportEmail) {
      supportInfo = (
        <p id="supportInfo">
          <FormattedMessage id="tutorial_intro.support" defaultMessage="Need anything, just email us at " />
          <a href={'mailto:' + this.props.supportEmail} target="_blank" rel="noopener noreferrer">
    ...
    return (
      <div id="tutorialIntroThree">
        <h3>
          <FormattedMessage id="tutorial_intro.allSet" defaultMessage={"You're all set"} />
        </h3>
        {inviteText}
        {supportInfo}
        <FormattedMessage
        ...
        <div id="tutorialIntroContent" className="tutorial__content">
          <div className="tutorial__steps">
            ...
            <div className="tutorial__footer">
              <button id="tutorialNextButton" className="btn btn-primary" onClick={this.handleNext}>
                <FormattedMessage id="tutorial_intro.next" defaultMessage="Next" />
              </button>
              <a id="tutorialSkipLink" className="tutorial-skip" href="#" onClick={this.skipTutorial}>
                <FormattedMessage id="tutorial_intro.skip" defaultMessage="Skip Tutorial" />
              </a>
            </div>
          </div>
        </div>
