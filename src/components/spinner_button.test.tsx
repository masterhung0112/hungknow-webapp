...
describe('components/SpinnerButton', () => {
  ...
  test('should handle onClick', () => {
    ...
    const wrapper = mount(<SpinnerButton spinning={false} onClick={onClick} spinningText="Test" />)
  ...
  test('should add properties to underlying button', () => {
    const wrapper = mount(<SpinnerButton id="my-button-id" className="btn btn-success" spinningText="Test" />)
