...
describe('components/HeaderFooterTemplate', () => {
  ...
  test('should match snapshot with help link', () => {
    const wrapper = shallow(<NotLoggedIn config={{ HelpLink: 'http://testhelplink' }} />)
    expect(wrapper).toMatchSnapshot()
  })

  test('should match snapshot with term of service link', () => {
    const wrapper = shallow(<NotLoggedIn config={{ TermsOfServiceLink: 'http://testtermsofservicelink' }} />)
    expect(wrapper).toMatchSnapshot()
  })

  test('should match snapshot with privacy policy link', () => {
    const wrapper = shallow(<NotLoggedIn config={{ PrivacyPolicyLink: 'http://testprivacypolicylink' }} />)
    expect(wrapper).toMatchSnapshot()
  })

  test('should match snapshot with about link', () => {
    const wrapper = shallow(<NotLoggedIn config={{ AboutLink: 'http://testaboutlink' }} />)
    expect(wrapper).toMatchSnapshot()
  })
