  ...
  render() {
    ...
    if (this.props.loading && channels.length === 0) {
      ...
      listContent = (
        <div className="no-channel-message">
          <p className="primary-message">
            <FormattedMessage id="more_channels.noMore" defaultMessage="No more channels to join" />
          </p>
      ...
      if (this.state.page > 0) {
        previousButton = (
          <button className="btn btn-link filter-control filter-control__prev" onClick={this.previousPage}>
            ...
            <a>
              <span>
                {this.props.shouldShowArchivedChannels
                  ? localizeMessage('more_channels.show_archived_channels', 'Show: Archived Channels')
                  : localizeMessage('more_channels.show_public_channels', 'Show: Public Channels')}
              </span>
