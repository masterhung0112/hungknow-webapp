...
function ThreadFooter({
  ...
  lastReplyAt,
  isFollowing,
  actions: { follow, unFollow, openThread },
}: Props) {
  return (
    <div className="ThreadFooter">
      ...
      <Avatars users={participants} totalUsers={totalParticipants} size="sm" />
      ...
      <FollowButton isFollowing={isFollowing} follow={follow} unFollow={unFollow} />

      {Boolean(lastReplyAt) && (
        <Timestamp value={lastReplyAt} useTime={false} units={THREADING_TIME}>
          {({ formatted }) => (
