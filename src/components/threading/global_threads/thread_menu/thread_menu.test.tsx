...
describe('components/threading/common/thread_menu', () => {
  ...
  test('should match snapshot', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} />)
  ...
  test('should allow following', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} isFollowing={false} />)
    wrapper.find('button').simulate('click')
  ...
  test('should allow unfollowing', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} isFollowing={true} />)
    wrapper.find('button').simulate('click')
  ...
  test('should allow marking as read', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} hasUnreads={true} />)
    wrapper.find('button').simulate('click')
  ...
  test('should allow marking as unread', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} hasUnreads={false} />)
    wrapper.find('button').simulate('click')
  ...
  test('should allow saving', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} isSaved={false} />)
    wrapper.find('button').simulate('click')
  ...
  test('should allow unsaving', () => {
    const wrapper = mountWithIntl(<ThreadMenu {...props} isSaved={true} />)
    wrapper.find('button').simulate('click')
