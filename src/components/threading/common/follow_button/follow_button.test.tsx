...
describe('components/threading/common/follow_button', () => {
  test('should say follow and fire start action', () => {
    ...
    const wrapper = mountWithIntl(<FollowButton isFollowing={false} follow={follow} unFollow={stop} />)
  ...
  test('should say following and fire stop action', () => {
    ...
    const wrapper = mountWithIntl(<FollowButton isFollowing={true} follow={follow} unFollow={unFollow} />)
