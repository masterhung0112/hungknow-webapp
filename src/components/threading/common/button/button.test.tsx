...
describe('components/threading/common/button', () => {
  ...
  test('should support className', () => {
    ...
    const wrapper = shallow<typeof Button>(<Button className={className} />)
  ...
  test('should support prepended content', () => {
    const wrapper = shallow<typeof Button>(<Button prepend={<ReplyIcon className="Icon" />} />)
  ...
  test('should support appended content', () => {
    const wrapper = shallow<typeof Button>(<Button append={<ReplyIcon className="Icon" />} />)
  ...
  test('should support children', () => {
    const wrapper = shallow<typeof Button>(<Button>{'text-goes-here'}</Button>)
