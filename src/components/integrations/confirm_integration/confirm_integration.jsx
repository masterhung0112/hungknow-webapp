...
export default class ConfirmIntegration extends React.PureComponent {
  ...
  render() {
    ...
    if (this.state.type === Constants.Integrations.COMMAND && command) {
      ...
      headerText = <FormattedMessage id={'installed_commands.header'} defaultMessage="Slash Commands" />
      helpText = (
        <p>
      ...
      headerText = <FormattedMessage id={'installed_incoming_webhooks.header'} defaultMessage="Incoming Webhooks" />
      helpText = (
        <p>
          <FormattedMarkdownMessage
      ...
      headerText = <FormattedMessage id={'installed_outgoing_webhooks.header'} defaultMessage="Outgoing Webhooks" />
      helpText = (
        <p>
          <FormattedMarkdownMessage
      ...
      headerText = <FormattedMessage id={'installed_oauth_apps.header'} defaultMessage="OAuth 2.0 Applications" />
      ...
      helpText.push(
        <p key="add_oauth_app.clientId">
          ...
          />
          <CopyText idMessage="integrations.copy_client_id" defaultMessage="Copy Client Id" value={oauthAppToken} />
          <br />
          <FormattedMarkdownMessage
      ...
      helpText.push(
        <p key="add_oauth_app.doneUrlHelp">
          <FormattedMessage id="add_oauth_app.doneUrlHelp" defaultMessage="Here are your authorized redirect URLs." />
        </p>
      )
      ...
      headerText = <FormattedMessage id="bots.manage.header" defaultMessage="Bot Accounts" />
      helpText = (
        <p>
          <FormattedMarkdownMessage
    ...
    return (
      <div className="backstage-content row">
        <BackstageHeader>
          <Link to={'/' + this.props.team.name + '/integrations/' + this.state.type}>{headerText}</Link>
        ...
        <div className="backstage-form backstage-form__confirmation">
          <h4 className="backstage-form__title" id="formTitle">
            <FormattedMessage id="integrations.successful" defaultMessage="Setup Successful" />
          </h4>
          {helpText}
          {tokenText}
          <div className="backstage-form__footer">
            <Link
              ...
              id="doneButton"
            >
              <FormattedMessage id="integrations.done" defaultMessage="Done" />
            </Link>
          </div>
        </div>
      </div>
