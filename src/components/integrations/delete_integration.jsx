...
export default class DeleteIntegration extends DeleteModalTrigger {
  get triggerTitle() {
    return <FormattedMessage id="installed_integrations.delete" defaultMessage="Delete" />
  }

  get modalTitle() {
    return <FormattedMessage id="integrations.delete.confirm.title" defaultMessage="Delete Integration" />
  }
  ...
  get modalConfirmButton() {
    return <FormattedMessage id="integrations.delete.confirm.button" defaultMessage="Delete" />
  }
}
