      ...
      <div className="backstage-content">
        <BackstageHeader>
          <Link to={`/${this.props.team.name}/integrations/outgoing_webhooks`}>
            <FormattedMessage id="installed_outgoing_webhooks.header" defaultMessage="Outgoing Webhooks" />
          </Link>
          ...
          <form className="form-horizontal" onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="displayName">
                <FormattedMessage id="add_outgoing_webhook.displayName" defaultMessage="Title" />
              </label>
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="description">
                <FormattedMessage id="add_outgoing_webhook.description" defaultMessage="Description" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="description"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="contentType">
                <FormattedMessage id="add_outgoing_webhook.content_Type" defaultMessage="Content Type" />
              </label>
              <div className="col-md-5 col-sm-8">
                <select className="form-control" value={this.state.contentType} onChange={this.updateContentType}>
                  <option value={contentTypeOption1}>{contentTypeOption1}</option>
                  <option value={contentTypeOption2}>{contentTypeOption2}</option>
                </select>
                <div className="form__help">
                  <FormattedMessage
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="channelId">
                <FormattedMessage id="add_outgoing_webhook.channel" defaultMessage="Channel" />
              </label>
              <div className="col-md-5 col-sm-8">
                <ChannelSelect
                  id="channelId"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="triggerWords">
                <FormattedMessage
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="triggerWords">
                <FormattedMessage id="add_outgoing_webhook.triggerWordsTriggerWhen" defaultMessage="Trigger When" />
              </label>
              <div className="col-md-5 col-sm-8">
                <select className="form-control" value={this.state.triggerWhen} onChange={this.updateTriggerWhen}>
                  <option value="0">
                    {localizeMessage(
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="callbackUrls">
                <FormattedMessage
            ...
            {this.props.enablePostUsernameOverride && (
              <div className="form-group">
                <label className="control-label col-sm-4" htmlFor="username">
                  <FormattedMessage id="add_outgoing_webhook.username" defaultMessage="Username" />
                </label>
                <div className="col-md-5 col-sm-8">
                  <input
                    id="username"
            ...
            {this.props.enablePostIconOverride && (
              <div className="form-group">
                <label className="control-label col-sm-4" htmlFor="iconURL">
                  <FormattedMessage id="add_outgoing_webhook.icon_url" defaultMessage="Profile Picture" />
                </label>
                <div className="col-md-5 col-sm-8">
                  <input
                    id="iconURL"
            ...
            <div className="backstage-form__footer">
              ...
              <Link className="btn btn-link btn-sm" to={`/${this.props.team.name}/integrations/outgoing_webhooks`}>
                <FormattedMessage id="add_outgoing_webhook.cancel" defaultMessage="Cancel" />
              </Link>
              <SpinnerButton
                ...
                id="saveWebhook"
              >
                <FormattedMessage id={footerToRender.id} defaultMessage={footerToRender.defaultMessage} />
              </SpinnerButton>
              {renderExtra}
            </div>
          </form>
