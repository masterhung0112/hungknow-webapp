    ...
    return (
      <div>
        <Switch>
          ...
          />
          <CommandRoute extraProps={extraProps} path={`${this.props.match.url}/add`} component={AddCommand} />
          <CommandRoute extraProps={extraProps} path={`${this.props.match.url}/edit`} component={EditCommand} />
          <CommandRoute
            extraProps={extraProps}
