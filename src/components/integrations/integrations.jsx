...
export default class Integrations extends React.PureComponent {
  ...
  updateTitle = () => {
    ...
    document.title =
      Utils.localizeMessage('admin.sidebar.integrations', 'Integrations') +
      ' - ' +
  ...
  render() {
      ...
      options.push(
        ...
        >
          <IntegrationOption
            ...
            title={<FormattedMessage id="integrations.incomingWebhook.title" defaultMessage="Incoming Webhooks" />}
            description={
              <FormattedMessage
      ...
      options.push(
        ...
        >
          <IntegrationOption
            ...
            title={<FormattedMessage id="integrations.outgoingWebhook.title" defaultMessage="Outgoing Webhooks" />}
            description={
              <FormattedMessage
      ...
      options.push(
        ...
        >
          <IntegrationOption
            ...
            title={<FormattedMessage id="integrations.command.title" defaultMessage="Slash Commands" />}
            description={
              <FormattedMessage
    ...
    if (this.props.enableOAuthServiceProvider) {
      options.push(
        <SystemPermissionGate permissions={[Permissions.MANAGE_OAUTH]} key="oauth2AppsPermission">
          <IntegrationOption
            key="oauth2Apps"
            image={OAuthIcon}
            title={<FormattedMessage id="integrations.oauthApps.title" defaultMessage="OAuth 2.0 Applications" />}
            description={
              <FormattedMessage
    ...
    options.push(
      <SystemPermissionGate permissions={['manage_bots']} key="botsPermissions">
        <IntegrationOption
          image={BotAccountsIcon}
          title={<FormattedMessage id="bots.manage.header" defaultMessage="Bot Accounts" />}
          description={
            <FormattedMessage
    ...
    return (
      <div className="backstage-content row">
        <div className="backstage-header">
          <h1>
            <FormattedMessage id="integrations.header" defaultMessage="Integrations" />
          </h1>
        </div>
        <div className="backstage-list__help">
          <FormattedMessage
            ...
            values={{
              appDirectory: (
                <a target="_blank" rel="noopener noreferrer" href="https://about.mattermost.com/default-app-directory/">
                  <FormattedMessage id="integrations.help.appDirectory" defaultMessage="App Directory" />
                </a>
              ),
            }}
          />
        </div>
        <div className="integrations-list d-flex flex-wrap">{options}</div>
      </div>
    )
  }
}
