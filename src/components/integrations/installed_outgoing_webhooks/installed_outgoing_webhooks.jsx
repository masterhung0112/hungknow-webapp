...
export default class InstalledOutgoingWebhooks extends React.PureComponent {
  ...
  render() {
    return (
      <BackstageList
        header={
          <FormattedMessage id="installed_outgoing_webhooks.header" defaultMessage="Installed Outgoing Webhooks" />
        }
        addText={<FormattedMessage id="installed_outgoing_webhooks.add" defaultMessage="Add Outgoing Webhook" />}
        addLink={'/' + this.props.team.name + '/integrations/outgoing_webhooks/add'}
        addButtonId="addOutgoingWebhook"
        emptyText={
          <FormattedMessage id="installed_outgoing_webhooks.empty" defaultMessage="No outgoing webhooks found" />
        }
        emptyTextSearch={
            ...
            values={{
              ...
              appDirectory: (
                <a target="_blank" rel="noopener noreferrer" href="https://about.mattermost.com/default-app-directory/">
                  <FormattedMessage id="installed_outgoing_webhooks.help.appDirectory" defaultMessage="App Directory" />
                </a>
              ),
            }}
          />
