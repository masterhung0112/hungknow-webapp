...
import { IncomingWebhook } from 'hkclient-ts/lib/types/integrations'
  ...
  render() {
    return (
      <BackstageList
        ...
        addText={<FormattedMessage id="installed_incoming_webhooks.add" defaultMessage="Add Incoming Webhook" />}
        addLink={'/' + this.props.team.name + '/integrations/incoming_webhooks/add'}
        addButtonId="addIncomingWebhook"
        emptyText={
          <FormattedMessage id="installed_incoming_webhooks.empty" defaultMessage="No incoming webhooks found" />
        }
        emptyTextSearch={
            ...
            values={{
              ...
              appDirectory: (
                <a target="_blank" rel="noopener noreferrer" href="https://about.mattermost.com/default-app-directory/">
                  <FormattedMessage id="installed_incoming_webhooks.help.appDirectory" defaultMessage="App Directory" />
                </a>
              ),
            }}
          />
