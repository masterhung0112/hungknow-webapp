  ...
  handleSubmit = (e) => {
    ...
    if (!this.state.channelId) {
      this.setState({
        saving: false,
        clientError: (
          <FormattedMessage id="add_incoming_webhook.channelRequired" defaultMessage="A valid channel is required" />
        ),
      })
          ...
          <form className="form-horizontal" onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="displayName">
                <FormattedMessage id="add_incoming_webhook.displayName" defaultMessage="Title" />
              </label>
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="channelLocked">
                <FormattedMessage id="add_incoming_webhook.channelLocked" defaultMessage="Lock to this channel" />
              </label>
            ...
            {this.props.enablePostUsernameOverride && (
              <div className="form-group">
                <label className="control-label col-sm-4" htmlFor="username">
                  <FormattedMessage id="add_incoming_webhook.username" defaultMessage="Username" />
                </label>
                <div className="col-md-5 col-sm-8">
                  <input
                    id="username"
            ...
            {this.props.enablePostIconOverride && (
              <div className="form-group">
                <label className="control-label col-sm-4" htmlFor="iconURL">
                  <FormattedMessage id="add_incoming_webhook.icon_url" defaultMessage="Profile Picture" />
                </label>
                <div className="col-md-5 col-sm-8">
                  <input
                    id="iconURL"
            ...
            <div className="backstage-form__footer">
              ...
              <Link className="btn btn-link btn-sm" to={`/${this.props.team.name}/integrations/incoming_webhooks`}>
