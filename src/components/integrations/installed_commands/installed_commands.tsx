...
export default class InstalledCommands extends React.PureComponent<Props> {
  ...
  public render(): JSX.Element {
    ...
    return (
      <BackstageList
        header={<FormattedMessage id="installed_commands.header" defaultMessage="Installed Slash Commands" />}
        addText={<FormattedMessage id="installed_commands.add" defaultMessage="Add Slash Command" />}
        addLink={'/' + this.props.team.name + '/integrations/commands/add'}
        addButtonId="addSlashCommand"
        emptyText={<FormattedMessage id="installed_commands.empty" defaultMessage="No slash commands found" />}
        emptyTextSearch={
          ...
          <FormattedMessage
            ...
            values={{
              buildYourOwn: (
                ...
                >
                  <FormattedMessage id="installed_commands.help.buildYourOwn" defaultMessage="Build Your Own" />
                </a>
              ),
              appDirectory: (
                <a target="_blank" rel="noopener noreferrer" href="https://about.mattermost.com/default-app-directory/">
                  <FormattedMessage id="installed_commands.help.appDirectory" defaultMessage="App Directory" />
                </a>
              ),
            }}
          />
