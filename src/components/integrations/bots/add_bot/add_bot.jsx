...
export default class AddBot extends React.PureComponent {
  ...
  render() {
    let subtitle = <FormattedMessage id="bots.manage.add" defaultMessage="Add" />
    let buttonText = <FormattedMessage id="bots.manage.add.create" defaultMessage="Create Bot Account" />
    let buttonActiveText = <FormattedMessage id="bots.manage.add.creating" defaultMessage="Creating..." />

    // If we are editing
    if (this.props.bot) {
      subtitle = <FormattedMessage id="bots.manage.edit" defaultMessage="Edit" />
      buttonText = <FormattedMessage id="bots.manage.edit.title" defaultMessage="Update" />
      buttonActiveText = <FormattedMessage id="bots.manage.edit.editing" defaultMessage="Updating..." />
    }
      ...
      <OverlayTrigger
        ...
        overlay={
          <Tooltip id="removeIcon">
            <FormattedMessage id="bot.remove_profile_picture" defaultMessage="Remove Bot Icon" />
          </Tooltip>
        }
      >
      ...
      <div className="backstage-content">
        <BackstageHeader>
          <Link to={`/${this.props.team.name}/integrations/bots`}>
            <FormattedMessage id="bots.manage.header" defaultMessage="Bot Accounts" />
          </Link>
          {subtitle}
        </BackstageHeader>
        <div className="backstage-form">
          <form className="form-horizontal" onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="username">
                <FormattedMessage id="bots.add.username" defaultMessage="Username" />
              </label>
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="boticon">
                <FormattedMessage id="bots.add.icon" defaultMessage="Bot Icon" />
              </label>
              <div className="col-md-5 col-sm-8">
                <div className={'bot-img-container'}>
                  <img className={'bot-img'} alt={'bot image'} src={imageURL} style={imageStyles} />
                  {removeImageIcon}
                </div>
                <div className="btn btn-sm btn-primary btn-file sel-btn">
                  <FormattedMessage id="bots.image.upload" defaultMessage="Upload Image" />
                  <input accept=".jpg,.png,.bmp" type="file" onChange={this.updatePicture} />
                </div>
              </div>
            </div>
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="displayName">
                <FormattedMessage id="bots.add.displayName" defaultMessage="Display Name" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="displayName"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="description">
                <FormattedMessage id="bot.add.description" defaultMessage="Description" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="description"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="role">
                <FormattedMessage id="bot.add.role" defaultMessage="Role" />
              </label>
              <div className="col-md-5 col-sm-8">
                <select
                  className="form-control"
                ...
                >
                  <option value={roleOptionMember}>{Utils.localizeMessage('bot.add.role.member', 'Member')}</option>
                  <option value={roleOptionSystemAdmin}>
                    {Utils.localizeMessage('bot.add.role.admin', 'System Admin')}
                  </option>
                </select>
                <div className="form__help">
                  <FormattedMessage id="bot.add.role.help" defaultMessage="Choose what role the bot should have." />
                </div>
              </div>
            </div>
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="postAll">
                <FormattedMessage id="bot.add.post_all" defaultMessage="post:all" />
              </label>
              <div className="col-md-5 col-sm-8 checkbox">
                <div className="checkbox no-padding">
                  <label htmlFor="postAll">
                    ...
                    />
                    <FormattedMessage id="bot.add.post_all.enabled" defaultMessage="Enabled" />
                  </label>
                </div>
                <div className="form__help">
                  <FormattedMessage
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="postChannels">
                <FormattedMessage id="bot.add.post_channels" defaultMessage="post:channels" />
              </label>
              <div className="col-md-5 col-sm-8 checkbox">
                <div className="checkbox no-padding">
                  <label htmlFor="postChannels">
                    <input
                      ...
                      type="checkbox"
                      checked={
                        this.state.postChannels || this.state.role === roleOptionSystemAdmin || this.state.postAll
                      }
                      onChange={this.updatePostChannels}
                      disabled={
                        !this.props.editingUserHasManageSystem ||
                        this.state.role === roleOptionSystemAdmin ||
                        this.state.postAll
                      }
                    />
                    <FormattedMessage id="bot.add.post_channels.enabled" defaultMessage="Enabled" />
                  </label>
                </div>
                <div className="form__help">
                  <FormattedMessage
            ...
            <div className="backstage-form__footer">
              <FormError type="backstage" errors={[this.state.error]} />
              <Link className="btn btn-link btn-sm" to={`/${this.props.team.name}/integrations/bots`}>
                <FormattedMessage id="bots.manage.add.cancel" defaultMessage="Cancel" />
              </Link>
              <SpinnerButton
