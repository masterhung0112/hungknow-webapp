    ...
    const trusted = (
      <SystemPermissionGate permissions={[Permissions.MANAGE_SYSTEM]}>
        <div className="form-group">
          <label className="control-label col-sm-4" htmlFor="is_trusted">
            <FormattedMessage id="installed_oauth_apps.trusted" defaultMessage="Is Trusted" />
          </label>
          <div className="col-md-5 col-sm-8">
            <label className="radio-inline">
              ...
              />
              <FormattedMessage id="installed_oauth_apps.trusted.yes" defaultMessage="Yes" />
            </label>
            <label className="radio-inline">
              <input
                type="radio"
                ...
                onChange={this.updateTrusted}
              />
              <FormattedMessage id="installed_oauth_apps.trusted.no" defaultMessage="No" />
            </label>
      ...
      <div className="backstage-content">
        <BackstageHeader>
          <Link to={`/${this.props.team.name}/integrations/oauth2-apps`}>
            <FormattedMessage id="installed_oauth_apps.header" defaultMessage="Installed OAuth2 Apps" />
          </Link>
          ...
          <form className="form-horizontal">
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="name">
                <FormattedMessage id="installed_oauth_apps.name" defaultMessage="Display Name" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="name"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="description">
                <FormattedMessage id="installed_oauth_apps.description" defaultMessage="Description" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="description"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="homepage">
                <FormattedMessage id="installed_oauth_apps.homepage" defaultMessage="Homepage" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="homepage"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="icon_url">
                <FormattedMessage id="installed_oauth_apps.iconUrl" defaultMessage="Icon URL" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="icon_url"
            ...
            <div className="backstage-form__footer">
              ...
              <Link className="btn btn-link btn-sm" to={`/${this.props.team.name}/integrations/oauth2-apps`}>
                <FormattedMessage id="installed_oauth_apps.cancel" defaultMessage="Cancel" />
              </Link>
              <SpinnerButton
