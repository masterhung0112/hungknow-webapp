...
export default class AbstractCommand extends React.PureComponent {
  ...
  handleSubmit = (e) => {
    ...
    if (!command.trigger) {
      this.setState({
        saving: false,
        clientError: <FormattedMessage id="add_command.triggerRequired" defaultMessage="A trigger word is required" />,
      })
    ...
    if (!command.url) {
      this.setState({
        saving: false,
        clientError: <FormattedMessage id="add_command.urlRequired" defaultMessage="A request URL is required" />,
      })
    ...
    if (this.state.autocomplete) {
      autocompleteHint = (
        <div className="form-group">
          <label className="control-label col-sm-4" htmlFor="autocompleteHint">
            <FormattedMessage id="add_command.autocompleteHint" defaultMessage="Autocomplete Hint" />
          </label>
          <div className="col-md-5 col-sm-8">
            <LocalizedInput
              ...
              placeholder={{
                id: t('add_command.autocompleteHint.placeholder'),
      ...
      autocompleteDescription = (
        <div className="form-group">
          <label className="control-label col-sm-4" htmlFor="autocompleteDescription">
            <FormattedMessage id="add_command.autocompleteDescription" defaultMessage="Autocomplete Description" />
          </label>
          <div className="col-md-5 col-sm-8">
            <LocalizedInput
              id="description"
              ...
              placeholder={{
                id: t('add_command.autocompleteDescription.placeholder'),
      ...
      <div className="backstage-content row">
        <BackstageHeader>
          <Link to={'/' + this.props.team.name + '/integrations/commands'}>
            <FormattedMessage id="installed_command.header" defaultMessage="Slash Commands" />
          </Link>
          ...
          <form className="form-horizontal" onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="displayName">
                <FormattedMessage id="add_command.displayName" defaultMessage="Title" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="displayName"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="description">
                <FormattedMessage id="add_command.description" defaultMessage="Description" />
              </label>
              <div className="col-md-5 col-sm-8">
                <input
                  id="description"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="trigger">
                <FormattedMessage id="add_command.trigger" defaultMessage="Command Trigger Word" />
              </label>
              <div className="col-md-5 col-sm-8">
                <LocalizedInput
                  id="trigger"
                  ...
                  placeholder={{
                    id: t('add_command.trigger.placeholder'),
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="url">
                <FormattedMessage id="add_command.url" defaultMessage="Request URL" />
              </label>
              <div className="col-md-5 col-sm-8">
                <LocalizedInput
                  id="url"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="method">
                <FormattedMessage id="add_command.method" defaultMessage="Request Method" />
              </label>
              <div className="col-md-5 col-sm-8">
                <select id="method" className="form-control" value={this.state.method} onChange={this.updateMethod}>
                  <option value={REQUEST_POST}>{Utils.localizeMessage('add_command.method.post', 'POST')}</option>
                  <option value={REQUEST_GET}>{Utils.localizeMessage('add_command.method.get', 'GET')}</option>
                </select>
                <div className="form__help">
                  <FormattedMessage
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="username">
                <FormattedMessage id="add_command.username" defaultMessage="Response Username" />
              </label>
              <div className="col-md-5 col-sm-8">
                <LocalizedInput
                  id="username"
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="iconUrl">
                <FormattedMessage id="add_command.iconUrl" defaultMessage="Response Icon" />
              </label>
              <div className="col-md-5 col-sm-8">
                <LocalizedInput
                  id="iconUrl"
                  ...
                  placeholder={{
                    id: t('add_command.iconUrl.placeholder'),
            ...
            <div className="form-group">
              <label className="control-label col-sm-4" htmlFor="autocomplete">
                <FormattedMessage id="add_command.autocomplete" defaultMessage="Autocomplete" />
              </label>
            ...
            <div className="backstage-form__footer">
              ...
              <Link className="btn btn-link btn-sm" to={'/' + this.props.team.name + '/integrations/commands'}>
                <FormattedMessage id="add_command.cancel" defaultMessage="Cancel" />
              </Link>
              <SpinnerButton
                ...
                id="saveCommand"
              >
                <FormattedMessage id={this.props.footer.id} defaultMessage={this.props.footer.defaultMessage} />
              </SpinnerButton>
