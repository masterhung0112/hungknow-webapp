...
export default class InstalledCommand extends React.PureComponent {
  ...
  render() {
    ...
    if (command.display_name) {
      ...
      name = <FormattedMessage id="installed_commands.unnamed_command" defaultMessage="Unnamed Slash Command" />
    }
    ...
    if (command.description) {
      description = (
        <div className="item-details__row">
          <span className="item-details__description">{command.description}</span>
        </div>
      )
    }
      ...
      actions = (
        <div className="item-actions">
          <button className="style--none color--link" onClick={this.handleRegenToken}>
            <FormattedMessage id="installed_integrations.regenToken" defaultMessage="Regenerate Token" />
          </button>
          {' - '}
          ...
          {' - '}
          <DeleteIntegration messageId={t('installed_commands.delete.confirm')} onDelete={this.handleDelete} />
        </div>
      )
    }
