...
export default class InstalledOAuthApps extends React.PureComponent<Props, State> {
  ...
  componentDidMount(): void {
    if (this.props.enableOAuthServiceProvider) {
      this.props.actions.loadOAuthAppsAndProfiles().then(() => this.setState({ loading: false }))
    }
  }
  ...
  render(): JSX.Element {
    ...
    return (
      <BackstageList
            ...
            values={{
              ...
              appDirectory: (
                <a target="_blank" rel="noopener noreferrer" href="https://about.mattermost.com/default-app-directory/">
                  <FormattedMessage id="installed_oauth_apps.help.appDirectory" defaultMessage="App Directory" />
                </a>
              ),
            }}
          />
        ...
        emptyText={
          <FormattedMessage id="installed_oauth_apps.empty" defaultMessage="No OAuth 2.0 Applications found" />
        }
        emptyTextSearch={
