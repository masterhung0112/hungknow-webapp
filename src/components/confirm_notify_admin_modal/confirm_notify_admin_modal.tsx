    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="title">
            <FormattedMessage id={'confirm.notification_sent_to_admin.modal_title'} defaultMessage={'Thank you!'} />
          </div>
          ...
          <div className="buttons">
            <Button className="confirm-button" onClick={props.actions.closeModal}>
              <FormattedMessage id={'confirm.notification_sent_to_admin.modal_done'} defaultMessage={'Done'} />
            </Button>
          </div>
        </Modal.Body>
      </Modal>
