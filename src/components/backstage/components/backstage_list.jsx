      ...
      if (children.length === 0 || !hasChildren) {
        if (!filter) {
          if (this.props.emptyText) {
            children = <div className="backstage-list__item backstage-list__empty">{this.props.emptyText}</div>
          }
        } else if (this.props.emptyTextSearch) {
          children = (
            <div className="backstage-list__item backstage-list__empty" id="emptySearchResultsMessage">
    ...
    if (this.props.addLink && this.props.addText) {
      addLink = (
        <Link className="add-link" to={this.props.addLink}>
          <button type="button" className="btn btn-primary" id={this.props.addButtonId}>
