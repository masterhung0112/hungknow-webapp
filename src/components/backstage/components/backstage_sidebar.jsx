...
export default class BackstageSidebar extends React.PureComponent {
  ...
  renderIntegrations() {
    ...
    if (this.props.enableIncomingWebhooks) {
      incomingWebhooks = (
        <TeamPermissionGate permissions={[Permissions.MANAGE_INCOMING_WEBHOOKS]} teamId={this.props.team.id}>
          <BackstageSection
    ...
    if (this.props.enableOutgoingWebhooks) {
      outgoingWebhooks = (
        <TeamPermissionGate permissions={[Permissions.MANAGE_OUTGOING_WEBHOOKS]} teamId={this.props.team.id}>
          <BackstageSection
    ...
    if (this.props.enableCommands) {
      commands = (
        <TeamPermissionGate permissions={[Permissions.MANAGE_SLASH_COMMANDS]} teamId={this.props.team.id}>
          <BackstageSection
            name="commands"
            parentLink={'/' + this.props.team.name + '/integrations'}
            title={<FormattedMessage id="backstage_sidebar.integrations.commands" defaultMessage="Slash Commands" />}
            id="slashCommands"
          />
        </TeamPermissionGate>
      )
      ...
      oauthApps = (
        <SystemPermissionGate permissions={[Permissions.MANAGE_OAUTH]}>
          <BackstageSection
            ...
            parentLink={'/' + this.props.team.name + '/integrations'}
            title={
              <FormattedMessage id="backstage_sidebar.integrations.oauthApps" defaultMessage="OAuth 2.0 Applications" />
            }
            id="oauthApps"
          />
    ...
    const botAccounts = (
      <SystemPermissionGate permissions={['manage_bots', 'manage_others_bots']}>
        <BackstageSection
          name="bots"
          parentLink={'/' + this.props.team.name + '/integrations'}
          title={<FormattedMessage id="backstage_sidebar.bots" defaultMessage="Bot Accounts" />}
          id="botAccounts"
        />
      </SystemPermissionGate>
    )
