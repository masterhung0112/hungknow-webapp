...
) => <Route {...rest} render={(props) => <Component {...extraProps} {...props} />} />
  ...
  render() {
    ...
    return (
      <div className="backstage">
        <AnnouncementBar />
        <SystemNotice />
        <BackstageNavbar team={this.props.team} siteName={this.props.siteName} />
        ...
        <div className="backstage-body" ref={this.setListRef}>
          ...
          <Switch>
            ...
            />
            <BackstageRoute extraProps={extraProps} exact={true} path={'/:team/emoji'} component={Emoji} />
            <BackstageRoute extraProps={extraProps} path={`${this.props.match.url}/add`} component={AddEmoji} />
            <BackstageRoute extraProps={extraProps} path={`${this.props.match.url}/bots/add`} component={AddBot} />
            <BackstageRoute extraProps={extraProps} path={`${this.props.match.url}/bots/edit`} component={AddBot} />
            <BackstageRoute extraProps={extraProps} path={`${this.props.match.url}/bots`} component={Bots} />
          </Switch>
        </div>
      </div>
    )
