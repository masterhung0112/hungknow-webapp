...
export default class AddEmoji extends React.PureComponent<AddEmojiProps, AddEmojiState> {
  ...
  handleSubmit = async (e: SyntheticEvent<unknown>): Promise<void> => {
    ...
    if (!emoji.name) {
      this.setState({
        saving: false,
        error: <FormattedMessage id="add_emoji.nameRequired" defaultMessage="A name is required for the emoji" />,
      })
    ...
    if (!image) {
      this.setState({
        saving: false,
        error: <FormattedMessage id="add_emoji.imageRequired" defaultMessage="An image is required for the emoji" />,
      })
        ...
        <div className="form-group">
          ...
          <div className="col-md-5 col-sm-8 add-emoji__preview">
            <FormattedMessage
              ...
              values={{
                image: <span className="emoticon" style={{ backgroundImage: 'url(' + this.state.imageUrl + ')' }} />,
              }}
            />
          </div>
        </div>
        ...
        <div className="backstage-form">
          <form className="form-horizontal" onSubmit={this.handleFormSubmit}>
            ...
            <div className="backstage-form__footer">
              ...
              <Link className="btn btn-link btn-sm" to={'/' + this.props.team.name + '/emoji'}>
