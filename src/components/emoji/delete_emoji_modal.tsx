...
export default class DeleteEmoji extends DeleteModalTrigger {
  get triggerTitle() {
    return <FormattedMessage id="emoji_list.delete" defaultMessage="Delete" />
  }

  get modalTitle() {
    return <FormattedMessage id="emoji_list.delete.confirm.title" defaultMessage="Delete Custom Emoji" />
  }
  ...
  get modalConfirmButton() {
    return <FormattedMessage id="emoji_list.delete.confirm.button" defaultMessage="Delete" />
  }
}
