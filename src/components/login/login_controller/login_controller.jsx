...
class LoginController extends React.PureComponent {
      ...
      this.setState({
        serverError: (
          <FormattedMessage
            ...
            values={{
              ldapUsername:
                this.props.ldapLoginFieldName || Utils.localizeMessage('login.ldapUsernameLower', 'AD/LDAP username'),
            }}
          />
        ),
      })
      ...
      if (error) {
        if (error.server_error_id === 'api.user.login.not_verified.app_error') {
          ...
          this.setState({
            showMfa: false,
            loading: false,
            serverError: <FormattedMessage id="login.invalidPassword" defaultMessage="Your password is incorrect." />,
          })
  ...
  createLoginOptions = () => {
      ...
      loginControls.push(
        <div className="form-group" key="signup">
          <span>
            ...
            <Link id="signup" to={'/signup_user_complete' + this.props.location.search} className="signup-team-login">
    ...
    if (
      ...
      (gitlabSigninEnabled || googleSigninEnabled || samlSigninEnabled || office365SigninEnabled || openIdSigninEnabled)
    ) {
      loginControls.push(
    ...
    if (openIdSigninEnabled) {
      ...
      let buttonText = <FormattedMessage id="login.openid" defaultMessage="Open ID" />
