...
describe('components/ChannelHeader', () => {
  ...
  test('should render bot description', () => {
    ...
    const wrapper = shallowWithIntl(<ChannelHeader {...props} />)
    expect(wrapper.containsMatchingElement(<Markdown message={props.currentUser.bot_description} />)).toEqual(true)
  })
  ...
  test('should render the guest badges on gms', () => {
    ...
    const wrapper = shallowWithIntl(<ChannelHeader {...props} />)
    expect(wrapper.containsMatchingElement(<GuestBadge show={true} />)).toEqual(true)
  })
