...
describe('components/channel_header/components/HeaderIconWrapper', () => {
  ...
  const mentionsIcon = <MentionsIcon className="icon icon__mentions" aria-hidden="true" />
  ...
  test('should match snapshot, on FlagIcon', () => {
    const flagIcon = <FlagIcon className="icon icon__flag" aria-hidden="true" />
  ...
  test('should match snapshot, on PinIcon', () => {
    const pinIcon = <PinIcon className="icon icon__pin" aria-hidden="true" />
  ...
  test('should match snapshot, on SearchIcon', () => {
    const searchIcon = <SearchIcon className="icon icon__search" aria-hidden="true" />
