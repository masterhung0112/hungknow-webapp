...
import { PostType, PostMetadata } from 'hkclient-ts/lib/types/posts'
...
describe('components/delete_post_modal', () => {
  ...
  test('should focus delete button on enter', () => {
    const wrapper = shallow<DeletePostModal>(<DeletePostModal {...baseProps} />)
  ...
  test('should have called actions.deleteAndRemovePost when handleDelete is called', async () => {
    ...
    const wrapper = shallow<DeletePostModal>(<DeletePostModal {...props} />)
