...
import { TeamMembership, TeamStats, GetTeamMembersOpts } from 'hkclient-ts/lib/types/teams'
import { Teams } from 'hkclient-ts/lib/constants'
  ...
  componentDidUpdate(prevProps: Props) {
    if (prevProps.searchTerm !== this.props.searchTerm) {
      ...
      const searchTimeoutId = window.setTimeout(async () => {
        const { loadStatusesForProfilesList, loadTeamMembersForProfilesList, searchProfiles } = this.props.actions
