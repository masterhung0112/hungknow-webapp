...
export default class PopoverListMembers extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.channel.type !== Constants.GM_CHANNEL && !channelIsArchived) {
      let membersName = <FormattedMessage id="members_popover.manageMembers" defaultMessage="Manage Members" />
      ...
      popoverButton = (
        <div className="more-modal__button" key={'popover-member-more'}>
          <button className="btn btn-link" data-testid="membersModal" onClick={this.showMembersModal}>
            {membersName}
          </button>
        </div>
      )
      ...
      <div id="channelMember">
        ...
        >
          <button
            ...
            className={
              'member-popover__trigger channel-header__icon channel-header__icon--left channel-header__icon--wide ' +
              (this.state.showPopover ? 'channel-header__icon--active' : '')
            }
            ref="member_popover_target"
            onClick={this.handleGetProfilesInChannel}
          >
            <div className="d-flex align-items-center">
              <i aria-hidden="true" className="icon icon-account-outline channel-header__members" />
        ...
        <Overlay
          ...
          placement="bottom"
        >
          <Popover className="member-list__popover" id="member-list-popover">
            ...
            <div className="more-modal__body">
              <div tabIndex="-1" role="presentation" ref={this.membersList} className="more-modal__list">
                {items}
              </div>
            </div>
            {popoverButton}
