...
export default class PopoverListMembersItem extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.showMessageIcon) {
      messageIcon = <MessageIcon aria-hidden="true" />
    }
      ...
      >
        ...
        <div className="more-modal__details d-flex whitespace--nowrap">
          <div className="more-modal__name">
            ...
            <BotBadge show={Boolean(this.props.user.is_bot)} className="badge-popoverlist" />
            <GuestBadge show={Utils.isGuest(this.props.user)} className="badge-popoverlist" />
          </div>
          <CustomStatusEmoji
