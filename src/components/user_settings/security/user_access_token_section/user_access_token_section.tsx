...
export default class UserAccessTokenSection extends React.PureComponent<Props, State> {
  ...
  confirmCopyToken = (confirmAction: () => void) => {
    this.setState({
      ...
      confirmTitle: <FormattedMessage id="user.settings.tokens.confirmCopyTitle" defaultMessage="Copied Your Token?" />,
        ...
        <div>
          ...
          {state.tokenCreationState === TOKEN_CREATING ? (
            <div>
              ...
              <FormattedMessage id="user.settings.tokens.tokenLoading" defaultMessage="Loading..." />
            </div>
          ) : (
            <strong className="word-break--all">
              <FormattedMessage id="user.settings.tokens.token" defaultMessage="Access Token: " />
      ...
      confirmButton: (
        <FormattedMessage id="user.settings.tokens.confirmCopyButton" defaultMessage="Yes, I have copied the token" />
      ),
      confirmComplete: () => {
        this.handleCancelConfirm()
        confirmAction()
  ...
  confirmCreateToken = () => {
    ...
    this.setState({
      ...
      confirmButton: <FormattedMessage id="user.settings.tokens.confirmCreateButton" defaultMessage="Yes, Create" />,
      confirmComplete: () => {
        this.handleCreateToken()
  ...
  confirmRevokeToken = (tokenId: string) => {
    ...
    this.setState({
      showConfirmModal: true,
      confirmTitle: <FormattedMessage id="user.settings.tokens.confirmDeleteTitle" defaultMessage="Delete Token?" />,
      confirmMessage: () => (
        <div className="alert alert-danger">
      ...
      confirmButton: <FormattedMessage id="user.settings.tokens.confirmDeleteButton" defaultMessage="Yes, Delete" />,
      confirmComplete: () => {
  ...
  render() {
    ...
    if (this.state.tokenCreationState === TOKEN_CREATING) {
      newTokenSection = (
        <div className="pl-3">
          ...
          <div>
            ...
            <div>
              <label id="clientError" className="has-error mt-2 mb-2">
            ...
            />
            <button className="btn btn-link" onClick={this.stopCreatingToken}>
      ...
      newTokenSection = (
        <a className="btn btn-primary" href="#" onClick={this.startCreatingToken}>
          <FormattedMessage id="user.settings.tokens.create" defaultMessage="Create Token" />
        </a>
      )
    }
    ...
    const inputs = []
    inputs.push(
      <div key="tokensSetting" className="pt-2">
        <div key="tokenList">
