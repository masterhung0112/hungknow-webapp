...
import { blendColors, setThemeDefaults } from 'hkclient-ts/lib/utils/theme_utils'
      ...
      <span>
        ...
        >
          <Modal.Header closeButton={true}>
            <Modal.Title componentClass="h1" id="importThemeModalLabel">
              <FormattedMessage id="user.settings.import_theme.importHeader" defaultMessage="Import Slack Theme" />
            </Modal.Title>
          </Modal.Header>
          <form role="form" className="form-horizontal">
            ...
            <Modal.Footer>
              <button id="cancelButton" type="button" className="btn btn-link" onClick={this.handleOnHide}>
                <FormattedMessage id="user.settings.import_theme.cancel" defaultMessage="Cancel" />
              </button>
              <button id="submitButton" onClick={this.handleSubmit} type="submit" className="btn btn-primary">
