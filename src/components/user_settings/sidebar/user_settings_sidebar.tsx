...
export default class UserSettingsSidebar extends React.PureComponent<
  UserSettingsSidebarProps,
  UserSettingsSidebarState
> {
  ...
  renderAutoCloseDMLabel = (value: string): JSX.Element => {
    ...
    return <FormattedMessage id="user.settings.sidebar.never" defaultMessage="Never" />
  }
            ...
            <fieldset key="autoCloseDMSetting">
              ...
              <div className="radio">
                <label>
                  ...
                  />
                  <FormattedMessage id="user.settings.sidebar.never" defaultMessage="Never" />
                </label>
              </div>
              <div className="mt-5">
                <FormattedMessage
  ...
  renderOrganizationLabel = (): JSX.Element[] => {
    ...
    if (grouping === 'by_type') {
      ...
      messages.push(
        <FormattedMessage key="none" id="user.settings.sidebar.groupByNoneShort" defaultMessage="No grouping" />
      )
    }
    ...
    messages.push(<FormattedMessage key="sorting" id={sortingId} defaultMessage={sortingDefaultMessage} />)
    ...
    if (atTopId) {
      ...
      messages.push(<FormattedMessage key="atTop" id={atTopId} defaultMessage={atTopDefaultMessage as any} />)
    }
  ...
  renderChannelSwitcherLabel = (value: string): JSX.Element => {
    if (value === 'true') {
      return <FormattedMessage id="user.settings.sidebar.on" defaultMessage="On" />
    }

    return <FormattedMessage id="user.settings.sidebar.off" defaultMessage="Off" />
  }
    ...
    if (this.props.activeSection === 'groupChannels') {
      ...
      inputs.push(
        <fieldset key="groupingSectionSetting">
          <legend className="form-legend">
            <FormattedMessage id="user.settings.sidebar.groupChannelsTitle" defaultMessage="Channel grouping" />
          </legend>
          <div className="radio">
            <label>
              <input
              ...
              />
              <FormattedMessage id="user.settings.sidebar.groupByType" defaultMessage="Channels grouped by type" />
            </label>
          </div>
          <div className="radio">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.sidebar.groupByNone" defaultMessage="Combine all channel types" />
            </label>
          </div>
          <div className="mt-5">
            <FormattedMessage
      ...
      inputs.push(
        <fieldset key="sortingOptions">
          <legend className="form-legend">
            <FormattedMessage id="user.settings.sidebar.sortChannelsTitle" defaultMessage="Channel sorting" />
          </legend>
          <div className="radio">
            <label>
              <input
              ...
              />
              <FormattedMessage id="user.settings.sidebar.sortRecent" defaultMessage="Recency" />
            </label>
          </div>
          <div className="radio">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.sidebar.sortAlpha" defaultMessage="Alphabetically" />
            </label>
          </div>
          <div className="mt-5">
            <FormattedMessage
        ...
        <fieldset key="unreadOption">
          <div className="checkbox">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.sidebar.unreads" defaultMessage="Unreads grouped separately" />
            </label>
          </div>
          <div className="mt-5">
            <FormattedMessage
        ...
        <fieldset key="favoriteOption">
          <div className="checkbox">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.sidebar.favorites" defaultMessage="Favorites grouped separately" />
            </label>
          </div>
          <div>
            <br />
  ...
  renderChannelSwitcherSection = (): JSX.Element => {
    ...
    const helpChannelSwitcherText = (
      <FormattedMessage id={channelSwitcherSectionDescId} defaultMessage={channelSwitcherSectionDescDefault} />
    )
            ...
            <fieldset key="channelSwitcherSectionSetting">
              ...
              <div id="channelSwitcherRadioOn" className="radio">
                <label>
                  ...
                  />
                  <FormattedMessage id="user.settings.sidebar.on" defaultMessage="On" />
                </label>
                <br />
              </div>
              <div id="channelSwitcherRadioOff" className="radio">
                <label>
                  ...
                  />
                  <FormattedMessage id="user.settings.sidebar.off" defaultMessage="Off" />
                </label>
                <br />
              </div>
    ...
    return (
      <SettingItemMin
        title={
          <FormattedMessage id="user.settings.sidebar.channelSwitcherSectionTitle" defaultMessage="Channel Switcher" />
        }
  ...
  render(): JSX.Element {
    ...
    const channelOrganizationSection =
      showChannelOrganization && enableLegacySidebar ? this.renderChannelOrganizationSection() : null
      ...
      <div>
        <div className="modal-header">
          ...
          <h4 className="modal-title">
            <div className="modal-back" onClick={this.props.collapseModal}>
              <LocalizedIcon
                className="fa fa-angle-left"
                title={{ id: t('generic_icons.collapse'), defaultMessage: 'Collapse Icon' }}
              />
            </div>
            <FormattedMessage id="user.settings.sidebar.title" defaultMessage="Sidebar Settings" />
          </h4>
        </div>
