...
import { setThemeDefaults } from 'hkclient-ts/lib/utils/theme_utils'
  ...
  render() {
    ...
    Constants.THEME_ELEMENTS.forEach((element, index) => {
      if (element.id === 'codeTheme') {
        ...
        var popoverContent = (
          <Popover popoverStyle="info" id="code-popover" className="code-popover">
            <img width="200" alt={'code theme image'} src={codeThemeURL} />
          </Popover>
        )
        ...
        centerChannelElements.push(
          <div className="col-sm-6 form-group" key={'custom-theme-key' + index}>
            ...
            <div className="input-group theme-group group--code dropdown" id={element.id}>
              ...
              <OverlayTrigger placement="top" overlay={popoverContent} ref="headerOverlay">
                <span className="input-group-addon">
                  <img alt={'code theme image'} src={codeThemeURL} />
                </span>
              </OverlayTrigger>
            </div>
          </div>
    ...
    const pasteBox = (
      <div className="col-sm-12">
        ...
        />
        <div className="mt-3">
          <button className="btn btn-link copy-theme-button" onClick={this.copyTheme}>
            <FormattedMessage id="user.settings.custom_theme.copyThemeColors" defaultMessage="Copy Theme Colors" />
          </button>
          <span className="alert alert-success copy-theme-success" role="alert" style={{ display: 'none' }}>
            <FormattedMessage id="user.settings.custom_theme.copied" defaultMessage="✔ Copied" />
          </span>
        </div>
      </div>
    )
    ...
    return (
      <div className="appearance-section pt-2">
        <div className="theme-elements row">
          ...
          >
            <FormattedMessage id="user.settings.custom_theme.sidebarTitle" defaultMessage="Sidebar Styles" />
        ...
        <div className="theme-elements row">
          ...
          <div ref="centerChannelStyles" id="centerChannelStyles" className="theme-elements__body">
        ...
        <div className="theme-elements row">
          ...
          >
            <FormattedMessage id="user.settings.custom_theme.linkButtonTitle" defaultMessage="Link and Button Styles" />
            <div className="header__icon">
              <LocalizedIcon
                className="fa fa-plus"
                title={{ id: t('generic_icons.expand'), defaultMessage: 'Expand Icon' }}
