...
export default class ThemeSetting extends React.PureComponent {
  ...
  render() {
    ...
    if (displayCustom && this.props.allowCustomThemes) {
      custom = (
        <div key="customThemeChooser">
          <CustomThemeChooser theme={this.state.theme} updateTheme={this.updateTheme} />
        </div>
      )
    } else {
      premade = (
        <div key="premadeThemeChooser">
          <br />
          <PremadeThemeChooser theme={this.state.theme} updateTheme={this.updateTheme} />
        </div>
      )
    }
    ...
    if (this.props.selected) {
        ...
        inputs.push(
          <div className="radio" key="premadeThemeColorLabel">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.display.theme.themeColors" defaultMessage="Theme Colors" />
            </label>
            <br />
          </div>
        )
      ...
      if (this.props.allowCustomThemes) {
        inputs.push(
          <div className="radio" key="customThemeColorLabel">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.display.theme.customTheme" defaultMessage="Custom Theme" />
            </label>
          </div>
        )
        ...
        inputs.push(
          <div key="otherThemes">
            ...
            >
              <FormattedMessage id="user.settings.display.theme.otherThemes" defaultMessage="See other themes" />
            </a>
          </div>
        )
        ...
        inputs.push(
          <div key="importSlackThemeButton" className="pt-2">
            <button id="slackImportTheme" className="theme style--none color--link" onClick={this.handleImportModal}>
              <FormattedMessage
      ...
      themeUI = (
        <SettingItemMin
          title={<FormattedMessage id="user.settings.display.theme.title" defaultMessage="Theme" />}
          describe={
            <FormattedMessage id="user.settings.display.theme.describe" defaultMessage="Open to manage your theme" />
          }
          section={'theme'}
          updateSection={this.handleUpdateSection}
