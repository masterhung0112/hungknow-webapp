...
export default class AdvancedSettingsDisplay extends React.PureComponent {
  ...
  renderOnOffLabel(enabled) {
    if (enabled === 'false') {
      return <FormattedMessage id="user.settings.advance.off" defaultMessage="Off" />
    }

    return <FormattedMessage id="user.settings.advance.on" defaultMessage="On" />
  }
  ...
  renderCtrlEnterLabel() {
    ...
    if (ctrlEnter === 'false' && codeBlockCtrlEnter === 'false') {
      ...
      return <FormattedMessage id="user.settings.advance.onForAllMessages" defaultMessage="On for all messages" />
    }
    return (
      <FormattedMessage
        ...
        <fieldset key="ctrlSendSetting">
          ...
          <div className="radio">
            <label>
              ...
              />
              <FormattedMessage id="user.settings.advance.onForAllMessages" defaultMessage="On for all messages" />
            </label>
            <br />
          </div>
          <div className="radio">
    ...
    if (currentUser.auth_service === '' && this.props.enableUserDeactivation) {
      if (this.props.activeSection === 'deactivateAccount') {
        deactivateAccountSection = (
          <SettingItemMax
            title={
              <FormattedMessage id="user.settings.advance.deactivateAccountTitle" defaultMessage="Deactivate Account" />
            }
            inputs={[
      ...
      <div>
        <div className="modal-header">
          ...
          <h4 className="modal-title" ref="title">
            ...
            <FormattedMessage id="user.settings.advance.title" defaultMessage="Advanced Settings" />
          </h4>
        </div>
