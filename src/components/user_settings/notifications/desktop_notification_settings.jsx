  ...
  buildMaximizedSetting = () => {
        ...
        soundSection = (
          <fieldset>
            <legend className="form-legend">
              <FormattedMessage id="user.settings.notifications.desktop.sound" defaultMessage="Notification sound" />
            </legend>
            <div className="radio">
              <label>
                <input
    ...
    inputs.push(
      <div key="userNotificationLevelOption">
        <fieldset>
          <legend className="form-legend">
            <FormattedMessage id="user.settings.notifications.desktop" defaultMessage="Send desktop notifications" />
          </legend>
          <div className="radio">
            <label>
              <input
                ...
                onChange={this.handleOnChange}
              />
              <FormattedMessage id="user.settings.notifications.allActivity" defaultMessage="For all activity" />
            </label>
            <br />
          </div>
          <div className="radio">
