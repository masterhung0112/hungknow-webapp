...
export default class NotificationsTab extends React.PureComponent {
  ...
  handleSubmit = () => {
    ...
    this.props.actions.updateMe({ notify_props: data }).then(({ data: result, error: err }) => {
      if (result) {
            ...
            <fieldset>
              ...
              <div className="radio">
                <label>
                  ...
                  />
                  <FormattedMessage id="user.settings.push_notification.away" defaultMessage="Away or offline" />
                </label>
              </div>
              <div className="radio">
                <label>
                  ...
                  />
                  <FormattedMessage id="user.settings.push_notification.offline" defaultMessage="Offline" />
                </label>
              </div>
            </fieldset>
          )
  ...
  render() {
    ...
    if (this.props.activeSection === 'keys') {
      ...
      if (describe.length > 0) {
        ...
        describe = <FormattedMessage id="user.settings.notifications.noWords" defaultMessage="No words configured" />
      }
    ...
    if (this.props.enableAutoResponder) {
      if (this.props.activeSection === 'auto-responder') {
        ...
        const describe = this.state.autoResponderActive ? (
          <FormattedMessage id="user.settings.notifications.autoResponderEnabled" defaultMessage="Enabled" />
        ) : (
          <FormattedMessage id="user.settings.notifications.autoResponderDisabled" defaultMessage="Disabled" />
        )
    ...
    return (
      <div id="notificationSettings">
        <div className="modal-header">
          <button id="closeButton" type="button" className="close" data-dismiss="modal" onClick={this.props.closeModal}>
          ...
          <h4 className="modal-title" ref={this.drawerRef}>
            <div className="modal-back">
              <FormattedMessage id="generic_icons.collapse" defaultMessage="Collapse Icon">
                {(title) => <i className="fa fa-angle-left" title={title} onClick={this.props.collapseModal} />}
              </FormattedMessage>
            </div>
            <FormattedMessage id="user.settings.notifications.title" defaultMessage="Notification Settings" />
          </h4>
        </div>
