...
describe('components/user_settings/notifications/ManageAutoResponder', () => {
  ...
  test('should match snapshot, enabled', () => {
    const wrapper = mountWithIntl(<ManageAutoResponder {...requiredProps} autoResponderActive={true} />)
  ...
  test('should pass handleChange', () => {
    ...
    const wrapper = mountWithIntl(
      <ManageAutoResponder {...requiredProps} autoResponderActive={true} setParentState={setParentState} />
    )
