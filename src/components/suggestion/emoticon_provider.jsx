...
import { autocompleteCustomEmojis } from 'hkclient-ts/lib/actions/emojis'
    ...
    return (
      ...
      >
        <div className="pull-left">
          <img alt={text} className="emoticon-suggestion__image" src={getEmojiImageUrl(emoji)} title={text} />
        </div>
  ...
  handlePretextChanged(pretext, resultsCallback) {
    ...
    if (store.getState().entities.general.config.EnableCustomEmoji === 'true') {
      store
        ...
        .then(() => this.findAndSuggestEmojis(text, partialName, resultsCallback))
    } else {
