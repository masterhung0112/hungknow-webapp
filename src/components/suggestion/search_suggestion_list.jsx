...
export default class SearchSuggestionList extends SuggestionList {
  ...
  renderChannelDivider(type) {
    ...
    if (type === Constants.OPEN_CHANNEL) {
      ...
      text = <FormattedMessage id="suggestion.search.direct" defaultMessage="Direct Messages" />
    }
  ...
  render() {
    ...
    return (
      <Popover
        ...
        placement="bottom"
      >
        <div ref={this.suggestionReadOut} aria-live="polite" className="hidden-label" />
        {items}
      </Popover>
    )
  }
