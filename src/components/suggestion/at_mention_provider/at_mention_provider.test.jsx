...
describe('components/suggestion/at_mention_provider/AtMentionProvider', () => {
  ...
  const userid6 = {
    id: 'userid6',
    username: 'user6.six-split',
    first_name: 'out Junior',
    last_name: 'out',
    nickname: 'out',
  }
  ...
  it('should suggest for "@"', async () => {
    ...
    const params = {
      ...
      searchAssociatedGroupsForReference: jest.fn().mockImplementation(
        () =>
          new Promise((resolve) => {
            resolve({
  ...
  it('should have priorityProfiles at the top', async () => {
    ...
    const params = {
      ...
      priorityProfiles: [userid11, userid12],
    }
  ...
  it('should suggest for "@h"', async () => {
    ...
    const itemsCall3 = [{ type: Constants.MENTION_SPECIAL, username: 'here' }]
    const params = {
      ...baseParams,
      autocompleteUsersInChannel: jest.fn().mockImplementation(
        () =>
  ...
  it('should suggest for username match "@user"', async () => {
    ...
    await Promise.resolve().then(() => {
      expect(resultCallback).toHaveBeenNthCalledWith(3, {
        matchedPretext,
        terms: ['@user', '@user2', '@user4', '@user5', '@user6.six-split'],
        items: itemsCall3,
        component: AtMentionSuggestion,
      })
    })
  ...
  it('should suggest for username match "@six"', async () => {
    ...
    const itemsCall3 = [{ type: Constants.MENTION_NONMEMBERS, ...userid6 }]
    const params = {
      ...baseParams,
      autocompleteUsersInChannel: jest.fn().mockImplementation(
        () =>
  ...
  it('should suggest for full name match "robert ward"', async () => {
    ...
    const itemsCall3 = [{ type: Constants.MENTION_NONMEMBERS, ...userid8 }]
    const params = {
      ...baseParams,
      autocompleteUsersInChannel: jest.fn().mockImplementation(
        () =>
  ...
  it('should ignore channel mentions - @here, @channel and @all when useChannelMentions is false', () => {
    ...
    expect(resultCallback).toHaveBeenNthCalledWith(1, {
      matchedPretext,
      terms: ['@board', '@developers', '@software-engineers'],
      items: [
        { type: Constants.MENTION_GROUPS, ...groupid1 },
        { type: Constants.MENTION_GROUPS, ...groupid2 },
        { type: Constants.MENTION_GROUPS, ...groupid3 },
  ...
  it('should suggest for full group display name match "software engineers"', async () => {
    ...
    const itemsCall3 = [{ type: Constants.MENTION_GROUPS, ...groupid3 }]
    const params = {
      ...baseParams,
      autocompleteUsersInChannel: jest.fn().mockImplementation(
        () =>
    ...
    expect(resultCallback).toHaveBeenNthCalledWith(1, {
      ...
      items: [{ type: Constants.MENTION_GROUPS, ...groupid3 }],
      component: AtMentionSuggestion,
    })
  })
})
