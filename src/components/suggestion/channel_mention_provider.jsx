...
import { getMyChannels, getMyChannelMemberships } from 'hkclient-ts/lib/selectors/entities/channels'
    ...
    return (
      ...
      >
        <div className="d-flex align-items-center">
          ...
          <span className="mention__channelname ml-2">{description}</span>
        </div>
      </div>
    )
  }
