    ...
    <React.Fragment>
      {props.withTitle && (
        <h4 className="search-hint__title">
          <FormattedMessage id="search_bar.usage.title" defaultMessage="Search Options" />
        </h4>
      )}
      <ul
        role="list"
      ...
      >
        {props.options.map((option, optionIndex) => (
          <li
            className={classNames('search-hint__suggestions-list__option', {
              highlighted: optionIndex === props.highlightedIndex,
            })}
          ...
          >
            ...
            <div className="search-hint__suggestion-list__value">
              <FormattedMessage id={option.message.id} defaultMessage={option.message.defaultMessage} />
            </div>
          </li>
        ))}
      </ul>
