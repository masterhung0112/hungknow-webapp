...
export default class GifPicker extends React.PureComponent {
  ...
  render() {
    ...
    switch (action) {
      case 'reactions':
        component = <Categories appProps={appProps} onTrending={this.handleTrending} onSearch={this.handleSearch} />
        break
      case 'search':
        component = (
          <Search appProps={appProps} onCategories={this.handleCategories} handleItemClick={this.handleItemClick} />
        )
        break
      case 'trending':
        component = (
          <Trending appProps={appProps} onCategories={this.handleCategories} handleItemClick={this.handleItemClick} />
        )
        break
    }
    return (
