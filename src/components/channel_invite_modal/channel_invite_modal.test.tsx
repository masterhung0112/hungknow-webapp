...
describe('components/channel_invite_modal', () => {
  ...
  test('should match snapshot for channel_invite_modal with profiles', () => {
    const wrapper = shallow(
      <ChannelInviteModal {...baseProps} profilesNotInCurrentChannel={users} profilesNotInCurrentTeam={[]} />
    )
  ...
  test('should match state when onHide is called', () => {
    const wrapper = shallow<ChannelInviteModal>(<ChannelInviteModal {...baseProps} />)
  ...
  test('should add users on handleSubmit', (done) => {
    ...
    const wrapper = shallow<ChannelInviteModal>(<ChannelInviteModal {...props} />)
