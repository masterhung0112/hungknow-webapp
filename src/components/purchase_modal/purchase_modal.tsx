...
import { Product } from 'hkclient-ts/lib/types/cloud'
...
export default class PurchaseModal extends React.PureComponent<Props, State> {
    ...
    return (
      <div className={this.state.processing ? 'processing' : ''}>
        <div className="LHS">
          ...
          <img className="image" alt="upgrade" src={upgradeImage} />
          <div className="footer-text">
            <FormattedMessage defaultMessage={'Questions?'} id={'admin.billing.subscription.questions'} />
          </div>
          <a
            className="footer-text"
            onClick={() => trackEvent(TELEMETRY_CATEGORIES.CLOUD_PURCHASING, 'click_contact_support')}
        ...
        <div className="central-panel">
          <PaymentForm className="normal-text" onInputChange={this.onPaymentInput} />
        </div>
        <div className="RHS">
          <div className="price-container">
            <div className="bold-text">
              <FormattedMessage defaultMessage={'Mattermost Cloud'} id={'admin.billing.subscription.mattermostCloud'} />
            </div>
            <div className="price-text">
              {`$${this.state.productPrice || 0}`}
              <span className="monthly-text">
                <FormattedMessage defaultMessage={' /user/month'} id={'admin.billing.subscription.perUserPerMonth'} />
              </span>
            </div>
            <div className="footer-text">
              <FormattedMessage
            ...
            <button disabled={!this.state.paymentInfoIsValid} onClick={this.handleSubmitClick}>
              <FormattedMessage defaultMessage={'Upgrade'} id={'admin.billing.subscription.upgrade'} />
            </button>
            <div className="fineprint-text">
              ...
              {'\u00A0'}
              <a href={CloudLinks.BILLING_DOCS} target="_new" rel="noopener noreferrer">
                <FormattedMessage
          ...
          <a
            className="footer-text"
            onClick={() => {
              trackEvent(TELEMETRY_CATEGORIES.CLOUD_PURCHASING, 'click_contact_sales')
            }}
  ...
  render() {
    ...
    return (
      <Elements options={{ fonts: [{ cssSrc: STRIPE_CSS_SRC }] }} stripe={stripePromise}>
        <RootPortal>
          <FullScreenModal
            show={Boolean(this.props.show)}
            onClose={() => {
              trackEvent(TELEMETRY_CATEGORIES.CLOUD_PURCHASING, 'click_close_purchasing_screen')
          ...
          >
            <div className="PurchaseModal">
              ...
              {this.purchaseScreen()}
              <div>
                <img className="waves" src={wavesBackground} />
                <img className="blue-dots" src={blueDots} />
                <img className="lower-blue-dots" src={LowerBlueDots} />
              </div>
            </div>
          </FullScreenModal>
        </RootPortal>
