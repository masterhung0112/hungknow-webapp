  ...
  public render() {
    ...
    const progressBar: JSX.Element | null = (
      <div className="ProcessPayment-progress">
        <div className="ProcessPayment-progress-fill" style={{ width: `${progress}%` }} />
      </div>
    )
    ...
    switch (state) {
      ...
      case ProcessState.SUCCESS:
        pageVisited(TELEMETRY_CATEGORIES.CLOUD_PURCHASING, 'pageview_payment_success')
        return (
          <IconMessage
      ...
      case ProcessState.FAILED:
        pageVisited(TELEMETRY_CATEGORIES.CLOUD_PURCHASING, 'pageview_payment_failed')
        return (
          <IconMessage
